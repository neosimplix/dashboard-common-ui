...
var mt = (i, o, t) => o.has(i) || Lt("Cannot " + t);
var c = (i, o, t) => (mt(i, o, "read from private field"), t ? t.call(i) : o.get(i)), h = (i, o, t) => o.has(i) ? Lt("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(i) : o.set(i, t), a = (i, o, t, s) => (mt(i, o, "write to private field"), s ? s.call(i, t) : o.set(i, t), t), l = (i, o, t) => (mt(i, o, "access private method"), t);
import { css as S, svg as yt, LitElement as x, html as v, nothing as _, ReactiveElement as Qt } from "lit";
import { svg as Ae } from "lit";
import { property as u, query as Gt, state as te } from "lit/decorators.js";
import { repeat as ee } from "lit/directives/repeat.js";
function m(i, o) {
  typeof window > "u" || !("customElements" in window) || customElements.get(i) || customElements.define(i, o);
}
let wt = !1;
const se = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  Next/React:  import "@neosimplix/common-ui/tokens.css";
  HTML:        <link rel="stylesheet" href="…/dist/tokens.css">`, Ft = () => getComputedStyle(document.documentElement).getPropertyValue("--ns-color-line").trim() !== "";
function y() {
...
`;
var oe = Object.defineProperty, re = (i, o, t, s) => {
...
const Bt = class Bt extends x {
  ...
  render() {
    return v`<slot>${l(this, D, It).call(this)}</slot>`;
  }
  /*
...
U = new WeakMap(), D = new WeakSet(), It = function() {
...
m("ns-icon", ut);
var ae = Object.defineProperty, V = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && ae(o, t, e), e;
}, w, O, $, p, xt, $t, Ct, Q, G, tt, et, st, St, lt;
const At = class At extends x {
  ...
  updated() {
    const t = this.dialogEl;
    t && (c(this, p, $t) && !t.open ? this.isConnected && t.showModal() : !c(this, p, $t) && t.open && (a(this, $, !0), t.close()));
  }
  render() {
    return v`
      <dialog
...
w = new WeakMap(), O = new WeakMap(), $ = new WeakMap(), p = new WeakSet(), xt = function() {
  return this.open !== void 0;
}, $t = function() {
  return this.open ?? c(this, w);
}, Ct = function(t) {
  return c(this, p, xt) ? (console.warn(
...
`;
var de = Object.defineProperty, Zt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && de(o, t, e), e;
}, nt;
...
`;
var he = Object.defineProperty, ue = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && he(o, t, e), e;
};
...
`;
var fe = Object.defineProperty, vt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && fe(o, t, e), e;
}, it;
...
`;
var ve = Object.defineProperty, Ht = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && ve(o, t, e), e;
};
...
m("ns-page-heading", J);
var be = Object.defineProperty, bt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && be(o, t, e), e;
};
...
var C, q, R, T, M, f, Pt, dt, Et, Vt, ct;
class ot extends x {
  constructor() {
    super(...arguments);
    h(this, f);
    ...
    h(this, T);
    h(this, M);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, a(this, C, 1), a(this, q, !1), a(this, R, !1), a(this, T, !1), a(this, M, null);
  }
  /*
...
C = new WeakMap(), q = new WeakMap(), R = new WeakMap(), T = new WeakMap(), M = new WeakMap(), f = new WeakSet(), Pt = function() {
  return this.page !== void 0;
}, dt = function() {
  return this.perPage > 0 ? !Number.isFinite(this.total) || this.total < 0 ? (c(this, T) || (a(this, T, !0), console.warn(
    `[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0) : Math.ceil(this.total / this.perPage) : (c(this, R) || (a(this, R, !0), console.warn(
...
Et = function() {
  ...
  return c(this, q) || (a(this, q, !0), console.warn(
...
*/
ct = function(t, s) {
  l(this, f, Vt).call(this, s) && a(this, M, { control: t, page: s });
};
bt([
  u({ type: Number })
], ot.prototype, "total");
...
`;
var we = Object.defineProperty, ke = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && we(o, t, e), e;
};
...
`;
var $e = Object.defineProperty, jt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && $e(o, t, e), e;
};
const Ce = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var gt, Xt;
...
gt = new WeakSet(), Xt = function() {
  return Ce.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, Tt.styles = xe;
let H = Tt;
jt([
  u({ type: String })
...
m("ns-skeleton", H);
var Se = Object.defineProperty, rt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && Se(o, t, e), e;
};
...
var z, j, B, L, F, r, Yt, _t, Ot, Nt, K, Mt, I, ht, E, Y, zt, Wt, Jt, N, Z;
class X extends Qt {
  constructor() {
    super(...arguments);
    h(this, r);
    ...
    h(this, I);
    h(this, Z);
    this.defaultSortKey = "", this.defaultSortDirection = "none", a(this, z, ""), a(this, j, "none"), a(this, L, !1), a(this, I, (t) => {
      const s = t.target, e = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!e || !l(this, r, K).call(this, e)) return;
      const n = e.dataset.nsSortKey ?? "", d = n === c(this, r, _t) ? Pe(c(this, r, Ot)) : "ascending", P = d === "none" ? "" : n;
      c(this, r, Yt) || (a(this, z, P), a(this, j, d), this.requestUpdate());
      ...
      if (s.hasAttribute("data-ns-select-all")) {
        ...
        l(this, r, N).call(this, s.checked ? e.map((b) => l(this, r, E).call(this, b)) : []), this.selected === void 0 && l(this, r, Y).call(this);
        return;
      }
      if (!s.hasAttribute("data-ns-row-id")) return;
      let n;
      if (this.selected === void 0) {
        n = e.filter((b) => b.checked).map((b) => l(this, r, E).call(this, b)), l(this, r, N).call(this, n), l(this, r, Y).call(this);
        return;
      }
      const d = new Set(this.selected), P = l(this, r, E).call(this, s);
      s.checked ? d.add(P) : d.delete(P), n = e.map((b) => l(this, r, E).call(this, b)).filter((b) => d.has(b)), l(this, r, N).call(this, n);
    });
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), y(), this.addEventListener("click", c(this, I)), this.addEventListener("change", c(this, Z)), a(this, F, new MutationObserver(() => {
      l(this, r, Mt).call(this), l(this, r, Y).call(this), l(this, r, Jt).call(this);
    })), c(this, F).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", c(this, I)), this.removeEventListener("change", c(this, Z)), (t = c(this, F)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && a(this, z, this.defaultSortKey), this.defaultSortDirection !== "none" && a(this, j, this.defaultSortDirection), this.selected === void 0 && a(this, B, l(this, r, zt).call(this));
  }
  updated() {
    l(this, r, Nt).call(this), l(this, r, Mt).call(this), l(this, r, Y).call(this);
  }
}
z = new WeakMap(), j = new WeakMap(), B = new WeakMap(), L = new WeakMap(), F = new WeakMap(), r = new WeakSet(), Yt = function() {
...
Jt = function() {
  ...
  const t = l(this, r, zt).call(this), s = c(this, B);
  if (!(s !== void 0 && l(this, r, Wt).call(this, s, t))) {
    if (s === void 0 || this.ownerDocument.readyState === "loading") {
      a(this, B, t);
      return;
    }
    l(this, r, N).call(this, t);
  }
}, N = function(t) {
  a(this, B, t);
  const s = { ids: t };
...
rt([
  u({ attribute: !1 })
], X.prototype, "sortDirection");
rt([
  u({ type: String, attribute: "default-sort-key" })
], X.prototype, "defaultSortKey");
rt([
  u({ type: String, attribute: "default-sort-direction" })
], X.prototype, "defaultSortDirection");
rt([
  u({ attribute: !1 })
], X.prototype, "selected");
m("ns-table", X);
export {
  k as NsDialog,
  W as NsHeader,
