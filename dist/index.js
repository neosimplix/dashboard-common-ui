...
import { css as A, svg as It, LitElement as C, html as b, nothing as y, ReactiveElement as We } from "lit";
...
Q = new WeakMap(), X = new WeakSet(), Ne = function() {
  if (this.name === "") return y;
  const t = Wt[this.name];
  return t ? b`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : y;
...
k("ns-header", xt);
var ys = Object.defineProperty, K = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && ys(o, t, e), e;
}, Ut, S, He, de, he;
    ...
    return b`
      ...
      (a) => b`
                <label class="ns-checkbox">
                  ...
                  />
                  <span>${a.label}</span>
                  ${a.meta === void 0 ? y : b`<span class="ns-checkbox__hint">${a.meta}</span>`}
                </label>
              `
    )}
      </div>
...
const Ke = class Ke extends C {
  ...
  render() {
    return b`
      <h1>${this.heading}</h1>
      ${this.description ? b`<p>${this.description}</p>` : y}
    `;
  }
};
Ke.styles = Ss;
...
class vt extends We {
  constructor() {
    ...
    this.defaultSortKey = "", this.defaultSortDirection = "none", r(this, R, ""), r(this, W, "none"), r(this, rt, !1), r(this, lt, (t) => {
      ...
      const a = i.dataset.nsSortKey ?? "", f = a === l(this, h, be) ? js(l(this, h, ge)) : "ascending", w = f === "none" ? "" : a;
      l(this, h, es) || (r(this, R, w), r(this, W, f), this.requestUpdate());
      const M = { key: w, direction: f };
      this.dispatchEvent(
...
wt = function() {
  ...
  ].filter((w) => c(this, h, Y).call(this, w));
  if (t.length === 0) return;
  const s = c(this, h, Xt).call(this), e = this.selected, i = e === void 0 ? s.filter((w) => w.checked).length : s.filter((w) => e.includes(c(this, h, L).call(this, w))).length, a = s.length > 0 && i === s.length, f = i > 0 && i < s.length;
  for (const w of t)
    w.checked = a, w.indeterminate = f;
...
var V, ct, dt, p, we, kt, q, ye, Zt, ke, xe, $e, ht, ut;
class Oe extends We {
  constructor() {
    super(...arguments);
    d(this, p);
    ...
    return b`
      ...
      (t) => b`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : y}>
              ${t.tone === "neutral" ? y : b`<span class="dot" aria-hidden="true"></span>`}
...
function cs(n, o, t) {
  ...
  e.append(M), e.addEventListener("ns-dialog-close", () => f(!1)), document.body.append(e), e.show(), ee !== null && w(ee);
}
function Xs(n) {
