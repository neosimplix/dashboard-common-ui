...
var vt = (i, o, t) => o.has(i) || Rt("Cannot " + t);
var c = (i, o, t) => (vt(i, o, "read from private field"), t ? t.call(i) : o.get(i)), h = (i, o, t) => o.has(i) ? Rt("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(i) : o.set(i, t), a = (i, o, t, s) => (vt(i, o, "write to private field"), s ? s.call(i, t) : o.set(i, t), t), l = (i, o, t) => (vt(i, o, "access private method"), t);
import { css as S, svg as bt, LitElement as x, nothing as E, html as v, ReactiveElement as Wt } from "lit";
import { svg as ze } from "lit";
...
const Nt = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  ...
  HTML:        <link rel="stylesheet" href="…/dist/tokens.css">`, Tt = () => getComputedStyle(document.documentElement).getPropertyValue("--ns-color-line").trim() !== "";
function y() {
...
const zt = class zt extends x {
  ...
  render() {
    ...
    const t = yt[this.name];
    return t ? v`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : (this.name !== c(this, D) && (a(this, D, this.name), console.warn(
      `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(yt).join(", ")}. registerIcons() 로 더할 수 있다 — 첫 렌더보다 앞서 불러야 한다.`
    )), E);
  }
};
D = new WeakMap(), zt.styles = ee;
let ct = zt;
ne([
  u({ type: String })
], ct.prototype, "name");
...
var ie = Object.defineProperty, H = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && ie(o, t, e), e;
}, w, O, $, p, wt, kt, xt, Q, G, N, tt, et, $t, rt;
const jt = class jt extends x {
  constructor() {
    ...
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, a(this, w, !1), a(this, O, !1), a(this, $, !1), a(this, Q, (t) => {
      ...
      a(this, O, l(this, p, $t).call(this, t));
    }), a(this, et, (t) => {
      const s = c(this, O);
      a(this, O, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !l(this, p, $t).call(this, t) || l(this, p, rt).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), y();
   ...
   */
  show() {
    l(this, p, xt).call(this, "show") || (a(this, w, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    l(this, p, xt).call(this, "close") || (a(this, w, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (c(this, p, kt) && !t.open ? this.isConnected && t.showModal() : !c(this, p, kt) && t.open && (a(this, $, !0), t.close()));
  }
  render() {
    return v`
      <dialog
      ...
      >
        <div class="header">
          ...
          <button class="close" type="button" aria-label="닫기" @click=${c(this, N)}>
...
w = new WeakMap(), O = new WeakMap(), $ = new WeakMap(), p = new WeakSet(), wt = function() {
  return this.open !== void 0;
}, kt = function() {
  return this.open ?? c(this, w);
}, xt = function(t) {
  return c(this, p, wt) ? (console.warn(
...
`;
var re = Object.defineProperty, Lt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && re(o, t, e), e;
}, st;
...
const Kt = class Kt extends x {
  ...
  render() {
    return v`
      <a class="row" href=${this.href} title=${this.label} @click=${c(this, nt)}>
        <span class="leading">
          <slot name="leading">
...
`;
var pe = Object.defineProperty, Ft = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && pe(o, t, e), e;
};
...
var C, U, q, R, M, f, Ct, at, St, It, lt;
class it extends x {
  constructor() {
    super(...arguments);
    h(this, f);
...
C = new WeakMap(), U = new WeakMap(), q = new WeakMap(), R = new WeakMap(), M = new WeakMap(), f = new WeakSet(), Ct = function() {
 ...
 */
St = function() {
  const t = this.page ?? c(this, C), s = c(this, f, at);
  if (Number.isInteger(t) && t >= 1 && t <= s) return t;
  const e = Number.isFinite(t) ? Math.min(Math.max(Math.round(t), 1), Math.max(s, 1)) : 1;
  return c(this, U) || (a(this, U, !0), console.warn(
    c(this, f, Ct) ? `[ns-pagination] page=${t} 가 1..${s} 범위를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.` : `[ns-pagination] 현재 페이지 ${t} 가 total=${this.total} · per-page=${this.perPage} 로 계산된 페이지 수(${s})를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.`
  )), e;
}, /** 이동했으면(= 이벤트를 냈으면) true. */
It = function(t) {
  if (!Number.isInteger(t) || t < 1 || t > c(this, f, at) || t === l(this, f, St).call(this)) return !1;
  c(this, f, Ct) || (a(this, C, t), this.requestUpdate());
  const s = { page: t };
...
`;
var we = Object.defineProperty, Mt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, d; n >= 0; n--)
    (d = i[n]) && (e = d(o, t, e) || e);
  return e && we(o, t, e), e;
};
...
var z, j, B, T, L, r, Ht, Pt, _t, Vt, K, Et, F, dt, _, X, Ot, Xt, Yt, Y, I;
class V extends Wt {
  constructor() {
    super(...arguments);
    h(this, r);
    ...
    h(this, F);
    h(this, I);
    this.defaultSortKey = "", this.defaultSortDirection = "none", a(this, z, ""), a(this, j, "none"), a(this, T, !1), a(this, F, (t) => {
      const s = t.target, e = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!e || !l(this, r, K).call(this, e)) return;
      const n = e.dataset.nsSortKey ?? "", d = n === c(this, r, Pt) ? $e(c(this, r, _t)) : "ascending", P = d === "none" ? "" : n;
      c(this, r, Ht) || (a(this, z, P), a(this, j, d), this.requestUpdate());
      ...
      const d = new Set(this.selected), P = l(this, r, _).call(this, s);
      s.checked ? d.add(P) : d.delete(P), n = e.map((b) => l(this, r, _).call(this, b)).filter((b) => d.has(b)), l(this, r, Y).call(this, n);
    });
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), y(), this.addEventListener("click", c(this, F)), this.addEventListener("change", c(this, I)), a(this, L, new MutationObserver(() => {
      l(this, r, Et).call(this), l(this, r, X).call(this), l(this, r, Yt).call(this);
    })), c(this, L).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", c(this, F)), this.removeEventListener("change", c(this, I)), (t = c(this, L)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && a(this, z, this.defaultSortKey), this.defaultSortDirection !== "none" && a(this, j, this.defaultSortDirection), this.selected === void 0 && a(this, B, l(this, r, Ot).call(this));
  }
  updated() {
    l(this, r, Vt).call(this), l(this, r, Et).call(this), l(this, r, X).call(this);
  }
}
z = new WeakMap(), j = new WeakMap(), B = new WeakMap(), T = new WeakMap(), L = new WeakMap(), r = new WeakSet(), Ht = function() {
  return this.sortKey !== void 0;
}, Pt = function() {
  return this.sortKey ?? c(this, z);
}, _t = function() {
  return this.sortDirection ?? c(this, j);
}, /*
  ...
  */
Vt = function() {
  c(this, T) || this.sortDirection === void 0 || this.sortKey !== void 0 || (a(this, T, !0), console.warn(
...
*/
Et = function() {
  const t = c(this, r, Pt), s = c(this, r, _t);
...
X = function() {
  ...
  const s = l(this, r, dt).call(this), e = this.selected, n = e === void 0 ? s.filter((g) => g.checked).length : s.filter((g) => e.includes(l(this, r, _).call(this, g))).length, d = s.length > 0 && n === s.length, P = n > 0 && n < s.length;
  for (const g of t)
    g.checked = d, g.indeterminate = P;
}, /** 비제어 모드의 진실 — DOM 이다. 행 순서를 그대로 따른다. */
Ot = function() {
  return l(this, r, dt).call(this).filter((t) => t.checked).map((t) => l(this, r, _).call(this, t));
}, /*
...
Yt = function() {
  ...
  const t = l(this, r, Ot).call(this), s = c(this, B);
