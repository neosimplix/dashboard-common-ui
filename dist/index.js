...
var Xt = (i, o, t) => o.has(i) || Ae("Cannot " + t);
var c = (i, o, t) => (Xt(i, o, "read from private field"), t ? t.call(i) : o.get(i)), h = (i, o, t) => o.has(i) ? Ae("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(i) : o.set(i, t), l = (i, o, t, s) => (Xt(i, o, "write to private field"), s ? s.call(i, t) : o.set(i, t), t), a = (i, o, t) => (Xt(i, o, "access private method"), t);
var Me = (i, o, t, s) => ({
  set _(e) {
    l(i, o, e, t);
  },
...
import { css as A, svg as Zt, LitElement as C, html as g, nothing as w, ReactiveElement as ze } from "lit";
import { svg as Ks } from "lit";
import { property as u, query as Je, state as be } from "lit/decorators.js";
...
function $() {
  if (Jt || typeof document > "u" || typeof getComputedStyle > "u") return;
  if (Oe()) {
    Jt = !0;
    return;
  }
...
function At(i, o) {
  for (const [t, s] of Object.entries(o)) {
    ...
    let n = De.get(i);
    n === void 0 && De.set(i, n = /* @__PURE__ */ new Set()), !n.has(e) && (n.add(e), console.warn(
      `[${i.localName}] ${e} 속성은 무시됩니다 — 이 이름은 프로퍼티 전용입니다.
  HTML 에서 쓸 것: ${s}
  JS 에서는 el.${Ye(t)} 에 대입합니다.`
    ));
  }
}
const Ye = (i) => i.replace(/-([a-z])/g, (o, t) => t.toUpperCase()), Qe = A`
...
`;
var ts = Object.defineProperty, es = (i, o, t, s) => {
...
const we = class we extends C {
  ...
  render() {
    return g`<slot>${a(this, N, Le).call(this)}</slot>`;
  }
  /*
  ...
  updated() {
    ...
    if (!t.some((e) => e.nodeType === Node.ELEMENT_NODE)) {
      if (t.length > 0) {
        a(this, N, Wt).call(this, `공백-${this.name}`, `[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);
        return;
      }
      this.name !== "" && !zt[this.name] && a(this, N, Wt).call(this, `없음-${this.name}`, `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(zt).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`);
    }
  }
};
J = new WeakMap(), N = new WeakSet(), Le = function() {
  if (this.name === "") return w;
  const t = zt[this.name];
  return t ? g`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : w;
}, /** 같은 사유로 리렌더될 때마다 찍지 않는다. */
Wt = function(t, s) {
  c(this, J) !== t && (l(this, J, t), console.warn(s));
}, we.styles = Ge;
let Bt = we;
es([
  u({ type: String })
...
k("ns-icon", Bt);
var ss = Object.defineProperty, at = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && ss(o, t, e), e;
}, S, K, O, v, Yt, Qt, Gt, vt, bt, mt, yt, wt, te, Lt;
const ke = class ke extends C {
  constructor() {
    ...
    h(this, yt);
    h(this, wt);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, l(this, S, !1), l(this, K, !1), l(this, O, !1), l(this, vt, (t) => {
      const s = t.target;
      ...
      a(this, v, Lt).call(this, "escape");
    }), l(this, mt, () => {
      a(this, v, Lt).call(this, "close-button");
    }), l(this, yt, (t) => {
      l(this, K, a(this, v, te).call(this, t));
    }), l(this, wt, (t) => {
      const s = c(this, K);
      l(this, K, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !a(this, v, te).call(this, t) || a(this, v, Lt).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), $(), At(this, { open: "default-open" });
   ...
   */
  show() {
    a(this, v, Gt).call(this, "show") || (l(this, S, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    a(this, v, Gt).call(this, "close") || (l(this, S, !1), this.requestUpdate());
  }
  /*
    ...
    return g`
      ...
      >
        ...
        <div class="footer" ?hidden=${!this.hasFooter}>
          <slot name="footer" @slotchange=${c(this, vt)}></slot>
        </div>
      </dialog>
    `;
  }
};
S = new WeakMap(), K = new WeakMap(), O = new WeakMap(), v = new WeakSet(), Yt = function() {
  return this.open !== void 0;
}, Qt = function() {
  return this.open ?? c(this, S);
}, Gt = function(t) {
  return c(this, v, Yt) ? (console.warn(
    `[ns-dialog] open 프로퍼티가 설정된 제어 모드에서는 ${t}() 가 동작하지 않습니다. open 을 바꾸세요.`
  ), !0) : !1;
}, vt = new WeakMap(), bt = new WeakMap(), mt = new WeakMap(), yt = new WeakMap(), wt = new WeakMap(), /*
...
], E.prototype, "defaultOpen");
at([
  u({ type: Boolean, attribute: "no-backdrop-close" })
], E.prototype, "noBackdropClose");
at([
  Je("dialog")
], E.prototype, "dialogEl");
at([
  be()
], E.prototype, "hasFooter");
k("ns-dialog", E);
const ns = A`
  :host {
    display: block;
...
`;
var is = Object.defineProperty, je = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && is(o, t, e), e;
}, kt;
const $e = class $e extends C {
  constructor() {
    super(...arguments);
    h(this, kt);
    this.projectName = "", this.sidebarOpen = !1, l(this, kt, () => {
...
k("ns-header", pt);
var os = Object.defineProperty, j = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && os(o, t, e), e;
}, $t, P, qe, ee, se;
class M extends C {
  ...
  render() {
    const t = c(this, P, ee), s = t.flatMap((r) => this.options.filter((f) => f.value === r)), e = this.query.trim().toLowerCase(), n = e === "" ? this.options : this.options.filter(
      ...
      (r) => g`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => a(this, P, se).call(this, r.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      (r) => g`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(f) => a(this, P, se).call(this, r.value, f.target)}
                  />
                  <span>${r.label}</span>
                  ${r.meta === void 0 ? w : g`<span class="ns-checkbox__hint">${r.meta}</span>`}
                </label>
              `
    )}
      </div>
...
$t = new WeakMap(), P = new WeakSet(), qe = function() {
  return this.value !== void 0;
}, ee = function() {
  return this.value ?? c(this, $t) ?? this.defaultValue;
}, /**
 * @param item   토글할 값
 * @param source 이 토글을 일으킨 네이티브 체크박스. 칩의 제거 버튼에는 없다.
 */
se = function(t, s) {
  const e = c(this, P, ee), n = e.includes(t) ? e.filter((f) => f !== t) : [...e, t];
  c(this, P, qe) ? s !== void 0 && (s.checked = e.includes(t)) : (l(this, $t, n), this.requestUpdate());
  const r = { values: n };
  this.dispatchEvent(
...
`;
var as = Object.defineProperty, ls = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && as(o, t, e), e;
};
...
`;
var ds = Object.defineProperty, Vt = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && ds(o, t, e), e;
}, xt;
const Ce = class Ce extends C {
  constructor() {
    super(...arguments);
    h(this, xt);
    this.href = "", this.label = "", this.badge = "", this.active = !1, l(this, xt, (t) => {
  ...
  render() {
    return g`
      <a class="row" href=${this.href} title=${this.label} @click=${c(this, xt)}>
        <span class="leading">
          <slot name="leading">
...
`;
var us = Object.defineProperty, Te = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && us(o, t, e), e;
};
const Pe = class Pe extends C {
  ...
  render() {
    return g`
      <h1>${this.heading}</h1>
      ${this.description ? g`<p>${this.description}</p>` : w}
    `;
  }
};
Pe.styles = hs;
...
k("ns-page-heading", ft);
var ps = Object.defineProperty, Ht = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && ps(o, t, e), e;
};
...
var D, W, Y, Q, B, b, ne, jt, ie, Ue, qt;
class Mt extends C {
  constructor() {
    super(...arguments);
    h(this, b);
    ...
    h(this, Q);
    h(this, B);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, l(this, D, 1), l(this, W, !1), l(this, Y, !1), l(this, Q, !1), l(this, B, null);
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), $(), At(this, { page: "default-page" });
  }
  /*
  ...
  willUpdate() {
    if (!this.hasUpdated) {
      ...
      this.defaultPage !== 1 && l(this, D, this.defaultPage);
    }
  }
  /*
  ...
  */
  updated() {
    var n;
    const t = c(this, B);
    if (t === null || (l(this, B, null), (this.page ?? c(this, D)) !== t.page)) return;
    ...
    return g`
      <nav aria-label="페이지 이동">
        <button
          ...
          @click=${() => a(this, b, qt).call(this, "prev", s - 1)}
        >
          이전
        </button>
        ${Kt(
      ...
      */
      ...
      (e) => e === "gap" ? g`<span class="ns-pagination-gap" aria-hidden="true">…</span>` : g`<button
                  ...
                  @click=${() => a(this, b, qt).call(this, e, e)}
                >
                  ${e}
                </button>`
    )}
        <button
          ...
          @click=${() => a(this, b, qt).call(this, "next", s + 1)}
        >
          다음
        </button>
      </nav>
...
D = new WeakMap(), W = new WeakMap(), Y = new WeakMap(), Q = new WeakMap(), B = new WeakMap(), b = new WeakSet(), ne = function() {
  ...
  )), 0) : Math.ceil(this.total / this.perPage) : (c(this, Y) || (l(this, Y, !0), console.warn(
...
Ue = function(t) {
  ...
  c(this, b, ne) || (l(this, D, t), this.requestUpdate());
  const s = { page: t };
...
*/
qt = function(t, s) {
  a(this, b, Ue).call(this, s) && l(this, B, { control: t, page: s });
};
Ht([
  u({ type: Number })
], Mt.prototype, "total");
...
], Mt.prototype, "perPage");
Ht([
  u({ attribute: !1 })
], Mt.prototype, "page");
Ht([
  u({ type: Number, attribute: "default-page" })
], Mt.prototype, "defaultPage");
k("ns-pagination", Mt);
const gs = A`
  /*
...
`;
var vs = Object.defineProperty, bs = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && vs(o, t, e), e;
};
...
`;
var ys = Object.defineProperty, me = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && ys(o, t, e), e;
};
const ws = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var Ft, Ke;
  ...
  render() {
    return g`
      <div
        class="bar"
        aria-hidden="true"
        style="width:${this.width};height:${this.height};border-radius:${a(this, Ft, Ke).call(this)}"
      ></div>
    `;
  }
};
Ft = new WeakSet(), Ke = function() {
  return ws.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, _e.styles = ms;
let rt = _e;
me([
  u({ type: String })
...
k("ns-skeleton", rt);
var ks = Object.defineProperty, Ot = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && ks(o, t, e), e;
};
...
var R, I, F, G, tt, d, Be, oe, re, Re, X, ae, et, Tt, T, dt, le, Ie, Fe, ht, Ve;
class lt extends ze {
  constructor() {
    super(...arguments);
    h(this, d);
    ...
    this.defaultSortKey = "", this.defaultSortDirection = "none", l(this, R, ""), l(this, I, "none"), l(this, G, !1), l(this, et, (t) => {
      ...
      if (e && a(this, d, X).call(this, e)) {
        a(this, d, Ve).call(this, e);
        return;
      }
      const n = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!n || !a(this, d, X).call(this, n)) return;
      const r = n.dataset.nsSortKey ?? "", f = r === c(this, d, oe) ? $s(c(this, d, re)) : "ascending", y = f === "none" ? "" : r;
...
ae = function() {
  ...
  for (const e of this.querySelectorAll("th[data-ns-sort-key]"))
    a(this, d, X).call(this, e) && (e.dataset.nsSortKey === t && s !== "none" ? e.setAttribute("aria-sort", s) : e.removeAttribute("aria-sort"));
}, et = new WeakMap(), /*
...
dt = function() {
  ...
  ].filter((y) => a(this, d, X).call(this, y));
  if (t.length === 0) return;
  const s = a(this, d, Tt).call(this), e = this.selected, n = e === void 0 ? s.filter((y) => y.checked).length : s.filter((y) => e.includes(a(this, d, T).call(this, y))).length, r = s.length > 0 && n === s.length, f = n > 0 && n < s.length;
  for (const y of t)
    y.checked = r, y.indeterminate = f;
}, /** 비제어 모드의 진실 — DOM 이다. 행 순서를 그대로 따른다. */
le = function() {
  return a(this, d, Tt).call(this).filter((t) => t.checked).map((t) => a(this, d, T).call(this, t));
}, /*
...
k("ns-table", lt);
var xs = Object.defineProperty, He = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && xs(o, t, e), e;
};
...
var V, st, nt, p, ce, ut, U, de, Ut, he, ue, pe, it, ot;
class ye extends ze {
  constructor() {
    super(...arguments);
    h(this, p);
    ...
    this.defaultActive = "", l(this, V, ""), l(this, nt, !1), l(this, it, (t) => {
      ...
      s !== null && a(this, p, he).call(this, a(this, p, U).call(this, s), !1);
    }), l(this, ot, (t) => {
      const s = a(this, p, pe).call(this, t.target);
      if (s === null) return;
      ...
      if (n === -1) return;
      const r = (f) => {
        t.preventDefault(), a(this, p, he).call(this, a(this, p, U).call(this, e[(f + e.length) % e.length]), !0);
      };
  ...
  connectedCallback() {
    super.connectedCallback(), $(), At(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", c(this, it)), this.addEventListener("keydown", c(this, ot)), l(this, st, new MutationObserver(() => a(this, p, Ut).call(this))), c(this, st).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
...
V = new WeakMap(), st = new WeakMap(), nt = new WeakMap(), p = new WeakSet(), ce = function() {
  ...
  if (t.some((n) => a(this, p, U).call(this, n) === s)) return s;
  const e = a(this, p, U).call(this, t[0]);
...
Ut = function() {
  ...
  for (const s of c(this, p, ut)) {
    const e = a(this, p, U).call(this, s), n = s.dataset.nsPanel ?? "";
    s.setAttribute("role", "tab"), !s.hasAttribute("id") && n !== "" && s.setAttribute("id", Cs(n)), n !== "" && s.setAttribute("aria-controls", n), s.setAttribute("aria-selected", e === t ? "true" : "false"), s.setAttribute("tabindex", e === t ? "0" : "-1");
  }
}, he = function(t, s) {
  if (t === "") return;
  if (t === c(this, p, de)) {
  ...
  ), a(this, p, Ut).call(this), s && a(this, p, ue).call(this, t);
}, ue = function(t) {
  var s;
  (s = c(this, p, ut).find((e) => a(this, p, U).call(this, e) === t)) == null || s.focus();
...
`;
var Ss = Object.defineProperty, Ne = (i, o, t, s) => {
  for (var e = void 0, n = i.length - 1, r; n >= 0; n--)
    (r = i[n]) && (e = r(o, t, e) || e);
  return e && Ss(o, t, e), e;
}, Ct, z, _, L, m, fe, ge, ve, Z, Pt, St, _t, Et;
const Ee = class Ee extends C {
  constructor() {
    ...
    h(this, _t);
    h(this, Et);
    this.position = "top-center", this.items = [], l(this, Ct, 0), l(this, z, !1), l(this, _, !1), l(this, L, !1), l(this, Pt, () => {
      l(this, z, !0), a(this, m, Z).call(this);
    }), l(this, St, () => {
      l(this, z, !1), a(this, m, Z).call(this);
    }), l(this, _t, () => {
      l(this, _, !0), a(this, m, Z).call(this);
    }), l(this, Et, () => {
      l(this, _, !1), a(this, m, Z).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), $(), a(this, m, ve).call(this);
  }
  disconnectedCallback() {
    a(this, m, ge).call(this), l(this, z, !1), l(this, _, !1), l(this, L, !1), super.disconnectedCallback();
  }
  /** 토스트 하나를 띄운다. 돌려주는 함수를 부르면 즉시 닫는다(두 번 불러도 안전). */
  show(t, s, e) {
    const n = Me(this, Ct)._++, r = {
      key: n,
      message: t,
      tone: s,
      duration: e,
    ...
    return this.items = [...this.items, r], c(this, L) || a(this, m, fe).call(this, r), () => this.dismiss(n);
  }
  ...
  updated() {
    var t;
    l(this, _, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), a(this, m, Z).call(this);
  }
  render() {
    return g`
      <div
      ...
      (t) => g`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : w}>
              ${t.tone === "neutral" ? w : g`<span class="dot" aria-hidden="true"></span>`}
...
Ct = new WeakMap(), z = new WeakMap(), _ = new WeakMap(), L = new WeakMap(), m = new WeakSet(), /*
...
*/
Z = function() {
  const t = c(this, z) || c(this, _);
  t !== c(this, L) && (l(this, L, t), t ? a(this, m, ge).call(this) : a(this, m, ve).call(this));
}, Pt = new WeakMap(), St = new WeakMap(), _t = new WeakMap(), Et = new WeakMap(), Ee.styles = Ps;
let gt = Ee;
Ne([
  u({ reflect: !0 })
], gt.prototype, "position");
Ne([
  be()
], gt.prototype, "items");
k("ns-toast", gt);
...
function _s() {
  ...
  return o.position = Xe, document.body.append(o), o;
}
function zs(i) {
  if (Xe = i, typeof document > "u") return;
...
function Ze(i, o, t) {
  ...
  if (o) {
    ...
    x.type = "button", x.className = "ns-button ns-button--outline ns-button--sm", x.textContent = i.cancelLabel ?? "취소", x.addEventListener("click", () => f(!1)), i.tone === "danger" && (Nt = x), Dt.append(x);
  }
  Dt.append(q), e.append(Dt), e.addEventListener("ns-dialog-close", () => f(!1)), document.body.append(e), e.show(), Nt !== null && y(Nt);
}
function js(i) {
