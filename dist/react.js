...
var ue = (n, i, t) => i.has(n) || We("Cannot " + t);
var l = (n, i, t) => (ue(n, i, "read from private field"), t ? t.call(n) : i.get(n)), d = (n, i, t) => i.has(n) ? We("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(n) : i.set(n, t), r = (n, i, t, s) => (ue(n, i, "write to private field"), s ? s.call(n, t) : i.set(n, t), t), c = (n, i, t) => (ue(n, i, "access private method"), t);
var He = (n, i, t, s) => ({
  set _(e) {
    r(n, i, e, t);
  },
...
import { useId as ys, isValidElement as ks, cloneElement as xs } from "react";
import { createComponent as S } from "@lit/react";
import { css as B, svg as Yt, LitElement as P, html as g, nothing as x, ReactiveElement as Qe } from "lit";
import { svg as Hn } from "lit";
import { property as u, query as $s, state as Be } from "lit/decorators.js";
import { repeat as ae } from "lit/directives/repeat.js";
import { jsx as b, jsxs as M, Fragment as Cs } from "react/jsx-runtime";
function $(n, i) {
  typeof window > "u" || !("customElements" in window) || customElements.get(n) || customElements.define(n, i);
}
let pe = !1;
const Ns = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  Next/React:  import "@neosimplix/common-ui/tokens.css";
  HTML:        <link rel="stylesheet" href="…/dist/tokens.css">`, Ve = () => getComputedStyle(document.documentElement).getPropertyValue("--ns-color-line").trim() !== "";
function C() {
  if (pe || typeof document > "u" || typeof getComputedStyle > "u") return;
  if (Ve()) {
    pe = !0;
    return;
  }
...
function st(n, i) {
  for (const [t, s] of Object.entries(i)) {
    ...
    let o = Ge.get(n);
    o === void 0 && Ge.set(n, o = /* @__PURE__ */ new Set()), !o.has(e) && (o.add(e), console.warn(
      `[${n.localName}] ${e} 속성은 무시됩니다 — 이 이름은 프로퍼티 전용입니다.
  HTML 에서 쓸 것: ${s}
  JS 에서는 el.${_s(t)} 에 대입합니다.`
    ));
  }
}
const _s = (n) => n.replace(/-([a-z])/g, (i, t) => t.toUpperCase()), Ss = B`
...
`;
var Ps = Object.defineProperty, As = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ps(i, t, e), e;
}, rt, tt, ts, be, lt;
let Te = (lt = class extends P {
  constructor() {
    super(...arguments);
    d(this, tt);
    d(this, rt);
  ...
  render() {
    return g`<slot>${c(this, tt, ts).call(this)}</slot>`;
  }
  /*
  ...
  updated() {
    ...
    if (!t.some((e) => e.nodeType === Node.ELEMENT_NODE)) {
      if (t.length > 0) {
        c(this, tt, be).call(this, `공백-${this.name}`, `[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);
        return;
      }
      this.name !== "" && !te[this.name] && c(this, tt, be).call(this, `없음-${this.name}`, `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(te).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`);
    }
  }
}, rt = new WeakMap(), tt = new WeakSet(), ts = function() {
  if (this.name === "") return x;
  const t = te[this.name];
  return t ? g`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : x;
}, /** 같은 사유로 리렌더될 때마다 찍지 않는다. */
be = function(t, s) {
  l(this, rt) !== t && (r(this, rt, t), console.warn(s));
}, lt.styles = Es, lt);
As([
  u({ type: String })
], Te.prototype, "name");
$("ns-icon", Te);
var Ms = Object.defineProperty, Et = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ms(i, t, e), e;
}, z, H, T, w, ge, ve, me, Ut, zt, It, Bt, Tt, we, ee;
const Ke = class Ke extends P {
  constructor() {
    ...
    d(this, Bt);
    d(this, Tt);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, r(this, z, !1), r(this, H, !1), r(this, T, !1), r(this, Ut, (t) => {
      const s = t.target;
      ...
      c(this, w, ee).call(this, "escape");
    }), r(this, It, () => {
      c(this, w, ee).call(this, "close-button");
    }), r(this, Bt, (t) => {
      r(this, H, c(this, w, we).call(this, t));
    }), r(this, Tt, (t) => {
      const s = l(this, H);
      r(this, H, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !c(this, w, we).call(this, t) || c(this, w, ee).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { open: "default-open" });
    const t = this.dialogEl;
    t != null && t.open && (r(this, T, !0), t.close()), this.requestUpdate();
  }
  /*
   ...
   */
  show() {
    c(this, w, me).call(this, "show") || (r(this, z, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    c(this, w, me).call(this, "close") || (r(this, z, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (l(this, w, ve) && !t.open ? this.isConnected && t.showModal() : !l(this, w, ve) && t.open && (r(this, T, !0), t.close()));
  }
  render() {
    return g`
      <dialog
      ...
      >
        <div class="header">
          ...
          <button class="close" type="button" aria-label="닫기" @click=${l(this, It)}>
...
z = new WeakMap(), H = new WeakMap(), T = new WeakMap(), w = new WeakSet(), ge = function() {
  return this.open !== void 0;
}, ve = function() {
  return this.open ?? l(this, z);
}, me = function(t) {
  return l(this, w, ge) ? (console.warn(
    `[ns-dialog] open 프로퍼티가 설정된 제어 모드에서는 ${t}() 가 동작하지 않습니다. open 을 바꾸세요.`
  ), !0) : !1;
}, Ut = new WeakMap(), zt = new WeakMap(), It = new WeakMap(), Bt = new WeakMap(), Tt = new WeakMap(), /*
...
`;
var Ds = Object.defineProperty, es = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ds(i, t, e), e;
}, jt, ct;
let ce = (ct = class extends P {
  constructor() {
    super(...arguments);
    d(this, jt);
    this.projectName = "", this.sidebarOpen = !1, r(this, jt, () => {
...
}, jt = new WeakMap(), ct.styles = Os, ct);
es([
...
$("ns-header", ce);
var Us = Object.defineProperty, q = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Us(i, t, e), e;
}, Lt, D, ss, ye, ke, Xe;
let U = (Xe = class extends P {
  constructor() {
    super(...arguments);
    d(this, D);
    /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), st(this, {
  ...
  render() {
    const t = l(this, D, ye), s = t.flatMap((a) => this.options.filter((p) => p.value === a)), e = this.query.trim().toLowerCase(), o = e === "" ? this.options : this.options.filter(
    ...
    return g`
      ...
      (a) => g`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => c(this, D, ke).call(this, a.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      <div class="ns-multi-select__list">
        ${o.length === 0 ? g`<p class="ns-multi-select__empty">${this.emptyMessage}</p>` : ae(
      o,
      (a) => a.value,
      (a) => g`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(p) => c(this, D, ke).call(this, a.value, p.target)}
                  />
                  <span>${a.label}</span>
...
}, Lt = new WeakMap(), D = new WeakSet(), ss = function() {
  return this.value !== void 0;
}, ye = function() {
  return this.value ?? l(this, Lt) ?? this.defaultValue;
}, /**
 * @param item   토글할 값
 * @param source 이 토글을 일으킨 네이티브 체크박스. 칩의 제거 버튼에는 없다.
 */
ke = function(t, s) {
  const e = l(this, D, ye), o = e.includes(t) ? e.filter((p) => p !== t) : [...e, t];
  l(this, D, ss) ? s !== void 0 && (s.checked = e.includes(t)) : (r(this, Lt, o), this.requestUpdate());
  const a = { values: o };
  this.dispatchEvent(
...
`;
var Is = Object.defineProperty, de = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Is(i, t, e), e;
}, V, dt, G, et, ns, xe, Kt, ht;
let Pt = (ht = class extends P {
  constructor() {
    super(...arguments);
    d(this, et);
    d(this, V);
    ...
    d(this, G);
    d(this, Kt);
    this.heading = "", this.collapsible = !1, this.defaultCollapsed = !1, r(this, V, !1), r(this, dt, !1), r(this, G, !1), r(this, Kt, () => {
      const t = !l(this, et, xe);
      r(this, dt, !0), l(this, et, ns) || (r(this, V, !t), this.requestUpdate());
      const s = { open: t };
      this.dispatchEvent(
  ...
  connectedCallback() {
    var s;
    super.connectedCallback(), C(), st(this, { open: "default-collapsed" });
    const t = ((s = this.parentElement) == null ? void 0 : s.closest("ns-nav-group")) != null;
    t !== l(this, G) && (r(this, G, t), this.requestUpdate());
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultCollapsed") && !l(this, dt) && r(this, V, this.defaultCollapsed);
  }
  render() {
    const t = l(this, et, xe);
    return g`
      <div role="group" aria-label=${this.heading} class=${l(this, G) ? "nested" : ""}>
        ${this.collapsible ? g`
              <button
                class="heading"
                type="button"
...
}, V = new WeakMap(), dt = new WeakMap(), G = new WeakMap(), et = new WeakSet(), ns = function() {
  return this.open !== void 0;
}, xe = function() {
  return this.open ?? !l(this, V);
}, Kt = new WeakMap(), ht.styles = zs, ht);
de([
  u({ type: String })
], Pt.prototype, "heading");
de([
  u({ type: Boolean })
], Pt.prototype, "collapsible");
de([
  u({ attribute: !1 })
], Pt.prototype, "open");
de([
  u({ type: Boolean, attribute: "default-collapsed" })
], Pt.prototype, "defaultCollapsed");
$("ns-nav-group", Pt);
const Bs = B`
  :host {
    display: block;
...
`;
var Ts = Object.defineProperty, je = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ts(i, t, e), e;
}, qt, ut;
let Gt = (ut = class extends P {
  constructor() {
    super(...arguments);
    d(this, qt);
    this.href = "", this.label = "", this.active = !1, r(this, qt, (t) => {
  ...
  render() {
    return g`
      <a class="row" href=${this.href} title=${this.label} @click=${l(this, qt)}>
...
}, qt = new WeakMap(), ut.styles = Bs, ut);
je([
  u({ type: String })
], Gt.prototype, "href");
je([
...
`;
var Ls = Object.defineProperty, is = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ls(i, t, e), e;
};
...
is([
  u({ type: String })
], _t.prototype, "heading");
is([
  u({ type: String })
], _t.prototype, "description");
$("ns-page-heading", _t);
var Ks = Object.defineProperty, Xt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ks(i, t, e), e;
};
...
function qs(n, i, t) {
  if (i <= t) return Qt(1, i);
  const s = t - 2, e = (t - 5) / 2;
  return n <= s ? [...Qt(1, s), "gap", i] : n > i - s ? [1, "gap", ...Qt(i - s + 1, i)] : [1, "gap", ...Qt(n - e, n + e), "gap", i];
}
var j, pt, ft, bt, gt, X, m, $e, se, os, Ce, as, ne, Ze;
let nt = (Ze = class extends P {
  constructor() {
    super(...arguments);
    d(this, m);
    d(this, j);
    ...
    d(this, gt);
    d(this, X);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, this.pageWindow = fe, r(this, j, 1), r(this, pt, !1), r(this, ft, !1), r(this, bt, !1), r(this, gt, !1), r(this, X, null);
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { page: "default-page" });
  }
  /*
  ...
  willUpdate() {
    if (!this.hasUpdated) {
      ...
      this.defaultPage !== 1 && r(this, j, this.defaultPage);
    }
  }
  /*
  ...
  */
  updated() {
    var o;
    const t = l(this, X);
    if (t === null || (r(this, X, null), (this.page ?? l(this, j)) !== t.page)) return;
    ...
    return g`
      <nav aria-label="페이지 이동">
        <button
          ...
          @click=${() => c(this, m, ne).call(this, "prev", s - 1)}
        >
          이전
        </button>
      ...
      (e) => e === "gap" ? g`<span class="ns-pagination-gap" aria-hidden="true">…</span>` : (
        ...
        */
        g`<button
                    ...
                    @click=${() => c(this, m, ne).call(this, e, e)}
                  >
                    ${e}
                  </button>`
      )
        ...
        <button
          ...
          @click=${() => c(this, m, ne).call(this, "next", s + 1)}
        >
          다음
        </button>
      </nav>
...
}, j = new WeakMap(), pt = new WeakMap(), ft = new WeakMap(), bt = new WeakMap(), gt = new WeakMap(), X = new WeakMap(), m = new WeakSet(), $e = function() {
  return this.page !== void 0;
}, se = function() {
  return this.perPage > 0 ? !Number.isFinite(this.total) || this.total < 0 ? (l(this, bt) || (r(this, bt, !0), console.warn(
    `[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0) : Math.ceil(this.total / this.perPage) : (l(this, ft) || (r(this, ft, !0), console.warn(
    `[ns-pagination] per-page=${this.perPage} 는 1 이상이어야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0);
}, os = function() {
  const t = this.pageWindow;
  return Number.isInteger(t) && t >= 5 && t % 2 === 1 ? t : (l(this, gt) || (r(this, gt, !0), console.warn(
    `[ns-pagination] page-window=${t} 는 5 이상의 홀수여야 합니다. ${fe} 로 그립니다.`
  )), fe);
}, /**
 ...
 */
Ce = function() {
  const t = this.page ?? l(this, j), s = l(this, m, se);
  if (Number.isInteger(t) && t >= 1 && t <= s) return t;
  const e = Number.isFinite(t) ? Math.min(Math.max(Math.round(t), 1), Math.max(s, 1)) : 1;
  return l(this, pt) || (r(this, pt, !0), console.warn(
    l(this, m, $e) ? `[ns-pagination] page=${t} 가 1..${s} 범위를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.` : `[ns-pagination] 현재 페이지 ${t} 가 total=${this.total} · per-page=${this.perPage} 로 계산된 페이지 수(${s})를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.`
  )), e;
}, /** 이동했으면(= 이벤트를 냈으면) true. */
as = function(t) {
  if (!Number.isInteger(t) || t < 1 || t > l(this, m, se) || t === c(this, m, Ce).call(this)) return !1;
  l(this, m, $e) || (r(this, j, t), this.requestUpdate());
  const s = { page: t };
...
*/
ne = function(t, s) {
  c(this, m, as).call(this, s) && r(this, X, { control: t, page: s });
}, Ze);
Xt([
  u({ type: Number })
], nt.prototype, "total");
...
const Fe = class Fe extends P {
  constructor() {
    ...
    d(this, re);
    d(this, vt);
    this.defaultOpen = !1, r(this, vt, !1);
  }
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { open: "default-open" });
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultOpen") && r(this, vt, this.defaultOpen === !0);
  }
  /*
    ...
    */
  updated() {
    this.toggleAttribute("data-ns-open", l(this, re, ls));
  }
  render() {
    return g`<nav><slot></slot></nav>`;
  }
};
vt = new WeakMap(), re = new WeakSet(), ls = function() {
  return this.open ?? l(this, vt);
}, Fe.styles = Fs;
let St = Fe;
rs([
  u({ attribute: !1 })
...
`;
var Hs = Object.defineProperty, Le = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Hs(i, t, e), e;
};
const Vs = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var le, cs, mt;
let Zt = (mt = class extends P {
  constructor() {
    super(...arguments);
    d(this, le);
  ...
  render() {
    return g`
      <div
        class="bar"
        aria-hidden="true"
        style="width:${this.width};height:${this.height};border-radius:${c(this, le, cs).call(this)}"
      ></div>
    `;
  }
}, le = new WeakSet(), cs = function() {
  return Vs.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, mt.styles = Ws, mt);
Le([
  u({ type: String })
], Zt.prototype, "width");
...
$("ns-skeleton", Zt);
var Gs = Object.defineProperty, Jt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Gs(i, t, e), e;
};
...
var Z, J, Y, wt, yt, h, ds, Ne, _e, hs, ot, Se, kt, ie, R, At, Ee, us, ps, Mt, fs, Je;
let it = (Je = class extends Qe {
  constructor() {
    super(...arguments);
    d(this, h);
    d(this, Z);
    ...
    d(this, yt);
    d(this, kt);
    this.defaultSortKey = "", this.defaultSortDirection = "none", r(this, Z, ""), r(this, J, "none"), r(this, wt, !1), r(this, kt, (t) => {
      const s = t.target, e = s == null ? void 0 : s.closest(
        'input[type="checkbox"][data-ns-select-all], input[type="checkbox"][data-ns-row-id]'
      );
      if (e && c(this, h, ot).call(this, e)) {
        c(this, h, fs).call(this, e);
        return;
      }
      const o = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!o || !c(this, h, ot).call(this, o)) return;
      const a = o.dataset.nsSortKey ?? "", p = a === l(this, h, Ne) ? Xs(l(this, h, _e)) : "ascending", v = p === "none" ? "" : a;
      l(this, h, ds) || (r(this, Z, v), r(this, J, p), this.requestUpdate());
      const E = { key: v, direction: p };
      this.dispatchEvent(
  ...
  connectedCallback() {
    ...
    }), this.addEventListener("click", l(this, kt)), r(this, yt, new MutationObserver(() => {
      c(this, h, Se).call(this), c(this, h, At).call(this), c(this, h, ps).call(this);
    })), l(this, yt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, kt)), (t = l(this, yt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && r(this, Z, this.defaultSortKey), this.defaultSortDirection !== "none" && r(this, J, this.defaultSortDirection), this.selected === void 0 && r(this, Y, c(this, h, Ee).call(this));
  }
  updated() {
    c(this, h, hs).call(this), c(this, h, Se).call(this), c(this, h, At).call(this);
  }
}, Z = new WeakMap(), J = new WeakMap(), Y = new WeakMap(), wt = new WeakMap(), yt = new WeakMap(), h = new WeakSet(), ds = function() {
  return this.sortKey !== void 0;
}, Ne = function() {
  return this.sortKey ?? l(this, Z);
}, _e = function() {
  return this.sortDirection ?? l(this, J);
}, /*
  ...
  */
hs = function() {
  l(this, wt) || this.sortDirection === void 0 || this.sortKey !== void 0 || (r(this, wt, !0), console.warn(
...
ot = function(t) {
  ...
  */
Se = function() {
  const t = l(this, h, Ne), s = l(this, h, _e);
  for (const e of this.querySelectorAll("th[data-ns-sort-key]"))
    c(this, h, ot).call(this, e) && (e.dataset.nsSortKey === t && s !== "none" ? e.setAttribute("aria-sort", s) : e.removeAttribute("aria-sort"));
}, kt = new WeakMap(), /*
...
At = function() {
  ...
  ].filter((v) => c(this, h, ot).call(this, v));
  if (t.length === 0) return;
  const s = c(this, h, ie).call(this), e = this.selected, o = e === void 0 ? s.filter((v) => v.checked).length : s.filter((v) => e.includes(c(this, h, R).call(this, v))).length, a = s.length > 0 && o === s.length, p = o > 0 && o < s.length;
  for (const v of t)
    v.checked = a, v.indeterminate = p;
}, /** 비제어 모드의 진실 — DOM 이다. 행 순서를 그대로 따른다. */
Ee = function() {
  return c(this, h, ie).call(this).filter((t) => t.checked).map((t) => c(this, h, R).call(this, t));
}, /*
...
ps = function() {
  ...
  const t = c(this, h, Ee).call(this), s = l(this, Y);
  if (!(s !== void 0 && c(this, h, us).call(this, s, t))) {
    if (s === void 0 || this.ownerDocument.readyState === "loading") {
      r(this, Y, t);
      return;
    }
    c(this, h, Mt).call(this, t);
  }
}, Mt = function(t) {
  r(this, Y, t);
  const s = { ids: t };
 ...
 */
fs = function(t) {
  const s = c(this, h, ie).call(this);
  if (t.hasAttribute("data-ns-select-all")) {
    if (this.selected === void 0)
      for (const p of s) p.checked = t.checked;
    c(this, h, Mt).call(this, t.checked ? s.map((p) => c(this, h, R).call(this, p)) : []), this.selected === void 0 && c(this, h, At).call(this);
    return;
  }
  if (!t.hasAttribute("data-ns-row-id")) return;
  let e;
  if (this.selected === void 0) {
    e = s.filter((p) => p.checked).map((p) => c(this, h, R).call(this, p)), c(this, h, Mt).call(this, e), c(this, h, At).call(this);
    return;
  }
  const o = new Set(this.selected), a = c(this, h, R).call(this, t);
  t.checked ? o.add(a) : o.delete(a), e = s.map((p) => c(this, h, R).call(this, p)).filter((p) => o.has(p)), c(this, h, Mt).call(this, e);
}, Je);
Jt([
  u({ attribute: !1 })
], it.prototype, "sortKey");
Jt([
  u({ attribute: !1 })
], it.prototype, "sortDirection");
Jt([
  u({ type: String, attribute: "default-sort-key" })
], it.prototype, "defaultSortKey");
Jt([
  u({ type: String, attribute: "default-sort-direction" })
], it.prototype, "defaultSortDirection");
Jt([
  u({ attribute: !1 })
], it.prototype, "selected");
$("ns-table", it);
var Zs = Object.defineProperty, bs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Zs(i, t, e), e;
};
...
var Q, xt, $t, f, Pe, Ot, W, Ae, oe, Me, Oe, De, Ct, Nt, Ye;
let he = (Ye = class extends Qe {
  constructor() {
    super(...arguments);
    d(this, f);
    d(this, Q);
    ...
    d(this, Ct);
    d(this, Nt);
    this.defaultActive = "", r(this, Q, ""), r(this, $t, !1), r(this, Ct, (t) => {
      const s = c(this, f, De).call(this, t.target);
      s !== null && c(this, f, Me).call(this, c(this, f, W).call(this, s), !1);
    }), r(this, Nt, (t) => {
      const s = c(this, f, De).call(this, t.target);
      if (s === null) return;
      const e = l(this, f, Ot), o = e.indexOf(s);
      if (o === -1) return;
      const a = (p) => {
        t.preventDefault(), c(this, f, Me).call(this, c(this, f, W).call(this, e[(p + e.length) % e.length]), !0);
      };
  ...
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", l(this, Ct)), this.addEventListener("keydown", l(this, Nt)), r(this, xt, new MutationObserver(() => c(this, f, oe).call(this))), l(this, xt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, Ct)), this.removeEventListener("keydown", l(this, Nt)), (t = l(this, xt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
    ...
    */
  firstUpdated() {
    this.defaultActive !== "" && r(this, Q, this.defaultActive);
  }
  updated() {
    c(this, f, oe).call(this);
  }
}, Q = new WeakMap(), xt = new WeakMap(), $t = new WeakMap(), f = new WeakSet(), Pe = function() {
  ...
  const t = l(this, f, Ot);
  if (t.length === 0) return "";
  const s = this.active ?? l(this, Q);
  if (t.some((o) => c(this, f, W).call(this, o) === s)) return s;
  const e = c(this, f, W).call(this, t[0]);
  return s !== "" && !l(this, $t) && (r(this, $t, !0), console.warn(
    l(this, f, Pe) ? `[ns-tabs] active="${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시하지만 그 탭을 눌러도 ns-tab-change 가 나가지 않습니다. 대소문자까지 맞는지 확인하세요.` : `[ns-tabs] 활성 탭 "${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시합니다. default-active 값이 data-ns-tab 과 맞는지 확인하세요.`
  )), e;
}, /** 소비자 DOM 에 ARIA 와 roving tabindex 를 쓴다. 멱등이다. */
oe = function() {
  const t = l(this, f, Ae);
  for (const s of l(this, f, Ot)) {
    const e = c(this, f, W).call(this, s), o = s.dataset.nsPanel ?? "";
    s.setAttribute("role", "tab"), !s.hasAttribute("id") && o !== "" && s.setAttribute("id", Js(o)), o !== "" && s.setAttribute("aria-controls", o), s.setAttribute("aria-selected", e === t ? "true" : "false"), s.setAttribute("tabindex", e === t ? "0" : "-1");
  }
}, Me = function(t, s) {
  if (t === "") return;
  if (t === l(this, f, Ae)) {
    s && c(this, f, Oe).call(this, t);
    return;
  }
  l(this, f, Pe) || (r(this, Q, t), this.requestUpdate());
  const e = { id: t };
  this.dispatchEvent(
    new CustomEvent("ns-tab-change", { detail: e, bubbles: !0, composed: !0 })
  ), c(this, f, oe).call(this), s && c(this, f, Oe).call(this, t);
}, Oe = function(t) {
  var s;
  (s = l(this, f, Ot).find((e) => c(this, f, W).call(this, e) === t)) == null || s.focus();
...
}, Ct = new WeakMap(), Nt = new WeakMap(), Ye);
bs([
  u({ attribute: !1 })
], he.prototype, "active");
bs([
  u({ type: String, attribute: "default-active" })
], he.prototype, "defaultActive");
$("ns-tabs", he);
const vn = S({
  react: _,
  tagName: "ns-header",
...
function _n({ title: n, description: i, className: t }) {
  return /* @__PURE__ */ b(Qs, { heading: n, description: i ?? "", className: t });
}
function Sn({
  open: n,
  title: i,
...
function gs({ variant: n = "solid", size: i = "md", fullWidth: t = !1 }, s) {
  return N(
    "ns-button",
    `ns-button--${n}`,
...
function Pn({
  ...
  return /* @__PURE__ */ b(
    ...
    {
      type: e,
      className: gs({ variant: n, size: i, fullWidth: t }, s),
      ...o
    }
  );
}
function An({
  ...
  return /* @__PURE__ */ b("a", { className: gs({ variant: n, size: i, fullWidth: t }, s), ...e });
}
function Mn({
  className: n,
  children: i,
  ...
  if (t === void 0)
    return /* @__PURE__ */ b("div", { className: N("ns-card", n), children: i });
  const a = o === 3 ? "h3" : "h2";
  return /* @__PURE__ */ M("div", { className: N("ns-card", n), children: [
...
function On({
  ...
  return /* @__PURE__ */ M(
    "details",
    {
      className: N("ns-accordion", `ns-accordion--${o}`, e),
      open: t,
      children: [
        /* @__PURE__ */ b("summary", { children: o === "plain" ? n : /* @__PURE__ */ M(Cs, { children: [
...
function Dn({ invalid: n = !1, className: i, ...t }) {
  return /* @__PURE__ */ b(
    "input",
    {
      className: N("ns-input", i),
...
function In({ label: n, hint: i, className: t, ...s }) {
  return /* @__PURE__ */ M("label", { className: N("ns-checkbox", t), children: [
    /* @__PURE__ */ b("input", { ...s, type: "checkbox" }),
    /* @__PURE__ */ b("span", { children: n }),
    i && /* @__PURE__ */ b("span", { className: "ns-checkbox__hint", children: i })
  ] });
}
function Bn({ label: n, hint: i, error: t, children: s }) {
  const e = ys(), o = `${e}-hint`, a = `${e}-error`, p = !!t, v = !p && !!i;
  let E = s, F = e;
  if (ks(s)) {
    const k = s;
    F = k.props.id ?? e;
    const A = { id: F };
    v && (A["aria-describedby"] = o), p && (A["aria-errormessage"] = a, A["aria-invalid"] = !0), E = xs(k, A);
  }
  return /* @__PURE__ */ M("div", { className: "ns-field", children: [
    /* @__PURE__ */ b("label", { htmlFor: F, className: "ns-field__label", children: n }),
    E,
...
function Tn({ children: n, className: i }) {
  return /* @__PURE__ */ b("div", { className: N("ns-message", i), children: /* @__PURE__ */ b("p", { children: n }) });
}
function jn({
  children: n,
  selected: i,
  ...
  ) : s !== void 0 ? /* @__PURE__ */ M("span", { className: N("ns-chip", a), children: [
    n,
    /* @__PURE__ */ b(
      "button",
      {
  ...
  ] }) : /* @__PURE__ */ b("span", { className: N("ns-chip", a), children: n });
}
const en = B`
  :host {
    position: fixed;
...
`;
var sn = Object.defineProperty, vs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && sn(i, t, e), e;
}, Ft, L, I, K, y, Ue, ze, Ie, at, Rt, Wt, Ht, Vt;
const Re = class Re extends P {
  constructor() {
    ...
    d(this, Ht);
    d(this, Vt);
    this.position = "top-center", this.items = [], r(this, Ft, 0), r(this, L, !1), r(this, I, !1), r(this, K, !1), r(this, Rt, () => {
      r(this, L, !0), c(this, y, at).call(this);
    }), r(this, Wt, () => {
      r(this, L, !1), c(this, y, at).call(this);
    }), r(this, Ht, () => {
      r(this, I, !0), c(this, y, at).call(this);
    }), r(this, Vt, () => {
      r(this, I, !1), c(this, y, at).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), c(this, y, Ie).call(this);
  }
  disconnectedCallback() {
    c(this, y, ze).call(this), r(this, L, !1), r(this, I, !1), r(this, K, !1), super.disconnectedCallback();
  }
  /** 토스트 하나를 띄운다. 돌려주는 함수를 부르면 즉시 닫는다(두 번 불러도 안전). */
  show(t, s, e) {
    const o = He(this, Ft)._++, a = {
      key: o,
      message: t,
      tone: s,
      duration: e,
    ...
    return this.items = [...this.items, a], l(this, K) || c(this, y, Ue).call(this, a), () => this.dismiss(o);
  }
  ...
  updated() {
    var t;
    r(this, I, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), c(this, y, at).call(this);
  }
  render() {
    return g`
      <div
...
Ft = new WeakMap(), L = new WeakMap(), I = new WeakMap(), K = new WeakMap(), y = new WeakSet(), /*
...
*/
at = function() {
  const t = l(this, L) || l(this, I);
  t !== l(this, K) && (r(this, K, t), t ? c(this, y, ze).call(this) : c(this, y, Ie).call(this));
}, Rt = new WeakMap(), Wt = new WeakMap(), Ht = new WeakMap(), Vt = new WeakMap(), Re.styles = en;
let Dt = Re;
vs([
  u({ reflect: !0 })
], Dt.prototype, "position");
vs([
  Be()
], Dt.prototype, "items");
$("ns-toast", Dt);
...
function nn() {
  ...
  return i.position = ms, document.body.append(i), i;
}
function Ln(n) {
  if (ms = n, typeof document > "u") return;
...
function ws(n, i, t) {
  ...
  E.type = "button", E.slot = "footer", E.className = n.tone === "danger" ? "ns-button ns-button--danger ns-button--sm" : "ns-button ns-button--solid ns-button--sm", E.textContent = n.confirmLabel ?? "확인", E.addEventListener("click", () => p(!0));
  let F = null;
  if (i) {
    const k = document.createElement("button");
    k.type = "button", k.slot = "footer", k.className = "ns-button ns-button--outline ns-button--sm", k.textContent = n.cancelLabel ?? "취소", k.addEventListener("click", () => p(!1)), n.tone === "danger" && (F = k), e.append(k);
  }
  e.append(E), e.addEventListener("ns-dialog-close", () => p(!1)), document.body.append(e), e.show(), F !== null && v(F);
}
function qn(n) {
