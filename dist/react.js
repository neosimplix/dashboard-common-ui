...
var se = (n, o, t) => o.has(n) || Ie("Cannot " + t);
var c = (n, o, t) => (se(n, o, "read from private field"), t ? t.call(n) : o.get(n)), h = (n, o, t) => o.has(n) ? Ie("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(n) : o.set(n, t), l = (n, o, t, s) => (se(n, o, "write to private field"), s ? s.call(n, t) : o.set(n, t), t), r = (n, o, t) => (se(n, o, "access private method"), t);
var Te = (n, o, t, s) => ({
  set _(e) {
    l(n, o, e, t);
  },
...
import { useId as os, isValidElement as as, cloneElement as rs } from "react";
import { createComponent as S } from "@lit/react";
import { css as j, svg as ne, LitElement as P, html as v, nothing as $, ReactiveElement as Fe } from "lit";
import { svg as Dn } from "lit";
import { property as p, query as ls, state as _e } from "lit/decorators.js";
...
let ie = !1;
const ds = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  Next/React:  import "@neosimplix/common-ui/tokens.css";
  HTML:        <link rel="stylesheet" href="…/dist/tokens.css">`, je = () => getComputedStyle(document.documentElement).getPropertyValue("--ns-color-line").trim() !== "";
function C() {
  if (ie || typeof document > "u" || typeof getComputedStyle > "u") return;
  if (je()) {
    ie = !0;
    return;
  }
...
function Ut(n, o) {
  for (const [t, s] of Object.entries(o)) {
    ...
    let i = ze.get(n);
    i === void 0 && ze.set(n, i = /* @__PURE__ */ new Set()), !i.has(e) && (i.add(e), console.warn(
      `[${n.localName}] ${e} 속성은 무시됩니다 — 이 이름은 프로퍼티 전용입니다.
  HTML 에서 쓸 것: ${s}
  JS 에서는 el.${hs(t)} 에 대입합니다.`
    ));
  }
}
const hs = (n) => n.replace(/-([a-z])/g, (o, t) => t.toUpperCase()), us = j`
...
`;
var fs = Object.defineProperty, gs = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && fs(o, t, e), e;
}, st, W, Ke, oe, nt;
let Se = (nt = class extends P {
  constructor() {
    super(...arguments);
    h(this, W);
    h(this, st);
  ...
  render() {
    return v`<slot>${r(this, W, Ke).call(this)}</slot>`;
  }
  /*
  ...
  updated() {
    ...
    if (!t.some((e) => e.nodeType === Node.ELEMENT_NODE)) {
      if (t.length > 0) {
        r(this, W, oe).call(this, `공백-${this.name}`, `[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);
        return;
      }
      this.name !== "" && !Rt[this.name] && r(this, W, oe).call(this, `없음-${this.name}`, `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(Rt).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`);
    }
  }
}, st = new WeakMap(), W = new WeakSet(), Ke = function() {
  if (this.name === "") return $;
  const t = Rt[this.name];
  return t ? v`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : $;
}, /** 같은 사유로 리렌더될 때마다 찍지 않는다. */
oe = function(t, s) {
  c(this, st) !== t && (l(this, st, t), console.warn(s));
}, nt.styles = ps, nt);
gs([
  p({ type: String })
], Se.prototype, "name");
x("ns-icon", Se);
var vs = Object.defineProperty, yt = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && vs(o, t, e), e;
}, I, H, B, m, ae, re, le, Pt, Et, Mt, At, Ot, ce, Ht;
const Me = class Me extends P {
  constructor() {
    ...
    h(this, At);
    h(this, Ot);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, l(this, I, !1), l(this, H, !1), l(this, B, !1), l(this, Pt, (t) => {
      const s = t.target;
      ...
      r(this, m, Ht).call(this, "escape");
    }), l(this, Mt, () => {
      r(this, m, Ht).call(this, "close-button");
    }), l(this, At, (t) => {
      l(this, H, r(this, m, ce).call(this, t));
    }), l(this, Ot, (t) => {
      const s = c(this, H);
      l(this, H, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !r(this, m, ce).call(this, t) || r(this, m, Ht).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), Ut(this, { open: "default-open" });
    const t = this.dialogEl;
    t != null && t.open && (l(this, B, !0), t.close()), this.requestUpdate();
  }
  /*
   ...
   */
  show() {
    r(this, m, le).call(this, "show") || (l(this, I, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    r(this, m, le).call(this, "close") || (l(this, I, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (c(this, m, re) && !t.open ? this.isConnected && t.showModal() : !c(this, m, re) && t.open && (l(this, B, !0), t.close()));
  }
  render() {
    return v`
      <dialog
      ...
      >
        <div class="header">
          ...
          <button class="close" type="button" aria-label="닫기" @click=${c(this, Mt)}>
            <ns-icon name="close"></ns-icon>
          </button>
        </div>
        <div class="body"><slot></slot></div>
        <div class="footer" ?hidden=${!this.hasFooter}>
          <slot name="footer" @slotchange=${c(this, Pt)}></slot>
        </div>
      </dialog>
    `;
  }
};
I = new WeakMap(), H = new WeakMap(), B = new WeakMap(), m = new WeakSet(), ae = function() {
  return this.open !== void 0;
}, re = function() {
  return this.open ?? c(this, I);
}, le = function(t) {
  return c(this, m, ae) ? (console.warn(
    `[ns-dialog] open 프로퍼티가 설정된 제어 모드에서는 ${t}() 가 동작하지 않습니다. open 을 바꾸세요.`
  ), !0) : !1;
}, Pt = new WeakMap(), Et = new WeakMap(), Mt = new WeakMap(), At = new WeakMap(), Ot = new WeakMap(), /*
...
`;
var ms = Object.defineProperty, Re = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && ms(o, t, e), e;
}, Dt, it;
let Yt = (it = class extends P {
  constructor() {
    super(...arguments);
    h(this, Dt);
    this.projectName = "", this.sidebarOpen = !1, l(this, Dt, () => {
...
}, Dt = new WeakMap(), it.styles = bs, it);
Re([
  p({ type: String, attribute: "project-name" })
], Yt.prototype, "projectName");
Re([
  p({ type: Boolean, reflect: !0, attribute: "sidebar-open" })
], Yt.prototype, "sidebarOpen");
x("ns-header", Yt);
var ys = Object.defineProperty, F = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && ys(o, t, e), e;
}, It, O, He, de, he, Be;
let D = (Be = class extends P {
  constructor() {
    super(...arguments);
    h(this, O);
    /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), Ut(this, {
  ...
  render() {
    const t = c(this, O, de), s = t.flatMap((a) => this.options.filter((u) => u.value === a)), e = this.query.trim().toLowerCase(), i = e === "" ? this.options : this.options.filter(
    ...
    return v`
      ...
      (a) => v`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => r(this, O, he).call(this, a.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      <div class="ns-multi-select__list">
        ${i.length === 0 ? v`<p class="ns-multi-select__empty">${this.emptyMessage}</p>` : Jt(
      i,
      (a) => a.value,
      (a) => v`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(u) => r(this, O, he).call(this, a.value, u.target)}
                  />
                  <span>${a.label}</span>
                  ${a.meta === void 0 ? $ : v`<span class="ns-checkbox__hint">${a.meta}</span>`}
                </label>
              `
    )}
      </div>
...
}, It = new WeakMap(), O = new WeakSet(), He = function() {
  return this.value !== void 0;
}, de = function() {
  return this.value ?? c(this, It) ?? this.defaultValue;
}, /**
 * @param item   토글할 값
 * @param source 이 토글을 일으킨 네이티브 체크박스. 칩의 제거 버튼에는 없다.
 */
he = function(t, s) {
  const e = c(this, O, de), i = e.includes(t) ? e.filter((u) => u !== t) : [...e, t];
  c(this, O, He) ? s !== void 0 && (s.checked = e.includes(t)) : (l(this, It, i), this.requestUpdate());
  const a = { values: i };
  this.dispatchEvent(
...
`;
var ks = Object.defineProperty, $s = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && ks(o, t, e), e;
}, ot;
let Pe = (ot = class extends P {
  constructor() {
...
`;
var Cs = Object.defineProperty, Qt = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Cs(o, t, e), e;
}, Tt, at;
let wt = (at = class extends P {
  constructor() {
    super(...arguments);
    h(this, Tt);
    this.href = "", this.label = "", this.badge = "", this.active = !1, l(this, Tt, (t) => {
  ...
  render() {
    return v`
      <a class="row" href=${this.href} title=${this.label} @click=${c(this, Tt)}>
        <span class="leading">
          <slot name="leading">
...
}, Tt = new WeakMap(), at.styles = xs, at);
Qt([
  p({ type: String })
], wt.prototype, "href");
Qt([
...
`;
var _s = Object.defineProperty, Ve = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && _s(o, t, e), e;
};
...
Ve([
  p({ type: String })
], mt.prototype, "description");
x("ns-page-heading", mt);
var Ss = Object.defineProperty, te = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Ss(o, t, e), e;
};
function Ps(n, o) {
  ...
  const t = [1, n - 1, n, n + 1, o].filter((i) => i >= 1 && i <= o).sort((i, a) => i - a), s = [];
  let e = 0;
  for (const i of t)
    i !== e && (e !== 0 && i - e > 1 && s.push("gap"), s.push(i), e = i);
  return s;
}
var L, rt, lt, ct, V, y, ue, Vt, pe, Xe, Xt, Le;
let kt = (Le = class extends P {
  constructor() {
    super(...arguments);
    h(this, y);
    h(this, L);
    ...
    h(this, ct);
    h(this, V);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, l(this, L, 1), l(this, rt, !1), l(this, lt, !1), l(this, ct, !1), l(this, V, null);
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), Ut(this, { page: "default-page" });
  }
  /*
  ...
  */
  updated() {
    var i;
    const t = c(this, V);
    if (t === null || (l(this, V, null), (this.page ?? c(this, L)) !== t.page)) return;
    ...
    return v`
      <nav aria-label="페이지 이동">
        <button
          ...
          @click=${() => r(this, y, Xt).call(this, "prev", s - 1)}
        >
          이전
        </button>
        ${Jt(
      ...
      */
      ...
      (e) => e === "gap" ? v`<span class="ns-pagination-gap" aria-hidden="true">…</span>` : v`<button
                  ...
                  @click=${() => r(this, y, Xt).call(this, e, e)}
                >
                  ${e}
                </button>`
    )}
        <button
          ...
          @click=${() => r(this, y, Xt).call(this, "next", s + 1)}
        >
          다음
        </button>
      </nav>
...
}, L = new WeakMap(), rt = new WeakMap(), lt = new WeakMap(), ct = new WeakMap(), V = new WeakMap(), y = new WeakSet(), ue = function() {
  return this.page !== void 0;
}, Vt = function() {
  return this.perPage > 0 ? !Number.isFinite(this.total) || this.total < 0 ? (c(this, ct) || (l(this, ct, !0), console.warn(
    `[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0) : Math.ceil(this.total / this.perPage) : (c(this, lt) || (l(this, lt, !0), console.warn(
 ...
 */
pe = function() {
  const t = this.page ?? c(this, L), s = c(this, y, Vt);
  if (Number.isInteger(t) && t >= 1 && t <= s) return t;
  const e = Number.isFinite(t) ? Math.min(Math.max(Math.round(t), 1), Math.max(s, 1)) : 1;
  return c(this, rt) || (l(this, rt, !0), console.warn(
    c(this, y, ue) ? `[ns-pagination] page=${t} 가 1..${s} 범위를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.` : `[ns-pagination] 현재 페이지 ${t} 가 total=${this.total} · per-page=${this.perPage} 로 계산된 페이지 수(${s})를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.`
  )), e;
}, /** 이동했으면(= 이벤트를 냈으면) true. */
Xe = function(t) {
  if (!Number.isInteger(t) || t < 1 || t > c(this, y, Vt) || t === r(this, y, pe).call(this)) return !1;
  c(this, y, ue) || (l(this, L, t), this.requestUpdate());
  const s = { page: t };
...
*/
Xt = function(t, s) {
  r(this, y, Xe).call(this, s) && l(this, V, { control: t, page: s });
}, Le);
te([
  p({ type: Number })
], kt.prototype, "total");
...
], kt.prototype, "perPage");
te([
  p({ attribute: !1 })
], kt.prototype, "page");
te([
  p({ type: Number, attribute: "default-page" })
], kt.prototype, "defaultPage");
x("ns-pagination", kt);
const Es = j`
  /*
...
`;
var Ms = Object.defineProperty, As = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Ms(o, t, e), e;
};
...
`;
var Ds = Object.defineProperty, Ee = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Ds(o, t, e), e;
};
const Is = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var Wt, Ze, dt;
let Ft = (dt = class extends P {
  constructor() {
    super(...arguments);
    h(this, Wt);
  ...
  render() {
    return v`
      <div
        class="bar"
        aria-hidden="true"
        style="width:${this.width};height:${this.height};border-radius:${r(this, Wt, Ze).call(this)}"
      ></div>
    `;
  }
}, Wt = new WeakSet(), Ze = function() {
  return Is.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, dt.styles = Os, dt);
Ee([
  p({ type: String })
], Ft.prototype, "width");
...
x("ns-skeleton", Ft);
var Ts = Object.defineProperty, Kt = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Ts(o, t, e), e;
};
...
var X, Z, G, ht, ut, d, Ge, fe, ge, Je, tt, ve, pt, Zt, K, xt, be, We, Ye, Ct, Qe, qe;
let Y = (qe = class extends Fe {
  constructor() {
    super(...arguments);
    h(this, d);
    h(this, X);
    ...
    h(this, ut);
    h(this, pt);
    this.defaultSortKey = "", this.defaultSortDirection = "none", l(this, X, ""), l(this, Z, "none"), l(this, ht, !1), l(this, pt, (t) => {
      const s = t.target, e = s == null ? void 0 : s.closest(
        'input[type="checkbox"][data-ns-select-all], input[type="checkbox"][data-ns-row-id]'
      );
      if (e && r(this, d, tt).call(this, e)) {
        r(this, d, Qe).call(this, e);
        return;
      }
      const i = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!i || !r(this, d, tt).call(this, i)) return;
      const a = i.dataset.nsSortKey ?? "", u = a === c(this, d, fe) ? js(c(this, d, ge)) : "ascending", b = u === "none" ? "" : a;
      c(this, d, Ge) || (l(this, X, b), l(this, Z, u), this.requestUpdate());
  ...
  connectedCallback() {
    ...
    }), this.addEventListener("click", c(this, pt)), l(this, ut, new MutationObserver(() => {
      r(this, d, ve).call(this), r(this, d, xt).call(this), r(this, d, Ye).call(this);
    })), c(this, ut).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", c(this, pt)), (t = c(this, ut)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && l(this, X, this.defaultSortKey), this.defaultSortDirection !== "none" && l(this, Z, this.defaultSortDirection), this.selected === void 0 && l(this, G, r(this, d, be).call(this));
  }
  updated() {
    r(this, d, Je).call(this), r(this, d, ve).call(this), r(this, d, xt).call(this);
  }
}, X = new WeakMap(), Z = new WeakMap(), G = new WeakMap(), ht = new WeakMap(), ut = new WeakMap(), d = new WeakSet(), Ge = function() {
  return this.sortKey !== void 0;
}, fe = function() {
  return this.sortKey ?? c(this, X);
}, ge = function() {
  return this.sortDirection ?? c(this, Z);
}, /*
  ...
  */
Je = function() {
  c(this, ht) || this.sortDirection === void 0 || this.sortKey !== void 0 || (l(this, ht, !0), console.warn(
...
tt = function(t) {
  ...
  */
ve = function() {
  const t = c(this, d, fe), s = c(this, d, ge);
  for (const e of this.querySelectorAll("th[data-ns-sort-key]"))
    r(this, d, tt).call(this, e) && (e.dataset.nsSortKey === t && s !== "none" ? e.setAttribute("aria-sort", s) : e.removeAttribute("aria-sort"));
}, pt = new WeakMap(), /*
...
xt = function() {
  ...
  ].filter((b) => r(this, d, tt).call(this, b));
  if (t.length === 0) return;
  const s = r(this, d, Zt).call(this), e = this.selected, i = e === void 0 ? s.filter((b) => b.checked).length : s.filter((b) => e.includes(r(this, d, K).call(this, b))).length, a = s.length > 0 && i === s.length, u = i > 0 && i < s.length;
  for (const b of t)
    b.checked = a, b.indeterminate = u;
}, /** 비제어 모드의 진실 — DOM 이다. 행 순서를 그대로 따른다. */
be = function() {
  return r(this, d, Zt).call(this).filter((t) => t.checked).map((t) => r(this, d, K).call(this, t));
}, /*
...
Ye = function() {
  ...
  const t = r(this, d, be).call(this), s = c(this, G);
  if (!(s !== void 0 && r(this, d, We).call(this, s, t))) {
    if (s === void 0 || this.ownerDocument.readyState === "loading") {
      l(this, G, t);
      return;
    }
    r(this, d, Ct).call(this, t);
  }
}, Ct = function(t) {
  l(this, G, t);
  const s = { ids: t };
 ...
 */
Qe = function(t) {
  const s = r(this, d, Zt).call(this);
  if (t.hasAttribute("data-ns-select-all")) {
    if (this.selected === void 0)
      for (const u of s) u.checked = t.checked;
    r(this, d, Ct).call(this, t.checked ? s.map((u) => r(this, d, K).call(this, u)) : []), this.selected === void 0 && r(this, d, xt).call(this);
    return;
  }
  if (!t.hasAttribute("data-ns-row-id")) return;
  let e;
  if (this.selected === void 0) {
    e = s.filter((u) => u.checked).map((u) => r(this, d, K).call(this, u)), r(this, d, Ct).call(this, e), r(this, d, xt).call(this);
    return;
  }
  const i = new Set(this.selected), a = r(this, d, K).call(this, t);
  t.checked ? i.add(a) : i.delete(a), e = s.map((u) => r(this, d, K).call(this, u)).filter((u) => i.has(u)), r(this, d, Ct).call(this, e);
}, qe);
Kt([
  p({ attribute: !1 })
], Y.prototype, "sortKey");
Kt([
  p({ attribute: !1 })
], Y.prototype, "sortDirection");
Kt([
  p({ type: String, attribute: "default-sort-key" })
], Y.prototype, "defaultSortKey");
Kt([
  p({ type: String, attribute: "default-sort-direction" })
], Y.prototype, "defaultSortDirection");
Kt([
  p({ attribute: !1 })
], Y.prototype, "selected");
x("ns-table", Y);
var zs = Object.defineProperty, ts = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && zs(o, t, e), e;
};
...
var J, ft, gt, f, me, Nt, R, ye, Gt, we, ke, $e, vt, bt, Ue;
let ee = (Ue = class extends Fe {
  constructor() {
    super(...arguments);
    h(this, f);
    h(this, J);
    ...
    h(this, vt);
    h(this, bt);
    this.defaultActive = "", l(this, J, ""), l(this, gt, !1), l(this, vt, (t) => {
      const s = r(this, f, $e).call(this, t.target);
      s !== null && r(this, f, we).call(this, r(this, f, R).call(this, s), !1);
    }), l(this, bt, (t) => {
      const s = r(this, f, $e).call(this, t.target);
      if (s === null) return;
      const e = c(this, f, Nt), i = e.indexOf(s);
      if (i === -1) return;
      const a = (u) => {
        t.preventDefault(), r(this, f, we).call(this, r(this, f, R).call(this, e[(u + e.length) % e.length]), !0);
      };
  ...
  connectedCallback() {
    super.connectedCallback(), C(), Ut(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", c(this, vt)), this.addEventListener("keydown", c(this, bt)), l(this, ft, new MutationObserver(() => r(this, f, Gt).call(this))), c(this, ft).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", c(this, vt)), this.removeEventListener("keydown", c(this, bt)), (t = c(this, ft)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
    ...
    */
  firstUpdated() {
    this.defaultActive !== "" && l(this, J, this.defaultActive);
  }
  updated() {
    r(this, f, Gt).call(this);
  }
}, J = new WeakMap(), ft = new WeakMap(), gt = new WeakMap(), f = new WeakSet(), me = function() {
  ...
  const t = c(this, f, Nt);
  if (t.length === 0) return "";
  const s = this.active ?? c(this, J);
  if (t.some((i) => r(this, f, R).call(this, i) === s)) return s;
  const e = r(this, f, R).call(this, t[0]);
  return s !== "" && !c(this, gt) && (l(this, gt, !0), console.warn(
    c(this, f, me) ? `[ns-tabs] active="${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시하지만 그 탭을 눌러도 ns-tab-change 가 나가지 않습니다. 대소문자까지 맞는지 확인하세요.` : `[ns-tabs] 활성 탭 "${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시합니다. default-active 값이 data-ns-tab 과 맞는지 확인하세요.`
  )), e;
}, /** 소비자 DOM 에 ARIA 와 roving tabindex 를 쓴다. 멱등이다. */
Gt = function() {
  const t = c(this, f, ye);
  for (const s of c(this, f, Nt)) {
    const e = r(this, f, R).call(this, s), i = s.dataset.nsPanel ?? "";
    s.setAttribute("role", "tab"), !s.hasAttribute("id") && i !== "" && s.setAttribute("id", Bs(i)), i !== "" && s.setAttribute("aria-controls", i), s.setAttribute("aria-selected", e === t ? "true" : "false"), s.setAttribute("tabindex", e === t ? "0" : "-1");
  }
}, we = function(t, s) {
  if (t === "") return;
  if (t === c(this, f, ye)) {
    s && r(this, f, ke).call(this, t);
    return;
  }
  c(this, f, me) || (l(this, J, t), this.requestUpdate());
  const e = { id: t };
  this.dispatchEvent(
    new CustomEvent("ns-tab-change", { detail: e, bubbles: !0, composed: !0 })
  ), r(this, f, Gt).call(this), s && r(this, f, ke).call(this, t);
}, ke = function(t) {
  var s;
  (s = c(this, f, Nt).find((e) => r(this, f, R).call(this, e) === t)) == null || s.focus();
...
}, vt = new WeakMap(), bt = new WeakMap(), Ue);
ts([
  p({ attribute: !1 })
], ee.prototype, "active");
ts([
  p({ type: String, attribute: "default-active" })
], ee.prototype, "defaultActive");
x("ns-tabs", ee);
const nn = S({
  react: _,
  tagName: "ns-header",
...
function pn({ title: n, description: o, className: t }) {
  return /* @__PURE__ */ g(qs, { heading: n, description: o ?? "", className: t });
}
function fn({
  open: n,
  title: o,
  ...
  return /* @__PURE__ */ M(
    Us,
    {
      ...
      children: [
        s,
        e != null && /* @__PURE__ */ g("div", { slot: "footer", children: e })
      ]
    }
  );
}
function gn({ open: n, onNavigate: o, children: t, className: s, style: e }) {
  return /* @__PURE__ */ g(
    Ls,
    {
      open: n,
...
function es({ variant: n = "solid", size: o = "md", fullWidth: t = !1 }, s) {
  return N(
    "ns-button",
    `ns-button--${n}`,
...
function vn({
  ...
  return /* @__PURE__ */ g(
    ...
    {
      type: e,
      className: es({ variant: n, size: o, fullWidth: t }, s),
      ...i
    }
  );
}
function bn({
  ...
  return /* @__PURE__ */ g("a", { className: es({ variant: n, size: o, fullWidth: t }, s), ...e });
}
function mn({
  className: n,
  children: o,
...
function yn({
  ...
  return /* @__PURE__ */ M(
    "details",
    {
      className: N("ns-accordion", `ns-accordion--${i}`, e),
      open: t,
      children: [
        /* @__PURE__ */ g("summary", { children: i === "plain" ? n : /* @__PURE__ */ M(cs, { children: [
...
function wn({ invalid: n = !1, className: o, ...t }) {
  return /* @__PURE__ */ g(
    "input",
    {
...
function kn({ invalid: n = !1, className: o, rows: t = 3, ...s }) {
  return /* @__PURE__ */ g(
    "textarea",
    {
...
function $n({
  ...
  const u = e !== void 0 ? void 0 : i !== void 0 ? i : o !== void 0 ? "" : void 0;
  return /* @__PURE__ */ M(
    "select",
    {
...
function xn({ label: n, hint: o, className: t, ...s }) {
...
function Cn({ label: n, hint: o, error: t, children: s }) {
  const e = os(), i = `${e}-hint`, a = `${e}-error`, u = !!t, b = !u && !!o;
  let E = s, z = e;
  if (as(s)) {
    const Q = s;
    z = Q.props.id ?? e;
    const k = { id: z };
    b && (k["aria-describedby"] = i), u && (k["aria-errormessage"] = a, k["aria-invalid"] = !0), E = rs(Q, k);
  }
  return /* @__PURE__ */ M("div", { className: "ns-field", children: [
    /* @__PURE__ */ g("label", { htmlFor: z, className: "ns-field__label", children: n }),
    E,
    u ? /* @__PURE__ */ g("span", { id: a, className: "ns-field__error", children: t }) : b ? /* @__PURE__ */ g("span", { id: i, className: "ns-field__hint", children: o }) : null
  ] });
}
function Nn({ children: n, className: o }) {
...
`;
var Ks = Object.defineProperty, ss = (n, o, t, s) => {
  for (var e = void 0, i = n.length - 1, a; i >= 0; i--)
    (a = n[i]) && (e = a(o, t, e) || e);
  return e && Ks(o, t, e), e;
}, jt, q, T, U, w, xe, Ce, Ne, et, zt, Bt, Lt, qt;
const De = class De extends P {
  constructor() {
    ...
    h(this, Lt);
    h(this, qt);
    this.position = "top-center", this.items = [], l(this, jt, 0), l(this, q, !1), l(this, T, !1), l(this, U, !1), l(this, zt, () => {
      l(this, q, !0), r(this, w, et).call(this);
    }), l(this, Bt, () => {
      l(this, q, !1), r(this, w, et).call(this);
    }), l(this, Lt, () => {
      l(this, T, !0), r(this, w, et).call(this);
    }), l(this, qt, () => {
      l(this, T, !1), r(this, w, et).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), r(this, w, Ne).call(this);
  }
  disconnectedCallback() {
    r(this, w, Ce).call(this), l(this, q, !1), l(this, T, !1), l(this, U, !1), super.disconnectedCallback();
  }
  /** 토스트 하나를 띄운다. 돌려주는 함수를 부르면 즉시 닫는다(두 번 불러도 안전). */
  show(t, s, e) {
    const i = Te(this, jt)._++, a = {
      key: i,
      message: t,
      tone: s,
      duration: e,
    ...
    return this.items = [...this.items, a], c(this, U) || r(this, w, xe).call(this, a), () => this.dismiss(i);
  }
  ...
  updated() {
    var t;
    l(this, T, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), r(this, w, et).call(this);
  }
  render() {
    return v`
      <div
      ...
      (t) => v`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : $}>
              ${t.tone === "neutral" ? $ : v`<span class="dot" aria-hidden="true"></span>`}
...
jt = new WeakMap(), q = new WeakMap(), T = new WeakMap(), U = new WeakMap(), w = new WeakSet(), /*
...
Ce = function() {
  ...
  for (const t of this.items) r(this, w, xe).call(this, t);
}, /*
  두 사유를 하나의 적용 상태로 접는다. 사유가 바뀔 때마다 부르고, 실제 정지·재개는
  상태가 뒤집힐 때만 일어난다.
*/
et = function() {
  const t = c(this, q) || c(this, T);
  t !== c(this, U) && (l(this, U, t), t ? r(this, w, Ce).call(this) : r(this, w, Ne).call(this));
}, zt = new WeakMap(), Bt = new WeakMap(), Lt = new WeakMap(), qt = new WeakMap(), De.styles = Fs;
let St = De;
ss([
  p({ reflect: !0 })
...
function Rs() {
  ...
  return o.position = ns, document.body.append(o), o;
}
function Sn(n) {
...
function is(n, o, t) {
  ...
  z.append(E), e.append(z), e.addEventListener("ns-dialog-close", () => u(!1)), document.body.append(e), e.show(), Q !== null && b(Q);
}
function En(n) {
