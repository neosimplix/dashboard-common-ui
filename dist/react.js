...
import { useId as ys, isValidElement as xs, cloneElement as ks } from "react";
import { createComponent as S } from "@lit/react";
import { css as I, svg as Yt, LitElement as P, html as g, nothing as k, ReactiveElement as Qe } from "lit";
import { svg as Hn } from "lit";
import { property as u, query as $s, state as Ie } from "lit/decorators.js";
...
const _s = (n) => n.replace(/-([a-z])/g, (i, t) => t.toUpperCase()), Ss = I`
...
let Be = (lt = class extends P {
  ...
  return t ? g`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : k;
...
var Ms = Object.defineProperty, Et = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ms(i, t, e), e;
}, U, H, B, w, ge, ve, me, zt, Ut, Tt, It, Bt, we, ee;
const Ke = class Ke extends P {
  constructor() {
    ...
    d(this, It);
    d(this, Bt);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, r(this, U, !1), r(this, H, !1), r(this, B, !1), r(this, zt, (t) => {
      const s = t.target;
  ...
  connectedCallback() {
    ...
    t != null && t.open && (r(this, B, !0), t.close()), this.requestUpdate();
  }
  /*
   ...
   */
  show() {
    c(this, w, me).call(this, "show") || (r(this, U, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    c(this, w, me).call(this, "close") || (r(this, U, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (l(this, w, ve) && !t.open ? this.isConnected && t.showModal() : !l(this, w, ve) && t.open && (r(this, B, !0), t.close()));
  }
  /*
    ...
    return g`
      ...
      >
        <div class="header">
          ...
          <button class="close" type="button" aria-label="닫기" @click=${l(this, Tt)}>
            <ns-icon name="close"></ns-icon>
          </button>
        </div>
        <div class="body"><slot></slot></div>
        <div class="footer" ?hidden=${!this.hasFooter}>
          <slot name="footer" @slotchange=${l(this, zt)}></slot>
        </div>
      </dialog>
    `;
  }
};
U = new WeakMap(), H = new WeakMap(), B = new WeakMap(), w = new WeakSet(), ge = function() {
...
}, zt = new WeakMap(), Ut = new WeakMap(), Tt = new WeakMap(), It = new WeakMap(), Bt = new WeakMap(), /*
...
$("ns-header", ce);
var zs = Object.defineProperty, q = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && zs(i, t, e), e;
}, Lt, D, ss, ye, xe, Xe;
let z = (Xe = class extends P {
  constructor() {
    super(...arguments);
    d(this, D);
    /*
  ...
  render() {
    ...
    return g`
      ...
      (a) => g`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => c(this, D, xe).call(this, a.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      <input
        class="ns-input"
        type="text"
        id=${this.inputId === "" ? k : this.inputId}
        aria-describedby=${this.inputDescribedby === "" ? k : this.inputDescribedby}
        .value=${this.query}
      ...
      (a) => g`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(p) => c(this, D, xe).call(this, a.value, p.target)}
                  />
                  <span>${a.label}</span>
                  ${a.meta === void 0 ? k : g`<span class="ns-checkbox__hint">${a.meta}</span>`}
                </label>
              `
    )}
      </div>
...
`;
var Ts = Object.defineProperty, de = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ts(i, t, e), e;
}, V, dt, G, et, ns, ke, Kt, ht;
...
`;
var Bs = Object.defineProperty, je = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Bs(i, t, e), e;
}, qt, ut;
...
}, qt = new WeakMap(), ut.styles = Is, ut);
je([
  u({ type: String })
], Gt.prototype, "href");
je([
...
const qe = class qe extends P {
  ...
  render() {
    return g`
      <h1>${this.heading}</h1>
      ${this.description ? g`<p>${this.description}</p>` : k}
    `;
  }
};
qe.styles = js;
...
var Z, J, Y, wt, yt, h, ds, Ne, _e, hs, ot, Se, xt, ie, R, At, Ee, us, ps, Mt, fs, Je;
let it = (Je = class extends Qe {
  constructor() {
    ...
    d(this, yt);
    d(this, xt);
    this.defaultSortKey = "", this.defaultSortDirection = "none", r(this, Z, ""), r(this, J, "none"), r(this, wt, !1), r(this, xt, (t) => {
  ...
  connectedCallback() {
    ...
    }), this.addEventListener("click", l(this, xt)), r(this, yt, new MutationObserver(() => {
      c(this, h, Se).call(this), c(this, h, At).call(this), c(this, h, ps).call(this);
    })), l(this, yt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, xt)), (t = l(this, yt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
...
var Q, kt, $t, f, Pe, Ot, W, Ae, oe, Me, Oe, De, Ct, Nt, Ye;
let he = (Ye = class extends Qe {
  ...
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", l(this, Ct)), this.addEventListener("keydown", l(this, Nt)), r(this, kt, new MutationObserver(() => c(this, f, oe).call(this))), l(this, kt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, Ct)), this.removeEventListener("keydown", l(this, Nt)), (t = l(this, kt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
...
}, Q = new WeakMap(), kt = new WeakMap(), $t = new WeakMap(), f = new WeakSet(), Pe = function() {
...
function zn({ invalid: n = !1, className: i, rows: t = 3, ...s }) {
  return /* @__PURE__ */ b(
    "textarea",
    {
...
function Tn({ label: n, hint: i, className: t, ...s }) {
...
function In({ label: n, hint: i, error: t, children: s }) {
  ...
  if (xs(s)) {
    ...
    F = x.props.id ?? e;
    const A = { id: F };
    v && (A["aria-describedby"] = o), p && (A["aria-errormessage"] = a, A["aria-invalid"] = !0), E = ks(x, A);
  }
...
function Bn({ children: n, className: i }) {
...
var sn = Object.defineProperty, vs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && sn(i, t, e), e;
}, Ft, L, T, K, y, ze, Ue, Te, at, Rt, Wt, Ht, Vt;
const Re = class Re extends P {
  constructor() {
    ...
    d(this, Ht);
    d(this, Vt);
    this.position = "top-center", this.items = [], r(this, Ft, 0), r(this, L, !1), r(this, T, !1), r(this, K, !1), r(this, Rt, () => {
      r(this, L, !0), c(this, y, at).call(this);
    }), r(this, Wt, () => {
      r(this, L, !1), c(this, y, at).call(this);
    }), r(this, Ht, () => {
      r(this, T, !0), c(this, y, at).call(this);
    }), r(this, Vt, () => {
      r(this, T, !1), c(this, y, at).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), c(this, y, Te).call(this);
  }
  disconnectedCallback() {
    c(this, y, Ue).call(this), r(this, L, !1), r(this, T, !1), r(this, K, !1), super.disconnectedCallback();
  }
  ...
  show(t, s, e) {
    ...
    return this.items = [...this.items, a], l(this, K) || c(this, y, ze).call(this, a), () => this.dismiss(o);
  }
  ...
  updated() {
    var t;
    r(this, T, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), c(this, y, at).call(this);
  }
  render() {
    return g`
      <div
      ...
      (t) => t.key,
      (t) => g`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : k}>
              ${t.tone === "neutral" ? k : g`<span class="dot" aria-hidden="true"></span>`}
...
Ft = new WeakMap(), L = new WeakMap(), T = new WeakMap(), K = new WeakMap(), y = new WeakSet(), /*
...
Ue = function() {
  ...
  for (const t of this.items) c(this, y, ze).call(this, t);
}, /*
  두 사유를 하나의 적용 상태로 접는다. 사유가 바뀔 때마다 부르고, 실제 정지·재개는
  상태가 뒤집힐 때만 일어난다.
*/
at = function() {
  const t = l(this, L) || l(this, T);
  t !== l(this, K) && (r(this, K, t), t ? c(this, y, Ue).call(this) : c(this, y, Te).call(this));
...
function ws(n, i, t) {
  ...
  const p = (x) => {
    ...
    for (let A = 0; A < 5; A++)
      if (await e.updateComplete, a || (x.focus({ preventScroll: !0 }), document.activeElement === x)) return;
    console.warn(
  ...
  if (i) {
    ...
    x.type = "button", x.slot = "footer", x.className = "ns-button ns-button--outline ns-button--sm", x.textContent = n.cancelLabel ?? "취소", x.addEventListener("click", () => p(!1)), n.tone === "danger" && (F = x), e.append(x);
  }
