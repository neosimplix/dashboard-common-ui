...
var l = (n, i, t) => (ue(n, i, "read from private field"), t ? t.call(n) : i.get(n)), d = (n, i, t) => i.has(n) ? We("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(n) : i.set(n, t), a = (n, i, t, s) => (ue(n, i, "write to private field"), s ? s.call(n, t) : i.set(n, t), t), c = (n, i, t) => (ue(n, i, "access private method"), t);
var He = (n, i, t, s) => ({
  set _(e) {
    a(n, i, e, t);
  },
...
import { useId as ws, isValidElement as ks, cloneElement as xs } from "react";
import { createComponent as S } from "@lit/react";
import { css as B, svg as Yt, LitElement as E, html as b, nothing as x, ReactiveElement as Qe } from "lit";
...
import { jsx as g, jsxs as M, Fragment as Cs } from "react/jsx-runtime";
function $(n, i) {
...
function st(n, i) {
  for (const [t, s] of Object.entries(i)) {
    const e = [t, t.replaceAll("-", "")].find((r) => n.hasAttribute(r));
...
`;
var Es = Object.defineProperty, As = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (e = r(i, t, e) || e);
  return e && Es(i, t, e), e;
}, at, tt, ts, ge, lt;
let Te = (lt = class extends E {
  constructor() {
    super(...arguments);
    d(this, tt);
    d(this, at);
  ...
  render() {
    return b`<slot>${c(this, tt, ts).call(this)}</slot>`;
  }
  /*
  ...
  updated() {
    ...
    if (!t.some((e) => e.nodeType === Node.ELEMENT_NODE)) {
      if (t.length > 0) {
        c(this, tt, ge).call(this, `공백-${this.name}`, `[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);
        return;
      }
      this.name !== "" && !te[this.name] && c(this, tt, ge).call(this, `없음-${this.name}`, `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(te).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`);
    }
  }
}, at = new WeakMap(), tt = new WeakSet(), ts = function() {
  if (this.name === "") return x;
  const t = te[this.name];
  return t ? b`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : x;
}, /** 같은 사유로 리렌더될 때마다 찍지 않는다. */
ge = function(t, s) {
  l(this, at) !== t && (a(this, at, t), console.warn(s));
}, lt.styles = Ps, lt);
As([
  u({ type: String })
], Te.prototype, "name");
$("ns-icon", Te);
var Ms = Object.defineProperty, Pt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (e = r(i, t, e) || e);
  return e && Ms(i, t, e), e;
}, z, H, T, y, be, ve, me, Ut, zt, It, Bt, Tt, ye, ee;
const Ke = class Ke extends E {
  constructor() {
    ...
    d(this, Bt);
    d(this, Tt);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, a(this, z, !1), a(this, H, !1), a(this, T, !1), a(this, Ut, (t) => {
      const s = t.target;
      ...
      c(this, y, ee).call(this, "escape");
    }), a(this, It, () => {
      c(this, y, ee).call(this, "close-button");
    }), a(this, Bt, (t) => {
      a(this, H, c(this, y, ye).call(this, t));
    }), a(this, Tt, (t) => {
      const s = l(this, H);
      a(this, H, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !c(this, y, ye).call(this, t) || c(this, y, ee).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { open: "default-open" });
    const t = this.dialogEl;
    t != null && t.open && (a(this, T, !0), t.close()), this.requestUpdate();
  }
  /*
   ...
   */
  show() {
    c(this, y, me).call(this, "show") || (a(this, z, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    c(this, y, me).call(this, "close") || (a(this, z, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (l(this, y, ve) && !t.open ? this.isConnected && t.showModal() : !l(this, y, ve) && t.open && (a(this, T, !0), t.close()));
  }
  render() {
    return b`
      <dialog
...
z = new WeakMap(), H = new WeakMap(), T = new WeakMap(), y = new WeakSet(), be = function() {
  return this.open !== void 0;
}, ve = function() {
  return this.open ?? l(this, z);
}, me = function(t) {
  return l(this, y, be) ? (console.warn(
...
let ce = (ct = class extends E {
  constructor() {
    super(...arguments);
    d(this, jt);
    this.projectName = "", this.sidebarOpen = !1, a(this, jt, () => {
...
let U = (Xe = class extends E {
  ...
  render() {
    const t = l(this, D, we), s = t.flatMap((r) => this.options.filter((p) => p.value === r)), e = this.query.trim().toLowerCase(), o = e === "" ? this.options : this.options.filter(
      (r) => [r.label, r.meta ?? ""].some((p) => p.toLowerCase().includes(e))
    );
    return b`
      ${s.length === 0 ? x : b`
      ...
      (r) => b`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => c(this, D, ke).call(this, r.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      <div class="ns-multi-select__list">
        ${o.length === 0 ? b`<p class="ns-multi-select__empty">${this.emptyMessage}</p>` : re(
      o,
      (r) => r.value,
      (r) => b`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(p) => c(this, D, ke).call(this, r.value, p.target)}
                  />
                  <span>${r.label}</span>
                  ${r.meta === void 0 ? x : b`<span class="ns-checkbox__hint">${r.meta}</span>`}
                </label>
              `
    )}
      </div>
 ...
 */
ke = function(t, s) {
  const e = l(this, D, we), o = e.includes(t) ? e.filter((p) => p !== t) : [...e, t];
  l(this, D, ss) ? s !== void 0 && (s.checked = e.includes(t)) : (a(this, Lt, o), this.requestUpdate());
  const r = { values: o };
  this.dispatchEvent(
...
let Et = (ht = class extends E {
  constructor() {
    ...
    d(this, G);
    d(this, Kt);
    this.heading = "", this.collapsible = !1, this.defaultCollapsed = !1, a(this, V, !1), a(this, dt, !1), a(this, G, !1), a(this, Kt, () => {
      const t = !l(this, et, xe);
      a(this, dt, !0), l(this, et, ns) || (a(this, V, !t), this.requestUpdate());
      const s = { open: t };
      this.dispatchEvent(
  ...
  connectedCallback() {
    ...
    t !== l(this, G) && (a(this, G, t), this.requestUpdate());
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultCollapsed") && !l(this, dt) && a(this, V, this.defaultCollapsed);
  }
  render() {
    const t = l(this, et, xe);
    return b`
...
de([
  u({ type: Boolean })
], Et.prototype, "collapsible");
de([
  u({ attribute: !1 })
], Et.prototype, "open");
de([
  u({ type: Boolean, attribute: "default-collapsed" })
], Et.prototype, "defaultCollapsed");
$("ns-nav-group", Et);
const Bs = B`
  :host {
    display: block;
...
let Gt = (ut = class extends E {
  constructor() {
    super(...arguments);
    d(this, qt);
    this.href = "", this.label = "", this.active = !1, a(this, qt, (t) => {
...
const qe = class qe extends E {
  ...
  render() {
    return b`
      <h1>${this.heading}</h1>
      ${this.description ? b`<p>${this.description}</p>` : x}
    `;
  }
};
qe.styles = js;
...
var j, pt, ft, gt, bt, X, m, $e, se, os, Ce, rs, ne, Ze;
let nt = (Ze = class extends E {
  constructor() {
    super(...arguments);
    d(this, m);
    d(this, j);
    ...
    d(this, bt);
    d(this, X);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, this.pageWindow = fe, a(this, j, 1), a(this, pt, !1), a(this, ft, !1), a(this, gt, !1), a(this, bt, !1), a(this, X, null);
  }
  /*
  ...
  willUpdate() {
    if (!this.hasUpdated) {
      ...
      this.defaultPage !== 1 && a(this, j, this.defaultPage);
    }
  }
  /*
  ...
  */
  updated() {
    var o;
    const t = l(this, X);
    if (t === null || (a(this, X, null), (this.page ?? l(this, j)) !== t.page)) return;
...
}, j = new WeakMap(), pt = new WeakMap(), ft = new WeakMap(), gt = new WeakMap(), bt = new WeakMap(), X = new WeakMap(), m = new WeakSet(), $e = function() {
  return this.page !== void 0;
}, se = function() {
  return this.perPage > 0 ? !Number.isFinite(this.total) || this.total < 0 ? (l(this, gt) || (a(this, gt, !0), console.warn(
    `[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0) : Math.ceil(this.total / this.perPage) : (l(this, ft) || (a(this, ft, !0), console.warn(
    `[ns-pagination] per-page=${this.perPage} 는 1 이상이어야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0);
}, os = function() {
  const t = this.pageWindow;
  return Number.isInteger(t) && t >= 5 && t % 2 === 1 ? t : (l(this, bt) || (a(this, bt, !0), console.warn(
...
Ce = function() {
  ...
  return l(this, pt) || (a(this, pt, !0), console.warn(
...
rs = function(t) {
  ...
  l(this, m, $e) || (a(this, j, t), this.requestUpdate());
  const s = { page: t };
...
*/
ne = function(t, s) {
  c(this, m, rs).call(this, s) && a(this, X, { control: t, page: s });
}, Ze);
Xt([
  u({ type: Number })
], nt.prototype, "total");
...
`;
var Rs = Object.defineProperty, as = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (e = r(i, t, e) || e);
  return e && Rs(i, t, e), e;
}, vt, ae, ls;
const Fe = class Fe extends E {
  constructor() {
    ...
    d(this, ae);
    d(this, vt);
    this.defaultOpen = !1, a(this, vt, !1);
  }
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { open: "default-open" });
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultOpen") && a(this, vt, this.defaultOpen === !0);
  }
  /*
    ...
    */
  updated() {
    this.toggleAttribute("data-ns-open", l(this, ae, ls));
  }
  render() {
    return b`<nav><slot></slot></nav>`;
  }
};
vt = new WeakMap(), ae = new WeakSet(), ls = function() {
...
var Z, J, Y, yt, wt, h, ds, Ne, _e, hs, ot, Se, kt, ie, R, At, Pe, us, ps, Mt, fs, Je;
let it = (Je = class extends Qe {
  constructor() {
    ...
    d(this, wt);
    d(this, kt);
    this.defaultSortKey = "", this.defaultSortDirection = "none", a(this, Z, ""), a(this, J, "none"), a(this, yt, !1), a(this, kt, (t) => {
      ...
      const r = o.dataset.nsSortKey ?? "", p = r === l(this, h, Ne) ? Xs(l(this, h, _e)) : "ascending", v = p === "none" ? "" : r;
      l(this, h, ds) || (a(this, Z, v), a(this, J, p), this.requestUpdate());
      const P = { key: v, direction: p };
      this.dispatchEvent(
  ...
  connectedCallback() {
    ...
    }), this.addEventListener("click", l(this, kt)), a(this, wt, new MutationObserver(() => {
      c(this, h, Se).call(this), c(this, h, At).call(this), c(this, h, ps).call(this);
    })), l(this, wt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, kt)), (t = l(this, wt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && a(this, Z, this.defaultSortKey), this.defaultSortDirection !== "none" && a(this, J, this.defaultSortDirection), this.selected === void 0 && a(this, Y, c(this, h, Pe).call(this));
  }
  updated() {
    c(this, h, hs).call(this), c(this, h, Se).call(this), c(this, h, At).call(this);
  }
}, Z = new WeakMap(), J = new WeakMap(), Y = new WeakMap(), yt = new WeakMap(), wt = new WeakMap(), h = new WeakSet(), ds = function() {
  ...
  */
hs = function() {
  l(this, yt) || this.sortDirection === void 0 || this.sortKey !== void 0 || (a(this, yt, !0), console.warn(
...
At = function() {
  ...
  const s = c(this, h, ie).call(this), e = this.selected, o = e === void 0 ? s.filter((v) => v.checked).length : s.filter((v) => e.includes(c(this, h, R).call(this, v))).length, r = s.length > 0 && o === s.length, p = o > 0 && o < s.length;
  for (const v of t)
    v.checked = r, v.indeterminate = p;
...
ps = function() {
  ...
  const t = c(this, h, Pe).call(this), s = l(this, Y);
...
fs = function(t) {
  ...
  const o = new Set(this.selected), r = c(this, h, R).call(this, t);
  t.checked ? o.add(r) : o.delete(r), e = s.map((p) => c(this, h, R).call(this, p)).filter((p) => o.has(p)), c(this, h, Mt).call(this, e);
}, Je);
Jt([
  u({ attribute: !1 })
...
$("ns-table", it);
var Zs = Object.defineProperty, gs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (e = r(i, t, e) || e);
  return e && Zs(i, t, e), e;
};
...
var Q, xt, $t, f, Ee, Ot, W, Ae, oe, Me, Oe, De, Ct, Nt, Ye;
let he = (Ye = class extends Qe {
  constructor() {
    ...
    d(this, Ct);
    d(this, Nt);
    this.defaultActive = "", a(this, Q, ""), a(this, $t, !1), a(this, Ct, (t) => {
      ...
      t.key === "ArrowRight" ? r(o + 1) : t.key === "ArrowLeft" ? r(o - 1) : t.key === "Home" ? r(0) : t.key === "End" && r(e.length - 1);
    });
  }
  /*
      Light DOM 이다. 실패 경로가 둘이고 이 재정의가 둘 다 막는다 —
  ...
  connectedCallback() {
    super.connectedCallback(), C(), st(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", l(this, Ct)), this.addEventListener("keydown", l(this, Nt)), a(this, xt, new MutationObserver(() => c(this, f, oe).call(this))), l(this, xt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
  ...
  /*
    ...
    */
  firstUpdated() {
    this.defaultActive !== "" && a(this, Q, this.defaultActive);
  }
  updated() {
    c(this, f, oe).call(this);
  }
}, Q = new WeakMap(), xt = new WeakMap(), $t = new WeakMap(), f = new WeakSet(), Ee = function() {
  ...
  return s !== "" && !l(this, $t) && (a(this, $t, !0), console.warn(
    l(this, f, Ee) ? `[ns-tabs] active="${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시하지만 그 탭을 눌러도 ns-tab-change 가 나가지 않습니다. 대소문자까지 맞는지 확인하세요.` : `[ns-tabs] 활성 탭 "${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시합니다. default-active 값이 data-ns-tab 과 맞는지 확인하세요.`
  )), e;
...
oe = function() {
  ...
  l(this, f, Ee) || (a(this, Q, t), this.requestUpdate());
  const e = { id: t };
  this.dispatchEvent(
...
function _n({ title: n, description: i, className: t }) {
  return /* @__PURE__ */ g(Qs, { heading: n, description: i ?? "", className: t });
}
function Sn({
  open: n,
  title: i,
  ...
  return /* @__PURE__ */ M(
    tn,
    {
      ...
      children: [
        s,
        e != null && /* @__PURE__ */ g("div", { slot: "footer", style: { display: "contents" }, children: e })
      ]
    }
  );
}
function Pn({
  ...
  return /* @__PURE__ */ g(
    Ys,
    {
      ...
      className: e,
      style: o,
      onNsNavigate: (r) => t == null ? void 0 : t(r.detail),
      children: s
    }
  );
}
...
function bs({ variant: n = "solid", size: i = "md", fullWidth: t = !1 }, s) {
  return N(
    "ns-button",
    `ns-button--${n}`,
...
function En({
  ...
  return /* @__PURE__ */ g(
    ...
    {
      type: e,
      className: bs({ variant: n, size: i, fullWidth: t }, s),
      ...o
    }
  );
}
function An({
  ...
  return /* @__PURE__ */ g("a", { className: bs({ variant: n, size: i, fullWidth: t }, s), ...e });
}
function Mn({
  className: n,
  children: i,
  ...
  if (t === void 0)
    return /* @__PURE__ */ g("div", { className: N("ns-card", n), children: i });
  const r = o === 3 ? "h3" : "h2";
  return /* @__PURE__ */ M("div", { className: N("ns-card", n), children: [
    /* @__PURE__ */ M("div", { className: "ns-card__header", children: [
      /* @__PURE__ */ M("div", { children: [
        /* @__PURE__ */ g(r, { className: "ns-card__title", children: t }),
        s !== void 0 && /* @__PURE__ */ g("p", { className: "ns-card__description", children: s })
      ] }),
      e !== void 0 && /* @__PURE__ */ g("div", { className: "ns-card__actions", children: e })
    ] }),
    /* @__PURE__ */ g("div", { className: "ns-card__body", children: i })
  ] });
}
function On({
  title: n,
  ...
  return /* @__PURE__ */ M(
    "details",
    {
      ...
      open: t,
      children: [
        /* @__PURE__ */ g("summary", { children: o === "plain" ? n : /* @__PURE__ */ M(Cs, { children: [
          /* @__PURE__ */ g("span", { className: "ns-accordion__title", children: n }),
          /* @__PURE__ */ g("span", { className: "ns-accordion__meta", children: i })
        ] }) }),
...
function zn({
  ...
  return /* @__PURE__ */ M(
    "select",
    {
      ...
      ...r,
      children: [
        i !== void 0 && /* @__PURE__ */ g("option", { value: "", disabled: !0, children: i }),
        n.map((v) => /* @__PURE__ */ g("option", { value: v.value, children: v.label }, v.value))
      ]
    }
  );
}
function In({ label: n, hint: i, className: t, ...s }) {
  return /* @__PURE__ */ M("label", { className: N("ns-checkbox", t), children: [
    ...
    i && /* @__PURE__ */ g("span", { className: "ns-checkbox__hint", children: i })
  ] });
}
function Bn({ label: n, hint: i, error: t, children: s }) {
  const e = ws(), o = `${e}-hint`, r = `${e}-error`, p = !!t, v = !p && !!i;
  let P = s, F = e;
  if (ks(s)) {
    const k = s;
    F = k.props.id ?? e;
    const A = { id: F };
    v && (A["aria-describedby"] = o), p && (A["aria-errormessage"] = r, A["aria-invalid"] = !0), P = xs(k, A);
  }
  return /* @__PURE__ */ M("div", { className: "ns-field", children: [
    /* @__PURE__ */ g("label", { htmlFor: F, className: "ns-field__label", children: n }),
    P,
    p ? /* @__PURE__ */ g("span", { id: r, className: "ns-field__error", children: t }) : v ? /* @__PURE__ */ g("span", { id: o, className: "ns-field__hint", children: i }) : null
  ] });
}
function Tn({ children: n, className: i }) {
  return /* @__PURE__ */ g("div", { className: N("ns-message", i), children: /* @__PURE__ */ g("p", { children: n }) });
}
function jn({
  children: n,
  selected: i,
  ...
  return i !== void 0 ? /* @__PURE__ */ g(
    "button",
    {
      ...
      disabled: o,
      onClick: t,
      className: N("ns-chip", r),
      children: n
    }
  ) : s !== void 0 ? /* @__PURE__ */ M("span", { className: N("ns-chip", r), children: [
    n,
    /* @__PURE__ */ g(
      "button",
      {
  ...
  ] }) : /* @__PURE__ */ g("span", { className: N("ns-chip", r), children: n });
}
const en = B`
  :host {
    position: fixed;
...
var sn = Object.defineProperty, vs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, r; o >= 0; o--)
    (r = n[o]) && (e = r(i, t, e) || e);
  return e && sn(i, t, e), e;
}, Ft, L, I, K, w, Ue, ze, Ie, rt, Rt, Wt, Ht, Vt;
const Re = class Re extends E {
  constructor() {
    ...
    d(this, Ht);
    d(this, Vt);
    this.position = "top-center", this.items = [], a(this, Ft, 0), a(this, L, !1), a(this, I, !1), a(this, K, !1), a(this, Rt, () => {
      a(this, L, !0), c(this, w, rt).call(this);
    }), a(this, Wt, () => {
      a(this, L, !1), c(this, w, rt).call(this);
    }), a(this, Ht, () => {
      a(this, I, !0), c(this, w, rt).call(this);
    }), a(this, Vt, () => {
      a(this, I, !1), c(this, w, rt).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), c(this, w, Ie).call(this);
  }
  disconnectedCallback() {
    c(this, w, ze).call(this), a(this, L, !1), a(this, I, !1), a(this, K, !1), super.disconnectedCallback();
  }
  /** 토스트 하나를 띄운다. 돌려주는 함수를 부르면 즉시 닫는다(두 번 불러도 안전). */
  show(t, s, e) {
    const o = He(this, Ft)._++, r = {
      key: o,
      message: t,
      tone: s,
      duration: e,
    ...
    return this.items = [...this.items, r], l(this, K) || c(this, w, Ue).call(this, r), () => this.dismiss(o);
  }
  ...
  updated() {
    var t;
    a(this, I, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), c(this, w, rt).call(this);
  }
  render() {
    return b`
      <div
      ...
      (t) => b`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : x}>
              ${t.tone === "neutral" ? x : b`<span class="dot" aria-hidden="true"></span>`}
...
Ft = new WeakMap(), L = new WeakMap(), I = new WeakMap(), K = new WeakMap(), w = new WeakSet(), /*
...
ze = function() {
  ...
  for (const t of this.items) c(this, w, Ue).call(this, t);
}, /*
...
rt = function() {
  ...
  t !== l(this, K) && (a(this, K, t), t ? c(this, w, ze).call(this) : c(this, w, Ie).call(this));
...
function ys(n, i, t) {
  ...
  const p = (k) => {
    ...
    for (let A = 0; A < 5; A++)
      if (await e.updateComplete, r || (k.focus({ preventScroll: !0 }), document.activeElement === k)) return;
    console.warn(
      "[ns-confirm] 취소 버튼에 초기 포커스를 주지 못했습니다. ns-dialog 의 갱신 순서가 바뀌었을 수 있습니다."
    );
  }, P = document.createElement("button");
  P.type = "button", P.slot = "footer", P.className = n.tone === "danger" ? "ns-button ns-button--danger ns-button--sm" : "ns-button ns-button--solid ns-button--sm", P.textContent = n.confirmLabel ?? "확인", P.addEventListener("click", () => p(!0));
  let F = null;
  if (i) {
  ...
  e.append(P), e.addEventListener("ns-dialog-close", () => p(!1)), document.body.append(e), e.show(), F !== null && v(F);
}
function qn(n) {
