...
var fe = (n, i, t) => i.has(n) || Ve("Cannot " + t);
var l = (n, i, t) => (fe(n, i, "read from private field"), t ? t.call(n) : i.get(n)), d = (n, i, t) => i.has(n) ? Ve("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(n) : i.set(n, t), r = (n, i, t, s) => (fe(n, i, "write to private field"), s ? s.call(n, t) : i.set(n, t), t), c = (n, i, t) => (fe(n, i, "access private method"), t);
var Ge = (n, i, t, s) => ({
  set _(e) {
    r(n, i, e, t);
  },
...
import { useRef as $s, useEffect as Cs, useId as Ns, isValidElement as _s, cloneElement as Xe } from "react";
import { createComponent as E } from "@lit/react";
import { css as B, svg as te, LitElement as P, html as g, nothing as x, ReactiveElement as ss } from "lit";
import { svg as Zn } from "lit";
import { property as p, query as Ss, state as je } from "lit/decorators.js";
import { repeat as le } from "lit/directives/repeat.js";
import { jsx as b, jsxs as O, Fragment as Es } from "react/jsx-runtime";
function $(n, i) {
  typeof window > "u" || !("customElements" in window) || customElements.get(n) || customElements.define(n, i);
}
let be = !1;
const Ps = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  Next/React:  import "@neosimplix/common-ui/tokens.css";
  HTML:        <link rel="stylesheet" href="…/dist/tokens.css">`, Ze = () => getComputedStyle(document.documentElement).getPropertyValue("--ns-color-line").trim() !== "";
function C() {
  if (be || typeof document > "u" || typeof getComputedStyle > "u") return;
  if (Ze()) {
    be = !0;
    return;
  }
...
function nt(n, i) {
  for (const [t, s] of Object.entries(i)) {
    ...
    let o = Je.get(n);
    o === void 0 && Je.set(n, o = /* @__PURE__ */ new Set()), !o.has(e) && (o.add(e), console.warn(
      `[${n.localName}] ${e} 속성은 무시됩니다 — 이 이름은 프로퍼티 전용입니다.
  HTML 에서 쓸 것: ${s}
  JS 에서는 el.${As(t)} 에 대입합니다.`
    ));
  }
}
const As = (n) => n.replace(/-([a-z])/g, (i, t) => t.toUpperCase()), Ms = B`
...
`;
var Ds = Object.defineProperty, Is = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ds(i, t, e), e;
}, ct, et, ns, ve, dt;
let Le = (dt = class extends P {
  constructor() {
    super(...arguments);
    d(this, et);
    d(this, ct);
  ...
  render() {
    return g`<slot>${c(this, et, ns).call(this)}</slot>`;
  }
  /*
  ...
  updated() {
    ...
    if (!t.some((e) => e.nodeType === Node.ELEMENT_NODE)) {
      if (t.length > 0) {
        c(this, et, ve).call(this, `공백-${this.name}`, `[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);
        return;
      }
      this.name !== "" && !se[this.name] && c(this, et, ve).call(this, `없음-${this.name}`, `[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys(se).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`);
    }
  }
}, ct = new WeakMap(), et = new WeakSet(), ns = function() {
  if (this.name === "") return x;
  const t = se[this.name];
  return t ? g`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>` : x;
}, /** 같은 사유로 리렌더될 때마다 찍지 않는다. */
ve = function(t, s) {
  l(this, ct) !== t && (r(this, ct, t), console.warn(s));
}, dt.styles = Os, dt);
Is([
  p({ type: String })
], Le.prototype, "name");
$("ns-icon", Le);
var zs = Object.defineProperty, At = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && zs(i, t, e), e;
}, U, V, K, w, me, we, ye, Ut, Tt, Bt, jt, Lt, ke, ne;
const Fe = class Fe extends P {
  constructor() {
    ...
    d(this, jt);
    d(this, Lt);
    this.heading = "", this.defaultOpen = !1, this.noBackdropClose = !1, this.hasFooter = !1, r(this, U, !1), r(this, V, !1), r(this, K, !1), r(this, Ut, (t) => {
      const s = t.target;
      ...
      c(this, w, ne).call(this, "escape");
    }), r(this, Bt, () => {
      c(this, w, ne).call(this, "close-button");
    }), r(this, jt, (t) => {
      r(this, V, c(this, w, ke).call(this, t));
    }), r(this, Lt, (t) => {
      const s = l(this, V);
      r(this, V, !1), !this.noBackdropClose && t.detail !== 0 && (!s || !c(this, w, ke).call(this, t) || c(this, w, ne).call(this, "backdrop"));
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, { open: "default-open" });
    const t = this.dialogEl;
    t != null && t.open && (r(this, K, !0), t.close()), this.requestUpdate();
  }
  /*
   ...
   */
  show() {
    c(this, w, ye).call(this, "show") || (r(this, U, !0), this.requestUpdate());
  }
  /** 비제어일 때만 닫는다. 소비자가 부른 것이므로 `ns-dialog-close` 를 내지 않는다. */
  close() {
    c(this, w, ye).call(this, "close") || (r(this, U, !1), this.requestUpdate());
  }
  /*
  ...
  updated() {
    const t = this.dialogEl;
    t && (l(this, w, we) && !t.open ? this.isConnected && t.showModal() : !l(this, w, we) && t.open && (r(this, K, !0), t.close()));
  }
  /*
    ...
    return g`
      ...
      >
        <div class="header">
          ...
          <button class="close" type="button" aria-label="닫기" @click=${l(this, Bt)}>
            <ns-icon name="close"></ns-icon>
          </button>
        </div>
        <div class="body"><slot></slot></div>
        <div class="footer" ?hidden=${!this.hasFooter}>
          <slot name="footer" @slotchange=${l(this, Ut)}></slot>
        </div>
      </dialog>
    `;
  }
};
U = new WeakMap(), V = new WeakMap(), K = new WeakMap(), w = new WeakSet(), me = function() {
  return this.open !== void 0;
}, we = function() {
  return this.open ?? l(this, U);
}, ye = function(t) {
  return l(this, w, me) ? (console.warn(
    `[ns-dialog] open 프로퍼티가 설정된 제어 모드에서는 ${t}() 가 동작하지 않습니다. open 을 바꾸세요.`
  ), !0) : !1;
}, Ut = new WeakMap(), Tt = new WeakMap(), Bt = new WeakMap(), jt = new WeakMap(), Lt = new WeakMap(), /*
...
], D.prototype, "defaultOpen");
At([
  p({ type: Boolean, attribute: "no-backdrop-close" })
], D.prototype, "noBackdropClose");
At([
  Ss("dialog")
], D.prototype, "dialogEl");
At([
  je()
], D.prototype, "hasFooter");
$("ns-dialog", D);
const Us = B`
  :host {
    display: block;
...
`;
var Ts = Object.defineProperty, is = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ts(i, t, e), e;
}, Kt, ht;
let he = (ht = class extends P {
  constructor() {
    super(...arguments);
    d(this, Kt);
    this.projectName = "", this.sidebarOpen = !1, r(this, Kt, () => {
...
}, Kt = new WeakMap(), ht.styles = Us, ht);
is([
  p({ type: String, attribute: "project-name" })
], he.prototype, "projectName");
is([
  p({ type: Boolean, reflect: !0, attribute: "sidebar-open" })
], he.prototype, "sidebarOpen");
$("ns-header", he);
var Bs = Object.defineProperty, j = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Bs(i, t, e), e;
}, qt, I, os, xe, $e, Ye;
let A = (Ye = class extends P {
  constructor() {
    super(...arguments);
    d(this, I);
    /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, {
  ...
  render() {
    const t = l(this, I, xe), s = t.flatMap((a) => this.options.filter((u) => u.value === a)), e = this.query.trim().toLowerCase(), o = e === "" ? this.options : this.options.filter(
      (a) => [a.label, a.meta ?? ""].some((u) => u.toLowerCase().includes(e))
    );
    return g`
      ${s.length === 0 ? x : g`
      ...
      (a) => g`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${() => c(this, I, $e).call(this, a.value)}
                    >
                      ×
                    </button>
                  </span>
      ...
      <div class="ns-multi-select__list">
        ${o.length === 0 ? g`<p class="ns-multi-select__empty">${this.emptyMessage}</p>` : le(
      o,
      (a) => a.value,
      (a) => g`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(u) => c(this, I, $e).call(this, a.value, u.target)}
                  />
                  <span>${a.label}</span>
...
}, qt = new WeakMap(), I = new WeakSet(), os = function() {
  return this.value !== void 0;
}, xe = function() {
  return this.value ?? l(this, qt) ?? this.defaultValue;
}, /**
 * @param item   토글할 값
 * @param source 이 토글을 일으킨 네이티브 체크박스. 칩의 제거 버튼에는 없다.
 */
$e = function(t, s) {
  const e = l(this, I, xe), o = e.includes(t) ? e.filter((u) => u !== t) : [...e, t];
  l(this, I, os) ? s !== void 0 && (s.checked = e.includes(t)) : (r(this, qt, o), this.requestUpdate());
  const a = { values: o };
  this.dispatchEvent(
...
`;
var Ls = Object.defineProperty, ue = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ls(i, t, e), e;
}, G, ut, X, st, as, Ce, Ft, pt;
let Mt = (pt = class extends P {
  constructor() {
    super(...arguments);
    d(this, st);
    d(this, G);
    ...
    d(this, X);
    d(this, Ft);
    this.heading = "", this.collapsible = !1, this.defaultCollapsed = !1, r(this, G, !1), r(this, ut, !1), r(this, X, !1), r(this, Ft, () => {
      const t = !l(this, st, Ce);
      r(this, ut, !0), l(this, st, as) || (r(this, G, !t), this.requestUpdate());
      const s = { open: t };
      this.dispatchEvent(
  ...
  connectedCallback() {
    var s;
    super.connectedCallback(), C(), nt(this, { open: "default-collapsed" });
    const t = ((s = this.parentElement) == null ? void 0 : s.closest("ns-nav-group")) != null;
    t !== l(this, X) && (r(this, X, t), this.requestUpdate());
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultCollapsed") && !l(this, ut) && r(this, G, this.defaultCollapsed);
  }
  render() {
    const t = l(this, st, Ce);
    return g`
...
}, G = new WeakMap(), ut = new WeakMap(), X = new WeakMap(), st = new WeakSet(), as = function() {
  return this.open !== void 0;
}, Ce = function() {
  return this.open ?? !l(this, G);
}, Ft = new WeakMap(), pt.styles = js, pt);
ue([
  p({ type: String })
], Mt.prototype, "heading");
ue([
  p({ type: Boolean })
], Mt.prototype, "collapsible");
ue([
  p({ attribute: !1 })
], Mt.prototype, "open");
ue([
  p({ type: Boolean, attribute: "default-collapsed" })
], Mt.prototype, "defaultCollapsed");
$("ns-nav-group", Mt);
const Ks = B`
  :host {
    display: block;
...
`;
var qs = Object.defineProperty, Ke = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && qs(i, t, e), e;
}, Rt, ft;
let Zt = (ft = class extends P {
  constructor() {
    super(...arguments);
    d(this, Rt);
    this.href = "", this.label = "", this.active = !1, r(this, Rt, (t) => {
  ...
  render() {
    return g`
      <a class="row" href=${this.href} title=${this.label} @click=${l(this, Rt)}>
...
}, Rt = new WeakMap(), ft.styles = Ks, ft);
Ke([
  p({ type: String })
], Zt.prototype, "href");
Ke([
...
`;
var Rs = Object.defineProperty, rs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Rs(i, t, e), e;
};
...
rs([
  p({ type: String })
], Et.prototype, "heading");
rs([
  p({ type: String })
], Et.prototype, "description");
$("ns-page-heading", Et);
var Ws = Object.defineProperty, Jt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ws(i, t, e), e;
};
const ge = 7;
function ee(n, i) {
  return Array.from({ length: Math.max(i - n + 1, 0) }, (t, s) => n + s);
}
function Hs(n, i, t) {
  if (i <= t) return ee(1, i);
  const s = t - 2, e = (t - 5) / 2;
  return n <= s ? [...ee(1, s), "gap", i] : n > i - s ? [1, "gap", ...ee(i - s + 1, i)] : [1, "gap", ...ee(n - e, n + e), "gap", i];
}
var q, bt, gt, vt, mt, Z, m, Ne, ie, ls, _e, cs, oe, Qe;
let it = (Qe = class extends P {
  constructor() {
    super(...arguments);
    d(this, m);
    d(this, q);
    ...
    d(this, mt);
    d(this, Z);
    this.total = 0, this.perPage = 20, this.defaultPage = 1, this.pageWindow = ge, r(this, q, 1), r(this, bt, !1), r(this, gt, !1), r(this, vt, !1), r(this, mt, !1), r(this, Z, null);
  }
  /*
  ...
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, { page: "default-page" });
  }
  /*
  ...
  */
  updated() {
    var o;
    const t = l(this, Z);
    if (t === null || (r(this, Z, null), (this.page ?? l(this, q)) !== t.page)) return;
    ...
    (o = this.querySelector(e)) == null || o.focus();
  }
  render() {
    const t = l(this, m, ie);
    if (t <= 1) return x;
    const s = c(this, m, _e).call(this);
    return g`
      <nav aria-label="페이지 이동">
        <button
          ...
          @click=${() => c(this, m, oe).call(this, "prev", s - 1)}
        >
          이전
        </button>
      ...
      /*
                  ...
                  */
      (e, o) => e === "gap" ? `gap-${o}` : e,
      (e) => e === "gap" ? g`<span class="ns-pagination-gap" aria-hidden="true">…</span>` : (
        /*
        ...
        */
        g`<button
                    ...
                    type="button"
                    data-ns-page=${e}
                    aria-current=${e === s ? "page" : x}
                    @click=${() => c(this, m, oe).call(this, e, e)}
                  >
                    ${e}
                  </button>`
      )
        ...
        <button
          ...
          type="button"
          data-ns-nav="next"
          aria-disabled=${s === t ? "true" : x}
          @click=${() => c(this, m, oe).call(this, "next", s + 1)}
        >
          다음
        </button>
      </nav>
...
}, q = new WeakMap(), bt = new WeakMap(), gt = new WeakMap(), vt = new WeakMap(), mt = new WeakMap(), Z = new WeakMap(), m = new WeakSet(), Ne = function() {
  return this.page !== void 0;
}, ie = function() {
  return this.perPage > 0 ? !Number.isFinite(this.total) || this.total < 0 ? (l(this, vt) || (r(this, vt, !0), console.warn(
    `[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0) : Math.ceil(this.total / this.perPage) : (l(this, gt) || (r(this, gt, !0), console.warn(
    `[ns-pagination] per-page=${this.perPage} 는 1 이상이어야 합니다. 페이징을 렌더하지 않습니다.`
  )), 0);
}, ls = function() {
  const t = this.pageWindow;
  return Number.isInteger(t) && t >= 5 && t % 2 === 1 ? t : (l(this, mt) || (r(this, mt, !0), console.warn(
    `[ns-pagination] page-window=${t} 는 5 이상의 홀수여야 합니다. ${ge} 로 그립니다.`
  )), ge);
}, /**
 ...
 */
_e = function() {
  const t = this.page ?? l(this, q), s = l(this, m, ie);
  if (Number.isInteger(t) && t >= 1 && t <= s) return t;
  const e = Number.isFinite(t) ? Math.min(Math.max(Math.round(t), 1), Math.max(s, 1)) : 1;
  return l(this, bt) || (r(this, bt, !0), console.warn(
    l(this, m, Ne) ? `[ns-pagination] page=${t} 가 1..${s} 범위를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.` : `[ns-pagination] 현재 페이지 ${t} 가 total=${this.total} · per-page=${this.perPage} 로 계산된 페이지 수(${s})를 벗어났습니다. 표시용으로 ${e} 로 보정합니다.`
  )), e;
}, /** 이동했으면(= 이벤트를 냈으면) true. */
cs = function(t) {
  if (!Number.isInteger(t) || t < 1 || t > l(this, m, ie) || t === c(this, m, _e).call(this)) return !1;
  l(this, m, Ne) || (r(this, q, t), this.requestUpdate());
  const s = { page: t };
...
*/
oe = function(t, s) {
  c(this, m, cs).call(this, s) && r(this, Z, { control: t, page: s });
}, Qe);
Jt([
  p({ type: Number })
], it.prototype, "total");
...
`;
var Gs = Object.defineProperty, ds = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Gs(i, t, e), e;
}, wt, ce, hs;
const We = class We extends P {
  constructor() {
    ...
    d(this, ce);
    d(this, wt);
    this.defaultOpen = !1, r(this, wt, !1);
  }
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, { open: "default-open" });
  }
  /*
    ...
    */
  willUpdate(t) {
    t.has("defaultOpen") && r(this, wt, this.defaultOpen === !0);
  }
  /*
    ...
    */
  updated() {
    this.toggleAttribute("data-ns-open", l(this, ce, hs));
  }
  render() {
    return g`<nav><slot></slot></nav>`;
  }
};
wt = new WeakMap(), ce = new WeakSet(), hs = function() {
  return this.open ?? l(this, wt);
}, We.styles = Vs;
let Pt = We;
ds([
  p({ attribute: !1 })
...
`;
var Zs = Object.defineProperty, qe = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Zs(i, t, e), e;
};
const Js = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var de, us, yt;
let Yt = (yt = class extends P {
  constructor() {
    super(...arguments);
    d(this, de);
  ...
  render() {
    return g`
      <div
        class="bar"
        aria-hidden="true"
        style="width:${this.width};height:${this.height};border-radius:${c(this, de, us).call(this)}"
      ></div>
    `;
  }
}, de = new WeakSet(), us = function() {
  return Js.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, yt.styles = Xs, yt);
qe([
  p({ type: String })
], Yt.prototype, "width");
...
$("ns-skeleton", Yt);
var Ys = Object.defineProperty, Qt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ys(i, t, e), e;
};
...
var J, Y, Q, kt, xt, h, ps, Se, Ee, fs, rt, Pe, $t, ae, W, Ot, Ae, bs, gs, Dt, vs, ts;
let ot = (ts = class extends ss {
  constructor() {
    super(...arguments);
    d(this, h);
    d(this, J);
    ...
    d(this, xt);
    d(this, $t);
    this.defaultSortKey = "", this.defaultSortDirection = "none", r(this, J, ""), r(this, Y, "none"), r(this, kt, !1), r(this, $t, (t) => {
      const s = t.target, e = s == null ? void 0 : s.closest(
        'input[type="checkbox"][data-ns-select-all], input[type="checkbox"][data-ns-row-id]'
      );
      if (e && c(this, h, rt).call(this, e)) {
        c(this, h, vs).call(this, e);
        return;
      }
      const o = s == null ? void 0 : s.closest("th[data-ns-sort-key]");
      if (!o || !c(this, h, rt).call(this, o)) return;
      const a = o.dataset.nsSortKey ?? "", u = a === l(this, h, Se) ? Qs(l(this, h, Ee)) : "ascending", v = u === "none" ? "" : a;
      l(this, h, ps) || (r(this, J, v), r(this, Y, u), this.requestUpdate());
  ...
  connectedCallback() {
    ...
    }), this.addEventListener("click", l(this, $t)), r(this, xt, new MutationObserver(() => {
      c(this, h, Pe).call(this), c(this, h, Ot).call(this), c(this, h, gs).call(this);
    })), l(this, xt).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, $t)), (t = l(this, xt)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
  ...
  */
  firstUpdated() {
    this.defaultSortKey !== "" && r(this, J, this.defaultSortKey), this.defaultSortDirection !== "none" && r(this, Y, this.defaultSortDirection), this.selected === void 0 && r(this, Q, c(this, h, Ae).call(this));
  }
  updated() {
    c(this, h, fs).call(this), c(this, h, Pe).call(this), c(this, h, Ot).call(this);
  }
}, J = new WeakMap(), Y = new WeakMap(), Q = new WeakMap(), kt = new WeakMap(), xt = new WeakMap(), h = new WeakSet(), ps = function() {
  ...
  */
fs = function() {
  l(this, kt) || this.sortDirection === void 0 || this.sortKey !== void 0 || (r(this, kt, !0), console.warn(
...
rt = function(t) {
  ...
  */
Pe = function() {
  const t = l(this, h, Se), s = l(this, h, Ee);
  for (const e of this.querySelectorAll("th[data-ns-sort-key]"))
    c(this, h, rt).call(this, e) && (e.dataset.nsSortKey === t && s !== "none" ? e.setAttribute("aria-sort", s) : e.removeAttribute("aria-sort"));
}, $t = new WeakMap(), /*
...
Ot = function() {
  ...
  ].filter((v) => c(this, h, rt).call(this, v));
  if (t.length === 0) return;
  const s = c(this, h, ae).call(this), e = this.selected, o = e === void 0 ? s.filter((v) => v.checked).length : s.filter((v) => e.includes(c(this, h, W).call(this, v))).length, a = s.length > 0 && o === s.length, u = o > 0 && o < s.length;
  for (const v of t)
    v.checked = a, v.indeterminate = u;
}, /** 비제어 모드의 진실 — DOM 이다. 행 순서를 그대로 따른다. */
Ae = function() {
  return c(this, h, ae).call(this).filter((t) => t.checked).map((t) => c(this, h, W).call(this, t));
}, /*
...
gs = function() {
  ...
  const t = c(this, h, Ae).call(this), s = l(this, Q);
  if (!(s !== void 0 && c(this, h, bs).call(this, s, t))) {
    if (s === void 0 || this.ownerDocument.readyState === "loading") {
      r(this, Q, t);
      return;
    }
    c(this, h, Dt).call(this, t);
  }
}, Dt = function(t) {
  r(this, Q, t);
  const s = { ids: t };
 ...
 */
vs = function(t) {
  const s = c(this, h, ae).call(this);
  if (t.hasAttribute("data-ns-select-all")) {
    if (this.selected === void 0)
      for (const u of s) u.checked = t.checked;
    c(this, h, Dt).call(this, t.checked ? s.map((u) => c(this, h, W).call(this, u)) : []), this.selected === void 0 && c(this, h, Ot).call(this);
    return;
  }
  if (!t.hasAttribute("data-ns-row-id")) return;
  let e;
  if (this.selected === void 0) {
    e = s.filter((u) => u.checked).map((u) => c(this, h, W).call(this, u)), c(this, h, Dt).call(this, e), c(this, h, Ot).call(this);
    return;
  }
  const o = new Set(this.selected), a = c(this, h, W).call(this, t);
  t.checked ? o.add(a) : o.delete(a), e = s.map((u) => c(this, h, W).call(this, u)).filter((u) => o.has(u)), c(this, h, Dt).call(this, e);
}, ts);
Qt([
  p({ attribute: !1 })
], ot.prototype, "sortKey");
Qt([
  p({ attribute: !1 })
], ot.prototype, "sortDirection");
Qt([
  p({ type: String, attribute: "default-sort-key" })
], ot.prototype, "defaultSortKey");
Qt([
  p({ type: String, attribute: "default-sort-direction" })
], ot.prototype, "defaultSortDirection");
Qt([
  p({ attribute: !1 })
], ot.prototype, "selected");
$("ns-table", ot);
var tn = Object.defineProperty, ms = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && tn(i, t, e), e;
};
...
var tt, Ct, Nt, f, Me, It, H, Oe, re, De, Ie, ze, _t, St, es;
let pe = (es = class extends ss {
  constructor() {
    super(...arguments);
    d(this, f);
    d(this, tt);
    ...
    d(this, _t);
    d(this, St);
    this.defaultActive = "", r(this, tt, ""), r(this, Nt, !1), r(this, _t, (t) => {
      const s = c(this, f, ze).call(this, t.target);
      s !== null && c(this, f, De).call(this, c(this, f, H).call(this, s), !1);
    }), r(this, St, (t) => {
      const s = c(this, f, ze).call(this, t.target);
      if (s === null) return;
      const e = l(this, f, It), o = e.indexOf(s);
      if (o === -1) return;
      const a = (u) => {
        t.preventDefault(), c(this, f, De).call(this, c(this, f, H).call(this, e[(u + e.length) % e.length]), !0);
      };
      t.key === "ArrowRight" ? a(o + 1) : t.key === "ArrowLeft" ? a(o - 1) : t.key === "Home" ? a(0) : t.key === "End" && a(e.length - 1);
    });
  }
  /*
      Light DOM 이다. 실패 경로가 둘이고 이 재정의가 둘 다 막는다 —
  ...
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, { active: "default-active" }), this.hasAttribute("role") || this.setAttribute("role", "tablist"), this.addEventListener("click", l(this, _t)), this.addEventListener("keydown", l(this, St)), r(this, Ct, new MutationObserver(() => c(this, f, re).call(this))), l(this, Ct).observe(this, { childList: !0, subtree: !0 });
  }
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", l(this, _t)), this.removeEventListener("keydown", l(this, St)), (t = l(this, Ct)) == null || t.disconnect(), super.disconnectedCallback();
  }
  /*
    ...
    */
  firstUpdated() {
    this.defaultActive !== "" && r(this, tt, this.defaultActive);
  }
  updated() {
    c(this, f, re).call(this);
  }
}, tt = new WeakMap(), Ct = new WeakMap(), Nt = new WeakMap(), f = new WeakSet(), Me = function() {
  ...
  const t = l(this, f, It);
  if (t.length === 0) return "";
  const s = this.active ?? l(this, tt);
  if (t.some((o) => c(this, f, H).call(this, o) === s)) return s;
  const e = c(this, f, H).call(this, t[0]);
  return s !== "" && !l(this, Nt) && (r(this, Nt, !0), console.warn(
    l(this, f, Me) ? `[ns-tabs] active="${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시하지만 그 탭을 눌러도 ns-tab-change 가 나가지 않습니다. 대소문자까지 맞는지 확인하세요.` : `[ns-tabs] 활성 탭 "${s}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${e}" 을 표시합니다. default-active 값이 data-ns-tab 과 맞는지 확인하세요.`
  )), e;
}, /** 소비자 DOM 에 ARIA 와 roving tabindex 를 쓴다. 멱등이다. */
re = function() {
  const t = l(this, f, Oe);
  for (const s of l(this, f, It)) {
    const e = c(this, f, H).call(this, s), o = s.dataset.nsPanel ?? "";
    s.setAttribute("role", "tab"), !s.hasAttribute("id") && o !== "" && s.setAttribute("id", en(o)), o !== "" && s.setAttribute("aria-controls", o), s.setAttribute("aria-selected", e === t ? "true" : "false"), s.setAttribute("tabindex", e === t ? "0" : "-1");
  }
}, De = function(t, s) {
  if (t === "") return;
  if (t === l(this, f, Oe)) {
    s && c(this, f, Ie).call(this, t);
    return;
  }
  l(this, f, Me) || (r(this, tt, t), this.requestUpdate());
  const e = { id: t };
  this.dispatchEvent(
    new CustomEvent("ns-tab-change", { detail: e, bubbles: !0, composed: !0 })
  ), c(this, f, re).call(this), s && c(this, f, Ie).call(this, t);
}, Ie = function(t) {
  var s;
  (s = l(this, f, It).find((e) => c(this, f, H).call(this, e) === t)) == null || s.focus();
...
}, _t = new WeakMap(), St = new WeakMap(), es);
ms([
  p({ attribute: !1 })
], pe.prototype, "active");
ms([
  p({ type: String, attribute: "default-active" })
], pe.prototype, "defaultActive");
$("ns-tabs", pe);
const kn = E({
  react: S,
  tagName: "ns-header",
...
function An({ title: n, description: i, className: t }) {
  return /* @__PURE__ */ b(nn, { heading: n, description: i ?? "", className: t });
}
function Mn({
  open: n,
  title: i,
  ...
  return /* @__PURE__ */ O(
    on,
    {
      ...
      noBackdropClose: o,
      className: a,
      onNsDialogClose: (u) => t(u.detail.reason),
      children: [
        s,
        e != null && /* @__PURE__ */ b("div", { slot: "footer", style: { display: "contents" }, children: e })
      ]
    }
  );
}
function On({
  ...
  제어하려면 open 을, 비제어로 열어 두려면 defaultOpen 을 줍니다.`
    ...
    sn,
    {
      ...
      className: e,
      style: o,
      onNsNavigate: (u) => t == null ? void 0 : t(u.detail),
      children: s
    }
  );
}
...
function ws({ variant: n = "solid", size: i = "md", fullWidth: t = !1 }, s) {
  return _(
    "ns-button",
    `ns-button--${n}`,
...
function Dn({
  ...
  return /* @__PURE__ */ b(
    ...
    {
      type: e,
      className: ws({ variant: n, size: i, fullWidth: t }, s),
      ...o
    }
  );
}
function In({
  ...
  return /* @__PURE__ */ b("a", { className: ws({ variant: n, size: i, fullWidth: t }, s), ...e });
}
function zn({
  className: n,
  children: i,
  ...
  const a = o === 3 ? "h3" : "h2";
  return /* @__PURE__ */ O("div", { className: _("ns-card", n), children: [
    /* @__PURE__ */ O("div", { className: "ns-card__header", children: [
      /* @__PURE__ */ O("div", { children: [
        /* @__PURE__ */ b(a, { className: "ns-card__title", children: t }),
        s !== void 0 && /* @__PURE__ */ b("p", { className: "ns-card__description", children: s })
      ] }),
      e !== void 0 && /* @__PURE__ */ b("div", { className: "ns-card__actions", children: e })
    ] }),
...
function Un({
  ...
  return /* @__PURE__ */ O(
    "details",
    {
      className: _("ns-accordion", `ns-accordion--${o}`, e),
      open: t,
      children: [
        /* @__PURE__ */ b("summary", { children: o === "plain" ? n : /* @__PURE__ */ O(Es, { children: [
...
function Tn({ invalid: n = !1, className: i, ...t }) {
  return /* @__PURE__ */ b(
    "input",
    {
      className: _("ns-input", i),
      ...t,
      "aria-invalid": n || t["aria-invalid"] || void 0
    }
  );
}
function Bn({ invalid: n = !1, className: i, rows: t = 3, ...s }) {
  return /* @__PURE__ */ b(
    "textarea",
    {
...
function jn({
  ...
  const u = e !== void 0 ? void 0 : o !== void 0 ? o : i !== void 0 ? "" : void 0;
  return /* @__PURE__ */ O(
    "select",
    {
      ...
      defaultValue: u,
      ...a,
      "aria-invalid": t || a["aria-invalid"] || void 0,
      children: [
...
function Ln({ label: n, hint: i, className: t, ...s }) {
  return /* @__PURE__ */ O("label", { className: _("ns-checkbox", t), children: [
    /* @__PURE__ */ b("input", { ...s, type: "checkbox" }),
    /* @__PURE__ */ b("span", { children: n }),
    i && /* @__PURE__ */ b("span", { className: "ns-checkbox__hint", children: i })
  ] });
}
function Kn({ label: n, hint: i, error: t, children: s }) {
  var k;
  const e = Ns(), o = `${e}-hint`, a = `${e}-error`, u = !!t, v = !u && !!i;
  let N = s, L = e;
  if (_s(s)) {
    const M = s, at = (k = M.type) == null ? void 0 : k.nsFieldControl;
    if (L = at ? e : M.props.id ?? e, at) {
      const z = { [at.id]: L };
      v && (z[at.describedby] = o), u && (z[at.describedby] = a, z[at.invalid] = !0), N = Xe(M, z);
    } else {
      const z = { id: L };
      v && (z["aria-describedby"] = o), u && (z["aria-errormessage"] = a, z["aria-invalid"] = !0), N = Xe(M, z);
    }
  }
  return /* @__PURE__ */ O("div", { className: "ns-field", children: [
    /* @__PURE__ */ b("label", { htmlFor: L, className: "ns-field__label", children: n }),
    N,
    u ? /* @__PURE__ */ b("span", { id: a, className: "ns-field__error", children: t }) : v ? /* @__PURE__ */ b("span", { id: o, className: "ns-field__hint", children: i }) : null
  ] });
}
function qn({ children: n, className: i }) {
...
function Fn({
  ...
  ) : s !== void 0 ? /* @__PURE__ */ O("span", { className: _("ns-chip", a), children: [
    n,
    /* @__PURE__ */ b(
      "button",
      {
...
`;
var rn = Object.defineProperty, ys = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && rn(i, t, e), e;
}, Wt, F, T, R, y, Ue, Te, Be, lt, Ht, Vt, Gt, Xt;
const He = class He extends P {
  constructor() {
    ...
    d(this, Gt);
    d(this, Xt);
    this.position = "top-center", this.items = [], r(this, Wt, 0), r(this, F, !1), r(this, T, !1), r(this, R, !1), r(this, Ht, () => {
      r(this, F, !0), c(this, y, lt).call(this);
    }), r(this, Vt, () => {
      r(this, F, !1), c(this, y, lt).call(this);
    }), r(this, Gt, () => {
      r(this, T, !0), c(this, y, lt).call(this);
    }), r(this, Xt, () => {
      r(this, T, !1), c(this, y, lt).call(this);
    });
  }
  connectedCallback() {
    super.connectedCallback(), C(), c(this, y, Be).call(this);
  }
  disconnectedCallback() {
    c(this, y, Te).call(this), r(this, F, !1), r(this, T, !1), r(this, R, !1), super.disconnectedCallback();
  }
  /** 토스트 하나를 띄운다. 돌려주는 함수를 부르면 즉시 닫는다(두 번 불러도 안전). */
  show(t, s, e) {
    const o = Ge(this, Wt)._++, a = {
      key: o,
      message: t,
      tone: s,
      duration: e,
    ...
    return this.items = [...this.items, a], l(this, R) || c(this, y, Ue).call(this, a), () => this.dismiss(o);
  }
  ...
  updated() {
    var t;
    r(this, T, ((t = this.shadowRoot) == null ? void 0 : t.activeElement) != null), c(this, y, lt).call(this);
  }
  render() {
    return g`
      <div
      ...
      (t) => t.key,
      (t) => g`
            <div class="toast ${t.tone}" role=${t.tone === "danger" ? "alert" : x}>
              ${t.tone === "neutral" ? x : g`<span class="dot" aria-hidden="true"></span>`}
...
Wt = new WeakMap(), F = new WeakMap(), T = new WeakMap(), R = new WeakMap(), y = new WeakSet(), /*
...
Te = function() {
  ...
  for (const t of this.items) c(this, y, Ue).call(this, t);
}, /*
  두 사유를 하나의 적용 상태로 접는다. 사유가 바뀔 때마다 부르고, 실제 정지·재개는
  상태가 뒤집힐 때만 일어난다.
*/
lt = function() {
  const t = l(this, F) || l(this, T);
  t !== l(this, R) && (r(this, R, t), t ? c(this, y, Te).call(this) : c(this, y, Be).call(this));
}, Ht = new WeakMap(), Vt = new WeakMap(), Gt = new WeakMap(), Xt = new WeakMap(), He.styles = an;
let zt = He;
ys([
  p({ reflect: !0 })
], zt.prototype, "position");
ys([
  je()
], zt.prototype, "items");
$("ns-toast", zt);
...
function ln() {
  ...
  return i.position = ks, document.body.append(i), i;
}
function Rn(n) {
  if (ks = n, typeof document > "u") return;
...
function Wn(n, i = {}) {
  ...
  const { tone: t = "neutral", duration: s = 4e3 } = i;
  return ln().show(n, t, s);
}
function xs(n, i, t) {
  const s = document.activeElement, e = document.createElement("ns-dialog");
  e.heading = n.heading ?? "";
  const o = document.createElement("p");
  o.textContent = n.message, o.style.margin = "0", e.append(o);
  let a = !1;
  const u = (k) => {
    if (a) return;
    a = !0, e.close();
    const M = () => {
      e.remove(), t(k), s instanceof HTMLElement && s.isConnected && s.focus();
    };
    e.updateComplete.then(M, M);
  }, v = async (k) => {
    for (let M = 0; M < 5; M++)
      if (await e.updateComplete, a || (k.focus({ preventScroll: !0 }), document.activeElement === k)) return;
    console.warn(
  ...
  if (i) {
    ...
    k.type = "button", k.slot = "footer", k.className = "ns-button ns-button--outline ns-button--sm", k.textContent = n.cancelLabel ?? "취소", k.addEventListener("click", () => u(!1)), n.tone === "danger" && (L = k), e.append(k);
  }
  e.append(N), e.addEventListener("ns-dialog-close", () => u(!1)), document.body.append(e), e.show(), L !== null && v(L);
}
function Hn(n) {
