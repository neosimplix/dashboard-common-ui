...
import { useId as $s, isValidElement as Cs, cloneElement as Xe } from "react";
import { createComponent as P } from "@lit/react";
import { css as B, svg as te, LitElement as E, html as g, nothing as x, ReactiveElement as ss } from "lit";
import { svg as Gn } from "lit";
import { property as u, query as Ns, state as je } from "lit/decorators.js";
import { repeat as le } from "lit/directives/repeat.js";
import { jsx as b, jsxs as O, Fragment as _s } from "react/jsx-runtime";
function $(n, i) {
  typeof window > "u" || !("customElements" in window) || customElements.get(n) || customElements.define(n, i);
}
let be = !1;
const Ss = `[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
...
function nt(n, i) {
  ...
  HTML 에서 쓸 것: ${s}
  JS 에서는 el.${Ps(t)} 에 대입합니다.`
    ));
  }
}
const Ps = (n) => n.replace(/-([a-z])/g, (i, t) => t.toUpperCase()), Es = B`
...
`;
var Ms = Object.defineProperty, Os = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ms(i, t, e), e;
}, ct, et, ns, ve, dt;
let Le = (dt = class extends E {
  constructor() {
    super(...arguments);
    d(this, et);
    d(this, ct);
...
$("ns-icon", Le);
var Ds = Object.defineProperty, At = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ds(i, t, e), e;
...
`;
var zs = Object.defineProperty, is = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && zs(i, t, e), e;
}, Kt, ht;
let he = (ht = class extends E {
  constructor() {
    super(...arguments);
    d(this, Kt);
...
}, Kt = new WeakMap(), ht.styles = Is, ht);
is([
...
$("ns-header", he);
var Us = Object.defineProperty, j = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Us(i, t, e), e;
}, qt, I, os, xe, $e, Ye;
let A = (Ye = class extends E {
  constructor() {
    super(...arguments);
    d(this, I);
    /*
  ...
  render() {
    const t = l(this, I, xe), s = t.flatMap((a) => this.options.filter((p) => p.value === a)), e = this.query.trim().toLowerCase(), o = e === "" ? this.options : this.options.filter(
      (a) => [a.label, a.meta ?? ""].some((p) => p.toLowerCase().includes(e))
    );
    return g`
      ${s.length === 0 ? x : g`
      ...
      (a) => g`
                <label class="ns-checkbox">
                  <input
                    ...
                    @change=${(p) => c(this, I, $e).call(this, a.value, p.target)}
                  />
                  <span>${a.label}</span>
 ...
 */
$e = function(t, s) {
  const e = l(this, I, xe), o = e.includes(t) ? e.filter((p) => p !== t) : [...e, t];
...
`;
var Bs = Object.defineProperty, ue = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Bs(i, t, e), e;
}, G, ut, X, st, as, Ce, Ft, pt;
let Mt = (pt = class extends E {
  constructor() {
    super(...arguments);
    d(this, st);
    d(this, G);
...
}, Ft = new WeakMap(), pt.styles = Ts, pt);
ue([
  u({ type: String })
...
`;
var Ls = Object.defineProperty, Ke = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ls(i, t, e), e;
}, Rt, ft;
let Zt = (ft = class extends E {
  constructor() {
    super(...arguments);
    d(this, Rt);
...
}, Rt = new WeakMap(), ft.styles = js, ft);
Ke([
  u({ type: String })
], Zt.prototype, "href");
Ke([
...
`;
var qs = Object.defineProperty, rs = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && qs(i, t, e), e;
};
...
rs([
  u({ type: String })
], Pt.prototype, "description");
$("ns-page-heading", Pt);
var Fs = Object.defineProperty, Jt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Fs(i, t, e), e;
};
...
`;
var Hs = Object.defineProperty, ds = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Hs(i, t, e), e;
}, wt, ce, hs;
...
`;
var Gs = Object.defineProperty, qe = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Gs(i, t, e), e;
};
const Xs = /* @__PURE__ */ new Set(["badge", "control", "panel", "card", "pill"]);
var de, us, yt;
let Yt = (yt = class extends E {
  constructor() {
    super(...arguments);
    d(this, de);
  ...
  return Xs.has(this.radius) ? `var(--ns-radius-${this.radius})` : this.radius;
}, yt.styles = Vs, yt);
qe([
  u({ type: String })
], Yt.prototype, "width");
...
$("ns-skeleton", Yt);
var Zs = Object.defineProperty, Qt = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Zs(i, t, e), e;
};
...
var J, Y, Q, kt, xt, h, ps, Se, Pe, fs, rt, Ee, $t, ae, W, Ot, Ae, bs, gs, Dt, vs, ts;
let ot = (ts = class extends ss {
  constructor() {
    ...
    this.defaultSortKey = "", this.defaultSortDirection = "none", r(this, J, ""), r(this, Y, "none"), r(this, kt, !1), r(this, $t, (t) => {
      ...
      const a = o.dataset.nsSortKey ?? "", p = a === l(this, h, Se) ? Js(l(this, h, Pe)) : "ascending", v = p === "none" ? "" : a;
      l(this, h, ps) || (r(this, J, v), r(this, Y, p), this.requestUpdate());
      const N = { key: v, direction: p };
      this.dispatchEvent(
  ...
  connectedCallback() {
    super.connectedCallback(), C(), nt(this, {
      ...
      c(this, h, Ee).call(this), c(this, h, Ot).call(this), c(this, h, gs).call(this);
  ...
  */
  ...
  updated() {
    c(this, h, fs).call(this), c(this, h, Ee).call(this), c(this, h, Ot).call(this);
  }
...
rt = function(t) {
  ...
  */
Ee = function() {
  const t = l(this, h, Se), s = l(this, h, Pe);
...
Ot = function() {
  ...
  const s = c(this, h, ae).call(this), e = this.selected, o = e === void 0 ? s.filter((v) => v.checked).length : s.filter((v) => e.includes(c(this, h, W).call(this, v))).length, a = s.length > 0 && o === s.length, p = o > 0 && o < s.length;
  for (const v of t)
    v.checked = a, v.indeterminate = p;
...
vs = function(t) {
  ...
  if (t.hasAttribute("data-ns-select-all")) {
    if (this.selected === void 0)
      for (const p of s) p.checked = t.checked;
    c(this, h, Dt).call(this, t.checked ? s.map((p) => c(this, h, W).call(this, p)) : []), this.selected === void 0 && c(this, h, Ot).call(this);
    return;
  }
  if (!t.hasAttribute("data-ns-row-id")) return;
  let e;
  if (this.selected === void 0) {
    e = s.filter((p) => p.checked).map((p) => c(this, h, W).call(this, p)), c(this, h, Dt).call(this, e), c(this, h, Ot).call(this);
    return;
  }
  const o = new Set(this.selected), a = c(this, h, W).call(this, t);
  t.checked ? o.add(a) : o.delete(a), e = s.map((p) => c(this, h, W).call(this, p)).filter((p) => o.has(p)), c(this, h, Dt).call(this, e);
}, ts);
Qt([
  u({ attribute: !1 })
...
$("ns-table", ot);
var Ys = Object.defineProperty, ms = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && Ys(i, t, e), e;
};
...
let pe = (es = class extends ss {
  constructor() {
    ...
    this.defaultActive = "", r(this, tt, ""), r(this, Nt, !1), r(this, _t, (t) => {
      ...
      if (o === -1) return;
      const a = (p) => {
        t.preventDefault(), c(this, f, De).call(this, c(this, f, H).call(this, e[(p + e.length) % e.length]), !0);
      };
...
re = function() {
  ...
  for (const s of l(this, f, It)) {
    ...
    s.setAttribute("role", "tab"), !s.hasAttribute("id") && o !== "" && s.setAttribute("id", Qs(o)), o !== "" && s.setAttribute("aria-controls", o), s.setAttribute("aria-selected", e === t ? "true" : "false"), s.setAttribute("tabindex", e === t ? "0" : "-1");
  }
}, De = function(t, s) {
  if (t === "") return;
  if (t === l(this, f, Oe)) {
...
function Pn({ title: n, description: i, className: t }) {
  return /* @__PURE__ */ b(en, { heading: n, description: i ?? "", className: t });
}
function En({
  open: n,
  title: i,
  ...
  return /* @__PURE__ */ O(
    sn,
    {
      ...
      noBackdropClose: o,
      className: a,
      onNsDialogClose: (p) => t(p.detail.reason),
      children: [
        s,
...
function An({
  ...
  return /* @__PURE__ */ b(
    tn,
    {
      ...
      className: e,
      style: o,
      onNsNavigate: (a) => t == null ? void 0 : t(a.detail),
      children: s
    }
  );
}
...
function In({
  ...
  return /* @__PURE__ */ O(
    "details",
    {
      ...
      open: t,
      children: [
        /* @__PURE__ */ b("summary", { children: o === "plain" ? n : /* @__PURE__ */ O(_s, { children: [
...
function zn({ invalid: n = !1, className: i, ...t }) {
  return /* @__PURE__ */ b(
    "input",
    {
...
function Un({ invalid: n = !1, className: i, rows: t = 3, ...s }) {
  return /* @__PURE__ */ b(
    "textarea",
    {
...
function Tn({
  ...
  const p = e !== void 0 ? void 0 : o !== void 0 ? o : i !== void 0 ? "" : void 0;
  return /* @__PURE__ */ O(
    "select",
    {
...
function Bn({ label: n, hint: i, className: t, ...s }) {
...
function jn({ label: n, hint: i, error: t, children: s }) {
  var k;
  const e = $s(), o = `${e}-hint`, a = `${e}-error`, p = !!t, v = !p && !!i;
  let N = s, L = e;
  if (Cs(s)) {
    const M = s, at = (k = M.type) == null ? void 0 : k.nsFieldControl;
    if (L = at ? e : M.props.id ?? e, at) {
      const z = { [at.id]: L };
      v && (z[at.describedby] = o), p && (z[at.describedby] = a, z[at.invalid] = !0), N = Xe(M, z);
    } else {
      const z = { id: L };
      v && (z["aria-describedby"] = o), p && (z["aria-errormessage"] = a, z["aria-invalid"] = !0), N = Xe(M, z);
    }
  }
  return /* @__PURE__ */ O("div", { className: "ns-field", children: [
    /* @__PURE__ */ b("label", { htmlFor: L, className: "ns-field__label", children: n }),
    N,
    p ? /* @__PURE__ */ b("span", { id: a, className: "ns-field__error", children: t }) : v ? /* @__PURE__ */ b("span", { id: o, className: "ns-field__hint", children: i }) : null
  ] });
}
function Ln({ children: n, className: i }) {
...
`;
var on = Object.defineProperty, ys = (n, i, t, s) => {
  for (var e = void 0, o = n.length - 1, a; o >= 0; o--)
    (a = n[o]) && (e = a(i, t, e) || e);
  return e && on(i, t, e), e;
...
}, Ht = new WeakMap(), Vt = new WeakMap(), Gt = new WeakMap(), Xt = new WeakMap(), He.styles = nn;
let zt = He;
ys([
  u({ reflect: !0 })
...
function xs(n, i, t) {
  ...
  N.type = "button", N.slot = "footer", N.className = n.tone === "danger" ? "ns-button ns-button--danger ns-button--sm" : "ns-button ns-button--solid ns-button--sm", N.textContent = n.confirmLabel ?? "확인", N.addEventListener("click", () => p(!0));
  let L = null;
  if (i) {
    const k = document.createElement("button");
    k.type = "button", k.slot = "footer", k.className = "ns-button ns-button--outline ns-button--sm", k.textContent = n.cancelLabel ?? "취소", k.addEventListener("click", () => p(!1)), n.tone === "danger" && (L = k), e.append(k);
  }
  e.append(N), e.addEventListener("ns-dialog-close", () => p(!1)), document.body.append(e), e.show(), L !== null && v(L);
}
function Rn(n) {
