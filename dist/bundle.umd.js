 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Yn}=Un,Bs=i=>i,qs=()=>document.createComment(""),Xt=(i,e,t)=>{var o;const n=i._$AA.parentNode,s=e===void 0?i._$AB:e._$AA;if(t===void 0){const r=n.insertBefore(qs(),s),a=n.insertBefore(qs(),s);t=new Yn(r,a,i,i.options)}else{const r=t._$AB.nextSibling,a=t._$AM,h=a!==i;if(h){let b;(o=t._$AQ)==null||o.call(t,i),t._$AM=i,t._$AP!==void 0&&(b=i._$AU)!==a._$AU&&t._$AP(b)}if(r!==s||h){let b=t._$AA;for(;b!==r;){const A=Bs(b).nextSibling;Bs(n).insertBefore(b,s),b=A}}}return t},st=(i,e,t=i)=>(i._$AI(e,t),i),Gn={},Qn=(i,e=Gn)=>i._$AH=e,ti=i=>i._$AH,Le=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ks=(i,e,t)=>{const n=new Map;for(let s=e;s<=t;s++)n.set(i[s],s);return n},we=Jn(class extends Xn{constructor(i){if(super(i),i.type!==Zn.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let n;t===void 0?t=e:e!==void 0&&(n=e);const s=[],o=[];let r=0;for(const a of i)s[r]=n?n(a,r):r,o[r]=t(a,r),r++;return{values:o,keys:s}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,n]){const s=ti(i),{values:o,keys:r}=this.dt(e,t,n);if(!Array.isArray(s))return this.ut=r,o;const a=this.ut??(this.ut=[]),h=[];let b,A,u=0,$=s.length-1,w=0,E=o.length-1;for(;u<=$&&w<=E;)if(s[u]===null)u++;else if(s[$]===null)$--;else if(a[u]===r[w])h[w]=st(s[u],o[w]),u++,w++;else if(a[$]===r[E])h[E]=st(s[$],o[E]),$--,E--;else if(a[u]===r[E])h[E]=st(s[u],o[E]),Xt(i,h[E+1],s[u]),u++,E--;else if(a[$]===r[w])h[w]=st(s[$],o[w]),Xt(i,s[u],s[$]),$--,w++;else if(b===void 0&&(b=Ks(r,w,E),A=Ks(a,u,$)),b.has(a[u]))if(b.has(a[$])){const H=A.get(r[w]),Qe=H!==void 0?s[H]:null;if(Qe===null){const Qs=Xt(i,s[u]);st(Qs,o[w]),h[w]=Qs}else h[w]=st(Qe,o[w]),Xt(i,s[u],Qe),s[H]=null;w++}else Le(s[$]),$--;else Le(s[u]),u++;for(;w<=E;){const H=Xt(i,h[E+1]);st(H,o[w]),h[w++]=H}for(;u<=$;){const H=s[u++];H!==null&&Le(H)}return this.ut=r,Qn(i,h),G}});var ei=Object.defineProperty,K=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ei(e,t,s),s};class N extends M{constructor(){super(...arguments);p(this,D);p(this,oe);this.options=[],this.defaultValue=[],this.searchPlaceholder="검색",this.emptyMessage="결과가 없습니다",this.inputId="",this.inputDescribedby="",this.query=""}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{value:"defaultValue 프로퍼티 (배열은 속성으로 쓸 수 없습니다)",options:"options 프로퍼티 (배열은 속성으로 쓸 수 없습니다)","default-value":"defaultValue 프로퍼티"})}render(){const t=c(this,D,rs),n=t.flatMap(r=>this.options.filter(a=>a.value===r)),s=this.query.trim().toLowerCase(),o=s===""?this.options:this.options.filter(r=>[r.label,r.meta??""].some(a=>a.toLowerCase().includes(s)));return x`
      ${n.length===0?y:x`
      ...
      <div class="ns-multi-select__list">
        ${o.length===0?x`<p class="ns-multi-select__empty">${this.emptyMessage}</p>`:we(o,r=>r.value,r=>x`
                <label class="ns-checkbox">
                  ...
                  />
                  <span>${r.label}</span>
                  ${r.meta===void 0?y:x`<span class="ns-checkbox__hint">${r.meta}</span>`}
                </label>
              `)}
      </div>
...
`;var ni=Object.defineProperty,_e=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ni(e,t,s),s};const Ve=class Ve extends M{constructor(){super(...arguments);p(this,ht);p(this,ct);p(this,St);p(this,dt);p(this,re);this.heading="",this.collapsible=!1,this.defaultCollapsed=!1,l(this,ct,!1),l(this,St,!1),l(this,dt,!1),l(this,re,()=>{const t=!c(this,ht,ls);l(this,St,!0),c(this,ht,on)||(l(this,ct,!t),this.requestUpdate());const n={open:t};this.dispatchEvent(new CustomEvent("ns-group-toggle",{detail:n,bubbles:!0,composed:!0}))})}connectedCallback(){var n;super.connectedCallback(),U(),et(this,{open:"default-collapsed"});const t=((n=this.parentElement)==null?void 0:n.closest("ns-nav-group"))!=null;t!==c(this,dt)&&(l(this,dt,t),this.requestUpdate())}willUpdate(t){t.has("defaultCollapsed")&&!c(this,St)&&l(this,ct,this.defaultCollapsed)}render(){const t=c(this,ht,ls);return x`
      <div role="group" aria-label=${this.heading} class=${c(this,dt)?"nested":""}>
        ${this.collapsible?x`
            ...
            `:x`<div class="heading">${this.heading}</div>`}
...
`;var ai=Object.defineProperty,Fs=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ai(e,t,s),s};const Je=class Je extends M{constructor(){super(...arguments),this.heading="",this.description=""}connectedCallback(){super.connectedCallback(),U()}render(){return x`
      <h1>${this.heading}</h1>
      ${this.description?x`<p>${this.description}</p>`:y}
    `}};Je.styles=ri;let At=Je;Fs([v({type:String})],At.prototype,"heading"),Fs([v({type:String})],At.prototype,"description"),O("ns-page-heading",At);var li=Object.defineProperty,Yt=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&li(e,t,s),s};const Be=7;function Ae(i,e){return Array.from({length:Math.max(e-i+1,0)},(t,n)=>i+n)}function ci(i,e,t){if(e<=t)return Ae(1,e);const n=t-2,s=(t-5)/2;return i<=n?[...Ae(1,n),"gap",e]:i>e-n?[1,"gap",...Ae(e-n+1,e)]:[1,"gap",...Ae(i-s,i+s),"gap",e]}class it extends M{constructor(){super(...arguments);p(this,k);p(this,V);p(this,Et);p(this,Pt);p(this,Mt);p(this,Ot);p(this,ut);this.total=0,this.perPage=20,this.defaultPage=1,this.pageWindow=Be,l(this,V,1),l(this,Et,!1),l(this,Pt,!1),l(this,Mt,!1),l(this,Ot,!1),l(this,ut,null)}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{page:"default-page"})}willUpdate(){if(!this.hasUpdated){if(!Number.isInteger(this.defaultPage)||this.defaultPage<1){console.warn(`[ns-pagination] default-page=${this.defaultPage} 는 1 이상의 정수여야 합니다. 1 페이지에서 시작합니다.`);return}this.defaultPage!==1&&l(this,V,this.defaultPage)}}updated(){var o;const t=c(this,ut);if(t===null||(l(this,ut,null),(this.page??c(this,V))!==t.page))return;const n=this.ownerDocument.activeElement;if(n!==null&&n!==this.ownerDocument.body&&!this.contains(n))return;const s=typeof t.control=="number"?`button[data-ns-page="${t.control}"]`:`button[data-ns-nav="${t.control}"]`;(o=this.querySelector(s))==null||o.focus()}render(){const t=c(this,k,Ee);if(t<=1)return y;const n=d(this,k,ds).call(this);return x`
      <nav aria-label="페이지 이동">
        ...
        <span class="ns-pagination-pages">
          ${we(ci(n,t,c(this,k,rn)),(s,o)=>s==="gap"?`gap-${o}`:s,s=>s==="gap"?x`<span class="ns-pagination-gap" aria-hidden="true">…</span>`:x`<button
...
`;var yi=Object.defineProperty,Js=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&yi(e,t,s),s};const Ge=class Ge extends M{constructor(){super(...arguments);p(this,P);p(this,le);p(this,Z);p(this,z);p(this,J);p(this,ce);p(this,de);p(this,he);p(this,ue);this.position="top-center",this.items=[],l(this,le,0),l(this,Z,!1),l(this,z,!1),l(this,J,!1),l(this,ce,()=>{l(this,Z,!0),d(this,P,It).call(this)}),l(this,de,()=>{l(this,Z,!1),d(this,P,It).call(this)}),l(this,he,()=>{l(this,z,!0),d(this,P,It).call(this)}),l(this,ue,()=>{l(this,z,!1),d(this,P,It).call(this)})}connectedCallback(){super.connectedCallback(),U(),d(this,P,_s).call(this)}disconnectedCallback(){d(this,P,ws).call(this),l(this,Z,!1),l(this,z,!1),l(this,J,!1),super.disconnectedCallback()}show(t,n,s){const o=en(this,le)._++,r={key:o,message:t,tone:n,duration:s,remaining:s,startedAt:Date.now()};return this.items=[...this.items,r],c(this,J)||d(this,P,$s).call(this,r),()=>this.dismiss(o)}dismiss(t){const n=this.items.find(s=>s.key===t);n!==void 0&&(n.timer!==void 0&&clearTimeout(n.timer),this.items=this.items.filter(s=>s.key!==t))}updated(){var t;l(this,z,((t=this.shadowRoot)==null?void 0:t.activeElement)!=null),d(this,P,It).call(this)}render(){return x`
      <div
        ...
        @focusout=${c(this,ue)}
      >
        ${we(this.items,t=>t.key,t=>x`
            <div class="toast ${t.tone}" role=${t.tone==="danger"?"alert":y}>
              ${t.tone==="neutral"?y:x`<span class="dot" aria-hidden="true"></span>`}
