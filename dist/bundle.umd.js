 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jn=(i,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(i,e,t),t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Rn(i,e){return(t,n,s)=>{const o=r=>{var a;return((a=r.renderRoot)==null?void 0:a.querySelector(i))??null};return jn(t,n,{get(){return o(this)}})}}function M(i,e){typeof window>"u"||!("customElements"in window)||customElements.get(i)||customElements.define(i,e)}let He=!1;const zn=`[@neosimplix/common-ui] tokens.css 가 로드되지 않아 레이아웃이 깨집니다.
  ...
  HTML 에서 쓸 것: ${n}
  JS 에서는 el.${Hn(t)} 에 대입합니다.`))}}const Hn=i=>i.replace(/-([a-z])/g,(e,t)=>t.toUpperCase()),Ln=j`
...
`,$e={menu:{viewBox:"0 0 20 20",content:Vt`
    ...
    `},google:{viewBox:"0 0 18 18",content:Vt`
      ...
      />
    `}};function In(i){Object.assign($e,i)}const Bn=j`
  /*
...
`;var qn=Object.defineProperty,Kn=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&qn(e,t,s),s};const Ke=class Ke extends O{constructor(){super(...arguments);p(this,at);p(this,Ct);this.name="",l(this,Ct,"")}connectedCallback(){super.connectedCallback(),U()}render(){return k`<slot>${h(this,at,sn).call(this)}</slot>`}updated(){var n;const t=((n=this.renderRoot.querySelector("slot"))==null?void 0:n.assignedNodes())??[];if(!t.some(s=>s.nodeType===Node.ELEMENT_NODE)){if(t.length>0){h(this,at,es).call(this,`공백-${this.name}`,`[ns-icon] 공백만 든 자식이 슬롯을 채워 name="${this.name}" 폴백이 그려지지 않았다. <ns-icon name="${this.name}"></ns-icon> 처럼 안쪽을 붙여 쓴다.`);return}this.name!==""&&!$e[this.name]&&h(this,at,es).call(this,`없음-${this.name}`,`[ns-icon] 없는 아이콘: "${this.name}". 사용 가능: ${Object.keys($e).join(", ")}. registerIcons() 로 더하거나, 자식으로 직접 넣는다 — <ns-icon><MyIcon /></ns-icon> 는 name 없이 동작한다.`)}}};Ct=new WeakMap,at=new WeakSet,sn=function(){if(this.name==="")return y;const t=$e[this.name];return t?k`<svg viewBox=${t.viewBox} fill="none" aria-hidden="true">${t.content}</svg>`:y},es=function(t,n){c(this,Ct)!==t&&(l(this,Ct,t),console.warn(n))},Ke.styles=Bn;let Jt=Ke;Kn([v({type:String})],Jt.prototype,"name"),M("ns-icon",Jt);var Fn=Object.defineProperty,wt=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&Fn(e,t,s),s};const Fe=class Fe extends O{constructor(){super(...arguments);p(this,S);p(this,R);p(this,lt);p(this,W);p(this,Qt);p(this,te);p(this,ee);p(this,se);p(this,ne);this.heading="",this.defaultOpen=!1,this.noBackdropClose=!1,this.hasFooter=!1,l(this,R,!1),l(this,lt,!1),l(this,W,!1),l(this,Qt,t=>{const n=t.target;this.hasFooter=n.assignedNodes({flatten:!0}).length>0}),l(this,te,()=>{if(c(this,W)){l(this,W,!1);return}h(this,S,Se).call(this,"escape")}),l(this,ee,()=>{h(this,S,Se).call(this,"close-button")}),l(this,se,t=>{l(this,lt,h(this,S,os).call(this,t))}),l(this,ne,t=>{const n=c(this,lt);l(this,lt,!1),!this.noBackdropClose&&t.detail!==0&&(!n||!h(this,S,os).call(this,t)||h(this,S,Se).call(this,"backdrop"))})}connectedCallback(){super.connectedCallback(),U(),et(this,{open:"default-open"});const t=this.dialogEl;t!=null&&t.open&&(l(this,W,!0),t.close()),this.requestUpdate()}firstUpdated(){this.defaultOpen&&l(this,R,!0)}show(){h(this,S,is).call(this,"show")||(l(this,R,!0),this.requestUpdate())}close(){h(this,S,is).call(this,"close")||(l(this,R,!1),this.requestUpdate())}updated(){const t=this.dialogEl;t&&(c(this,S,ns)&&!t.open?this.isConnected&&t.showModal():!c(this,S,ns)&&t.open&&(l(this,W,!0),t.close()))}render(){return k`
      <dialog
    ...
    `}};R=new WeakMap,lt=new WeakMap,W=new WeakMap,S=new WeakSet,ss=function(){return this.open!==void 0},ns=function(){return this.open??c(this,R)},is=function(t){return c(this,S,ss)?(console.warn(`[ns-dialog] open 프로퍼티가 설정된 제어 모드에서는 ${t}() 가 동작하지 않습니다. open 을 바꾸세요.`),!0):!1},Qt=new WeakMap,te=new WeakMap,ee=new WeakMap,se=new WeakMap,ne=new WeakMap,os=function(t){const n=this.dialogEl;if(!n)return!1;const s=n.getBoundingClientRect();return t.clientX<s.left||t.clientX>s.right||t.clientY<s.top||t.clientY>s.bottom},Se=function(t){c(this,S,ss)||l(this,R,!1);const n={reason:t};this.dispatchEvent(new CustomEvent("ns-dialog-close",{detail:n,bubbles:!0,composed:!0})),this.requestUpdate()},Fe.styles=Ln;let T=Fe;wt([v({type:String})],T.prototype,"heading"),wt([v({attribute:!1})],T.prototype,"open"),wt([v({type:Boolean,attribute:"default-open"})],T.prototype,"defaultOpen"),wt([v({type:Boolean,attribute:"no-backdrop-close"})],T.prototype,"noBackdropClose"),wt([Rn("dialog")],T.prototype,"dialogEl"),wt([ze()],T.prototype,"hasFooter"),M("ns-dialog",T);const Wn=j`
  :host {
    display: block;
    box-sizing: border-box;
...
`;var Vn=Object.defineProperty,Is=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&Vn(e,t,s),s};const We=class We extends O{constructor(){super(...arguments);p(this,ie);this.projectName="",this.sidebarOpen=!1,l(this,ie,()=>{const t={open:!this.sidebarOpen};this.dispatchEvent(new CustomEvent("ns-toggle",{detail:t,bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback(),U()}render(){return k`
      <header>
        <button
          class="toggle"
          type="button"
    ...
    `}};ie=new WeakMap,We.styles=Wn;let _t=We;Is([v({type:String,attribute:"project-name"})],_t.prototype,"projectName"),Is([v({type:Boolean,reflect:!0,attribute:"sidebar-open"})],_t.prototype,"sidebarOpen"),M("ns-header",_t);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Yn}=Un,Bs=i=>i,qs=()=>document.createComment(""),Xt=(i,e,t)=>{var o;const n=i._$AA.parentNode,s=e===void 0?i._$AB:e._$AA;if(t===void 0){const r=n.insertBefore(qs(),s),a=n.insertBefore(qs(),s);t=new Yn(r,a,i,i.options)}else{const r=t._$AB.nextSibling,a=t._$AM,d=a!==i;if(d){let b;(o=t._$AQ)==null||o.call(t,i),t._$AM=i,t._$AP!==void 0&&(b=i._$AU)!==a._$AU&&t._$AP(b)}if(r!==s||d){let b=t._$AA;for(;b!==r;){const A=Bs(b).nextSibling;Bs(n).insertBefore(b,s),b=A}}}return t},st=(i,e,t=i)=>(i._$AI(e,t),i),Gn={},Qn=(i,e=Gn)=>i._$AH=e,ti=i=>i._$AH,Le=i=>{i._$AR(),i._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ks=(i,e,t)=>{const n=new Map;for(let s=e;s<=t;s++)n.set(i[s],s);return n},we=Jn(class extends Xn{constructor(i){if(super(i),i.type!==Zn.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let n;t===void 0?t=e:e!==void 0&&(n=e);const s=[],o=[];let r=0;for(const a of i)s[r]=n?n(a,r):r,o[r]=t(a,r),r++;return{values:o,keys:s}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,n]){const s=ti(i),{values:o,keys:r}=this.dt(e,t,n);if(!Array.isArray(s))return this.ut=r,o;const a=this.ut??(this.ut=[]),d=[];let b,A,u=0,$=s.length-1,w=0,E=o.length-1;for(;u<=$&&w<=E;)if(s[u]===null)u++;else if(s[$]===null)$--;else if(a[u]===r[w])d[w]=st(s[u],o[w]),u++,w++;else if(a[$]===r[E])d[E]=st(s[$],o[E]),$--,E--;else if(a[u]===r[E])d[E]=st(s[u],o[E]),Xt(i,d[E+1],s[u]),u++,E--;else if(a[$]===r[w])d[w]=st(s[$],o[w]),Xt(i,s[u],s[$]),$--,w++;else if(b===void 0&&(b=Ks(r,w,E),A=Ks(a,u,$)),b.has(a[u]))if(b.has(a[$])){const H=A.get(r[w]),Qe=H!==void 0?s[H]:null;if(Qe===null){const Qs=Xt(i,s[u]);st(Qs,o[w]),d[w]=Qs}else d[w]=st(Qe,o[w]),Xt(i,s[u],Qe),s[H]=null;w++}else Le(s[$]),$--;else Le(s[u]),u++;for(;w<=E;){const H=Xt(i,d[E+1]);st(H,o[w]),d[w++]=H}for(;u<=$;){const H=s[u++];H!==null&&Le(H)}return this.ut=r,Qn(i,d),G}});var ei=Object.defineProperty,K=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ei(e,t,s),s};class N extends O{constructor(){super(...arguments);p(this,D);p(this,oe);this.options=[],this.defaultValue=[],this.searchPlaceholder="검색",this.emptyMessage="결과가 없습니다",this.inputId="",this.inputDescribedby="",this.query=""}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{value:"defaultValue 프로퍼티 (배열은 속성으로 쓸 수 없습니다)",options:"options 프로퍼티 (배열은 속성으로 쓸 수 없습니다)","default-value":"defaultValue 프로퍼티"})}render(){const t=c(this,D,rs),n=t.flatMap(r=>this.options.filter(a=>a.value===r)),s=this.query.trim().toLowerCase(),o=s===""?this.options:this.options.filter(r=>[r.label,r.meta??""].some(a=>a.toLowerCase().includes(s)));return k`
      ${n.length===0?y:k`
              ...
              ${we(n,r=>r.value,r=>k`
                  <span class="ns-chip">
                    ...
                    <button
                      ...
                      @click=${()=>h(this,D,as).call(this,r.value)}
                    >
                      ×
                    </button>
                  </span>
  ...
  */
  ...
  /*
    ...
    **레일이 없어지면서 그 이유도 없어졌다.** 지금 최상위 그룹은 ns-sidebar 의
    ...
    문구는 README.md 의 0.5.0 이주 절에 있고, 좁아진 화면을 사람이 판정하는 것은
    docs/pending-human-checks.md 의 A-23 이다.
...
`;var ni=Object.defineProperty,_e=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ni(e,t,s),s};const Ve=class Ve extends O{constructor(){super(...arguments);p(this,dt);p(this,ct);p(this,St);p(this,ht);p(this,re);this.heading="",this.collapsible=!1,this.defaultCollapsed=!1,l(this,ct,!1),l(this,St,!1),l(this,ht,!1),l(this,re,()=>{const t=!c(this,dt,ls);l(this,St,!0),c(this,dt,on)||(l(this,ct,!t),this.requestUpdate());const n={open:t};this.dispatchEvent(new CustomEvent("ns-group-toggle",{detail:n,bubbles:!0,composed:!0}))})}connectedCallback(){var n;super.connectedCallback(),U(),et(this,{open:"default-collapsed"});const t=((n=this.parentElement)==null?void 0:n.closest("ns-nav-group"))!=null;t!==c(this,ht)&&(l(this,ht,t),this.requestUpdate())}willUpdate(t){t.has("defaultCollapsed")&&!c(this,St)&&l(this,ct,this.defaultCollapsed)}render(){const t=c(this,dt,ls);return k`
      <div role="group" aria-label=${this.heading} class=${c(this,ht)?"nested":""}>
        ${this.collapsible?k`
              <button
                class="heading"
                type="button"
            ...
            `:k`<div class="heading">${this.heading}</div>`}
        <div id="list" class=${this.collapsible&&!t?"list collapsed":"list"}>
          <slot></slot>
        </div>
      </div>
    `}};ct=new WeakMap,St=new WeakMap,ht=new WeakMap,dt=new WeakSet,on=function(){return this.open!==void 0},ls=function(){return this.open??!c(this,ct)},re=new WeakMap,Ve.styles=si;let F=Ve;_e([v({type:String})],F.prototype,"heading"),_e([v({type:Boolean})],F.prototype,"collapsible"),_e([v({attribute:!1})],F.prototype,"open"),_e([v({type:Boolean,attribute:"default-collapsed"})],F.prototype,"defaultCollapsed"),M("ns-nav-group",F);const ii=j`
  :host {
    display: block;
  }
...
`;var oi=Object.defineProperty,Ie=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&oi(e,t,s),s};const Ze=class Ze extends O{constructor(){super(...arguments);p(this,ae);this.href="",this.label="",this.active=!1,l(this,ae,t=>{if(t.button!==0||t.metaKey||t.ctrlKey||t.shiftKey||t.altKey)return;t.preventDefault();const n={href:this.href,label:this.label};this.dispatchEvent(new CustomEvent("ns-navigate",{detail:n,bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback(),U()}render(){return k`
      <a class="row" href=${this.href} title=${this.label} @click=${c(this,ae)}>
        <slot name="leading"></slot>
        <span class="label">${this.label}</span>
        <slot name="trailing"></slot>
      </a>
    `}};ae=new WeakMap,Ze.styles=ii;let nt=Ze;Ie([v({type:String})],nt.prototype,"href"),Ie([v({type:String})],nt.prototype,"label"),Ie([v({type:Boolean,reflect:!0})],nt.prototype,"active"),M("ns-nav-item",nt);const ri=j`
  :host {
    display: block;
  }
...
`;var ai=Object.defineProperty,Fs=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&ai(e,t,s),s};const Je=class Je extends O{constructor(){super(...arguments),this.heading="",this.description=""}connectedCallback(){super.connectedCallback(),U()}render(){return k`
      <h1>${this.heading}</h1>
      ${this.description?k`<p>${this.description}</p>`:y}
    `}};Je.styles=ri;let At=Je;Fs([v({type:String})],At.prototype,"heading"),Fs([v({type:String})],At.prototype,"description"),M("ns-page-heading",At);var li=Object.defineProperty,Yt=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&li(e,t,s),s};const Be=7;function Ae(i,e){return Array.from({length:Math.max(e-i+1,0)},(t,n)=>i+n)}function ci(i,e,t){if(e<=t)return Ae(1,e);const n=t-2,s=(t-5)/2;return i<=n?[...Ae(1,n),"gap",e]:i>e-n?[1,"gap",...Ae(e-n+1,e)]:[1,"gap",...Ae(i-s,i+s),"gap",e]}class it extends O{constructor(){super(...arguments);p(this,x);p(this,V);p(this,Et);p(this,Pt);p(this,Ot);p(this,Mt);p(this,ut);this.total=0,this.perPage=20,this.defaultPage=1,this.pageWindow=Be,l(this,V,1),l(this,Et,!1),l(this,Pt,!1),l(this,Ot,!1),l(this,Mt,!1),l(this,ut,null)}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{page:"default-page"})}willUpdate(){if(!this.hasUpdated){if(!Number.isInteger(this.defaultPage)||this.defaultPage<1){console.warn(`[ns-pagination] default-page=${this.defaultPage} 는 1 이상의 정수여야 합니다. 1 페이지에서 시작합니다.`);return}this.defaultPage!==1&&l(this,V,this.defaultPage)}}updated(){var o;const t=c(this,ut);if(t===null||(l(this,ut,null),(this.page??c(this,V))!==t.page))return;const n=this.ownerDocument.activeElement;if(n!==null&&n!==this.ownerDocument.body&&!this.contains(n))return;const s=typeof t.control=="number"?`button[data-ns-page="${t.control}"]`:`button[data-ns-nav="${t.control}"]`;(o=this.querySelector(s))==null||o.focus()}render(){const t=c(this,x,Ee);if(t<=1)return y;const n=h(this,x,hs).call(this);return k`
      <nav aria-label="페이지 이동">
        <button
          ...
          @click=${()=>h(this,x,Pe).call(this,"prev",n-1)}
        >
          이전
        </button>
        <span class="ns-pagination-pages">
          ${we(ci(n,t,c(this,x,rn)),(s,o)=>s==="gap"?`gap-${o}`:s,s=>s==="gap"?k`<span class="ns-pagination-gap" aria-hidden="true">…</span>`:k`<button
                    class=${s===n?"ns-button ns-button--outline ns-button--sm":"ns-button ns-button--ghost ns-button--sm"}
                    type="button"
                    data-ns-page=${s}
                    aria-current=${s===n?"page":y}
                    @click=${()=>h(this,x,Pe).call(this,s,s)}
                  >
                    ${s}
                  </button>`)}
        </span>
        <button
          ...
          @click=${()=>h(this,x,Pe).call(this,"next",n+1)}
        >
          다음
        </button>
      </nav>
    `}}V=new WeakMap,Et=new WeakMap,Pt=new WeakMap,Ot=new WeakMap,Mt=new WeakMap,ut=new WeakMap,x=new WeakSet,cs=function(){return this.page!==void 0},Ee=function(){return this.perPage>0?!Number.isFinite(this.total)||this.total<0?(c(this,Ot)||(l(this,Ot,!0),console.warn(`[ns-pagination] total=${this.total} 은 0 이상의 유한한 수여야 합니다. 페이징을 렌더하지 않습니다.`)),0):Math.ceil(this.total/this.perPage):(c(this,Pt)||(l(this,Pt,!0),console.warn(`[ns-pagination] per-page=${this.perPage} 는 1 이상이어야 합니다. 페이징을 렌더하지 않습니다.`)),0)},rn=function(){const t=this.pageWindow;return Number.isInteger(t)&&t>=5&&t%2===1?t:(c(this,Mt)||(l(this,Mt,!0),console.warn(`[ns-pagination] page-window=${t} 는 5 이상의 홀수여야 합니다. ${Be} 로 그립니다.`)),Be)},hs=function(){const t=this.page??c(this,V),n=c(this,x,Ee);if(Number.isInteger(t)&&t>=1&&t<=n)return t;const s=Number.isFinite(t)?Math.min(Math.max(Math.round(t),1),Math.max(n,1)):1;return c(this,Et)||(l(this,Et,!0),console.warn(c(this,x,cs)?`[ns-pagination] page=${t} 가 1..${n} 범위를 벗어났습니다. 표시용으로 ${s} 로 보정합니다.`:`[ns-pagination] 현재 페이지 ${t} 가 total=${this.total} · per-page=${this.perPage} 로 계산된 페이지 수(${n})를 벗어났습니다. 표시용으로 ${s} 로 보정합니다.`)),s},an=function(t){if(!Number.isInteger(t)||t<1||t>c(this,x,Ee)||t===h(this,x,hs).call(this))return!1;c(this,x,cs)||(l(this,V,t),this.requestUpdate());const n={page:t};return this.dispatchEvent(new CustomEvent("ns-page-change",{detail:n,bubbles:!0,composed:!0})),!0},Pe=function(t,n){h(this,x,an).call(this,n)&&l(this,ut,{control:t,page:n})},Yt([v({type:Number})],it.prototype,"total"),Yt([v({type:Number,attribute:"per-page"})],it.prototype,"perPage"),Yt([v({attribute:!1})],it.prototype,"page"),Yt([v({type:Number,attribute:"default-page"})],it.prototype,"defaultPage"),Yt([v({type:Number,attribute:"page-window"})],it.prototype,"pageWindow"),M("ns-pagination",it);const hi=j`
  /*
...
`;var di=Object.defineProperty,Ws=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&di(e,t,s),s};const Xe=class Xe extends O{constructor(){super(...arguments);p(this,xe);p(this,Ut);this.defaultOpen=!1,l(this,Ut,!1)}connectedCallback(){super.connectedCallback(),U(),et(this,{open:"default-open"})}willUpdate(t){t.has("defaultOpen")&&l(this,Ut,this.defaultOpen===!0)}updated(){this.toggleAttribute("data-ns-open",c(this,xe,ln))}render(){return k`<nav><slot></slot></nav>`}};Ut=new WeakMap,xe=new WeakSet,ln=function(){return this.open??c(this,Ut)},Xe.styles=hi;let kt=Xe;Ws([v({attribute:!1})],kt.prototype,"open"),Ws([v({type:Boolean,attribute:"default-open"})],kt.prototype,"defaultOpen"),M("ns-sidebar",kt);const ui=j`
  :host {
    display: block;
  }
...
`;var pi=Object.defineProperty,qe=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&pi(e,t,s),s};const fi=new Set(["badge","control","panel","card","pill"]),Ye=class Ye extends O{constructor(){super(...arguments);p(this,Ce);this.width="100%",this.height="1rem",this.radius="control"}connectedCallback(){super.connectedCallback(),U()}render(){return k`
      <div
        class="bar"
        aria-hidden="true"
        style="width:${this.width};height:${this.height};border-radius:${h(this,Ce,cn).call(this)}"
      ></div>
    `}};Ce=new WeakSet,cn=function(){return fi.has(this.radius)?`var(--ns-radius-${this.radius})`:this.radius},Ye.styles=ui;let ot=Ye;qe([v({type:String})],ot.prototype,"width"),qe([v({type:String})],ot.prototype,"height"),qe([v({type:String})],ot.prototype,"radius"),M("ns-skeleton",ot);var gi=Object.defineProperty,Gt=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&gi(e,t,s),s};function bi(i){return i==="none"?"ascending":i==="ascending"?"descending":"none"}class rt extends B{constructor(){super(...arguments);p(this,f);p(this,pt);p(this,ft);p(this,gt);p(this,Tt);p(this,Nt);p(this,Dt);this.defaultSortKey="",this.defaultSortDirection="none",l(this,pt,""),l(this,ft,"none"),l(this,Tt,!1),l(this,Dt,t=>{const n=t.target,s=n==null?void 0:n.closest('input[type="checkbox"][data-ns-select-all], input[type="checkbox"][data-ns-row-id]');if(s&&h(this,f,Lt).call(this,s)){h(this,f,fn).call(this,s);return}const o=n==null?void 0:n.closest("th[data-ns-sort-key]");if(!o||!h(this,f,Lt).call(this,o))return;const r=o.dataset.nsSortKey??"",a=r===c(this,f,ds)?bi(c(this,f,us)):"ascending",d=a==="none"?"":r;c(this,f,hn)||(l(this,pt,d),l(this,ft,a),this.requestUpdate());const b={key:d,direction:a};this.dispatchEvent(new CustomEvent("ns-sort",{detail:b,bubbles:!0,composed:!0}))})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{"sort-key":"default-sort-key","sort-direction":"default-sort-direction",selected:"각 행 checkbox 의 checked 속성"}),this.addEventListener("click",c(this,Dt)),l(this,Nt,new MutationObserver(()=>{h(this,f,ps).call(this),h(this,f,pe).call(this),h(this,f,pn).call(this)})),c(this,Nt).observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){var t;this.removeEventListener("click",c(this,Dt)),(t=c(this,Nt))==null||t.disconnect(),super.disconnectedCallback()}firstUpdated(){this.defaultSortKey!==""&&l(this,pt,this.defaultSortKey),this.defaultSortDirection!=="none"&&l(this,ft,this.defaultSortDirection),this.selected===void 0&&l(this,gt,h(this,f,fs).call(this))}updated(){h(this,f,dn).call(this),h(this,f,ps).call(this),h(this,f,pe).call(this)}}pt=new WeakMap,ft=new WeakMap,gt=new WeakMap,Tt=new WeakMap,Nt=new WeakMap,f=new WeakSet,hn=function(){return this.sortKey!==void 0},ds=function(){return this.sortKey??c(this,pt)},us=function(){return this.sortDirection??c(this,ft)},dn=function(){c(this,Tt)||this.sortDirection===void 0||this.sortKey!==void 0||(l(this,Tt,!0),console.warn(`[ns-table] sortDirection="${this.sortDirection}" 만 설정하고 sortKey 는 설정하지 않았습니다. 둘은 짝이라 이 상태에서는 정렬 방향이 바뀌지 않습니다. 제어하려면 둘 다 설정하고, 비제어 초기값이 목적이면 default-sort-direction 을 쓰세요.`))},Lt=function(t){return t.closest("ns-table")===this},ps=function(){const t=c(this,f,ds),n=c(this,f,us);for(const s of this.querySelectorAll("th[data-ns-sort-key]"))h(this,f,Lt).call(this,s)&&(s.dataset.nsSortKey===t&&n!=="none"?s.setAttribute("aria-sort",n):s.removeAttribute("aria-sort"))},Dt=new WeakMap,Oe=function(){return[...this.querySelectorAll("input[data-ns-row-id]")].filter(t=>h(this,f,Lt).call(this,t))},vt=function(t){return t.dataset.nsRowId??""},pe=function(){const t=[...this.querySelectorAll("input[data-ns-select-all]")].filter(d=>h(this,f,Lt).call(this,d));if(t.length===0)return;const n=h(this,f,Oe).call(this),s=this.selected,o=s===void 0?n.filter(d=>d.checked).length:n.filter(d=>s.includes(h(this,f,vt).call(this,d))).length,r=n.length>0&&o===n.length,a=o>0&&o<n.length;for(const d of t)d.checked=r,d.indeterminate=a},fs=function(){return h(this,f,Oe).call(this).filter(t=>t.checked).map(t=>h(this,f,vt).call(this,t))},un=function(t,n){if(t.length!==n.length)return!1;const s=new Set(n);return t.every(o=>s.has(o))},pn=function(){if(this.selected!==void 0)return;const t=h(this,f,fs).call(this),n=c(this,gt);if(!(n!==void 0&&h(this,f,un).call(this,n,t))){if(n===void 0||this.ownerDocument.readyState==="loading"){l(this,gt,t);return}h(this,f,fe).call(this,t)}},fe=function(t){l(this,gt,t);const n={ids:t};this.dispatchEvent(new CustomEvent("ns-select-change",{detail:n,bubbles:!0,composed:!0}))},fn=function(t){const n=h(this,f,Oe).call(this);if(t.hasAttribute("data-ns-select-all")){if(this.selected===void 0)for(const a of n)a.checked=t.checked;h(this,f,fe).call(this,t.checked?n.map(a=>h(this,f,vt).call(this,a)):[]),this.selected===void 0&&h(this,f,pe).call(this);return}if(!t.hasAttribute("data-ns-row-id"))return;let s;if(this.selected===void 0){s=n.filter(a=>a.checked).map(a=>h(this,f,vt).call(this,a)),h(this,f,fe).call(this,s),h(this,f,pe).call(this);return}const o=new Set(this.selected),r=h(this,f,vt).call(this,t);t.checked?o.add(r):o.delete(r),s=n.map(a=>h(this,f,vt).call(this,a)).filter(a=>o.has(a)),h(this,f,fe).call(this,s)},Gt([v({attribute:!1})],rt.prototype,"sortKey"),Gt([v({attribute:!1})],rt.prototype,"sortDirection"),Gt([v({type:String,attribute:"default-sort-key"})],rt.prototype,"defaultSortKey"),Gt([v({type:String,attribute:"default-sort-direction"})],rt.prototype,"defaultSortDirection"),Gt([v({attribute:!1})],rt.prototype,"selected"),M("ns-table",rt);var vi=Object.defineProperty,Vs=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&vi(e,t,s),s};function Zs(i){return`${i}-tab`}class ke extends B{constructor(){super(...arguments);p(this,m);p(this,bt);p(this,jt);p(this,Rt);p(this,zt);p(this,Ht);this.defaultActive="",l(this,bt,""),l(this,Rt,!1),l(this,zt,t=>{const n=h(this,m,ys).call(this,t.target);n!==null&&h(this,m,vs).call(this,h(this,m,mt).call(this,n),!1)}),l(this,Ht,t=>{const n=h(this,m,ys).call(this,t.target);if(n===null)return;const s=c(this,m,ge),o=s.indexOf(n);if(o===-1)return;const r=a=>{t.preventDefault(),h(this,m,vs).call(this,h(this,m,mt).call(this,s[(a+s.length)%s.length]),!0)};t.key==="ArrowRight"?r(o+1):t.key==="ArrowLeft"?r(o-1):t.key==="Home"?r(0):t.key==="End"&&r(s.length-1)})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),U(),et(this,{active:"default-active"}),this.hasAttribute("role")||this.setAttribute("role","tablist"),this.addEventListener("click",c(this,zt)),this.addEventListener("keydown",c(this,Ht)),l(this,jt,new MutationObserver(()=>h(this,m,Me).call(this))),c(this,jt).observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){var t;this.removeEventListener("click",c(this,zt)),this.removeEventListener("keydown",c(this,Ht)),(t=c(this,jt))==null||t.disconnect(),super.disconnectedCallback()}firstUpdated(){this.defaultActive!==""&&l(this,bt,this.defaultActive)}updated(){h(this,m,Me).call(this)}}bt=new WeakMap,jt=new WeakMap,Rt=new WeakMap,m=new WeakSet,gs=function(){return this.active!==void 0},ge=function(){return[...this.querySelectorAll("[data-ns-tab]")].filter(t=>t.closest("ns-tabs")===this)},mt=function(t){return t.dataset.nsTab??""},bs=function(){const t=c(this,m,ge);if(t.length===0)return"";const n=this.active??c(this,bt);if(t.some(o=>h(this,m,mt).call(this,o)===n))return n;const s=h(this,m,mt).call(this,t[0]);return n!==""&&!c(this,Rt)&&(l(this,Rt,!0),console.warn(c(this,m,gs)?`[ns-tabs] active="${n}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${s}" 을 표시하지만 그 탭을 눌러도 ns-tab-change 가 나가지 않습니다. 대소문자까지 맞는지 확인하세요.`:`[ns-tabs] 활성 탭 "${n}" 와 일치하는 data-ns-tab 이 없습니다. 첫 번째 탭 "${s}" 을 표시합니다. default-active 값이 data-ns-tab 과 맞는지 확인하세요.`)),s},Me=function(){const t=c(this,m,bs);for(const n of c(this,m,ge)){const s=h(this,m,mt).call(this,n),o=n.dataset.nsPanel??"";n.setAttribute("role","tab"),!n.hasAttribute("id")&&o!==""&&n.setAttribute("id",Zs(o)),o!==""&&n.setAttribute("aria-controls",o),n.setAttribute("aria-selected",s===t?"true":"false"),n.setAttribute("tabindex",s===t?"0":"-1")}},vs=function(t,n){if(t==="")return;if(t===c(this,m,bs)){n&&h(this,m,ms).call(this,t);return}c(this,m,gs)||(l(this,bt,t),this.requestUpdate());const s={id:t};this.dispatchEvent(new CustomEvent("ns-tab-change",{detail:s,bubbles:!0,composed:!0})),h(this,m,Me).call(this),n&&h(this,m,ms).call(this,t)},ms=function(t){var n;(n=c(this,m,ge).find(s=>h(this,m,mt).call(this,s)===t))==null||n.focus()},ys=function(t){var s;const n=((s=t==null?void 0:t.closest)==null?void 0:s.call(t,"[data-ns-tab]"))??null;return n===null||n.closest("ns-tabs")!==this?null:n},zt=new WeakMap,Ht=new WeakMap,Vs([v({attribute:!1})],ke.prototype,"active"),Vs([v({type:String,attribute:"default-active"})],ke.prototype,"defaultActive"),M("ns-tabs",ke);const mi=j`
  :host {
    position: fixed;
    /*
...
`;var yi=Object.defineProperty,Js=(i,e,t,n)=>{for(var s=void 0,o=i.length-1,r;o>=0;o--)(r=i[o])&&(s=r(e,t,s)||s);return s&&yi(e,t,s),s};const Ge=class Ge extends O{constructor(){super(...arguments);p(this,P);p(this,le);p(this,Z);p(this,z);p(this,J);p(this,ce);p(this,he);p(this,de);p(this,ue);this.position="top-center",this.items=[],l(this,le,0),l(this,Z,!1),l(this,z,!1),l(this,J,!1),l(this,ce,()=>{l(this,Z,!0),h(this,P,It).call(this)}),l(this,he,()=>{l(this,Z,!1),h(this,P,It).call(this)}),l(this,de,()=>{l(this,z,!0),h(this,P,It).call(this)}),l(this,ue,()=>{l(this,z,!1),h(this,P,It).call(this)})}connectedCallback(){super.connectedCallback(),U(),h(this,P,_s).call(this)}disconnectedCallback(){h(this,P,ws).call(this),l(this,Z,!1),l(this,z,!1),l(this,J,!1),super.disconnectedCallback()}show(t,n,s){const o=en(this,le)._++,r={key:o,message:t,tone:n,duration:s,remaining:s,startedAt:Date.now()};return this.items=[...this.items,r],c(this,J)||h(this,P,$s).call(this,r),()=>this.dismiss(o)}dismiss(t){const n=this.items.find(s=>s.key===t);n!==void 0&&(n.timer!==void 0&&clearTimeout(n.timer),this.items=this.items.filter(s=>s.key!==t))}updated(){var t;l(this,z,((t=this.shadowRoot)==null?void 0:t.activeElement)!=null),h(this,P,It).call(this)}render(){return k`
      <div
        class="region"
        aria-live="polite"
        @mousemove=${c(this,ce)}
        @mouseleave=${c(this,he)}
        @focusin=${c(this,de)}
        @focusout=${c(this,ue)}
      >
        ${we(this.items,t=>t.key,t=>k`
            <div class="toast ${t.tone}" role=${t.tone==="danger"?"alert":y}>
              ${t.tone==="neutral"?y:k`<span class="dot" aria-hidden="true"></span>`}
    ...
    `}};le=new WeakMap,Z=new WeakMap,z=new WeakMap,J=new WeakMap,P=new WeakSet,$s=function(t){!Number.isFinite(t.duration)||t.duration<=0||t.timer!==void 0||(t.startedAt=Date.now(),t.timer=window.setTimeout(()=>this.dismiss(t.key),t.remaining))},ws=function(){for(const t of this.items)t.timer!==void 0&&(clearTimeout(t.timer),t.timer=void 0,t.remaining=Math.max(0,t.remaining-(Date.now()-t.startedAt)))},_s=function(){for(const t of this.items)h(this,P,$s).call(this,t)},It=function(){const t=c(this,Z)||c(this,z);t!==c(this,J)&&(l(this,J,t),t?h(this,P,ws).call(this):h(this,P,_s).call(this))},ce=new WeakMap,he=new WeakMap,de=new WeakMap,ue=new WeakMap,Ge.styles=mi;let xt=Ge;Js([v({reflect:!0})],xt.prototype,"position"),Js([ze()],xt.prototype,"items"),M("ns-toast",xt);let Xs="top-center";function $i(){const i=document.querySelector("ns-toast");if(i!==null)return i;const e=document.createElement("ns-toast");return e.position=Xs,document.body.append(e),e}function wi(i){if(Xs=i,typeof document>"u")return;const e=document.querySelector("ns-toast");e!==null&&(e.position=i)}function _i(i,e={}){if(typeof document>"u")return()=>{};const{tone:t="neutral",duration:n=4e3}=e;return $i().show(i,t,n)}function Ys(i,e,t){const n=document.activeElement,s=document.createElement("ns-dialog");s.heading=i.heading??"";const o=document.createElement("p");o.textContent=i.message,o.style.margin="0",s.append(o);let r=!1;const a=u=>{if(r)return;r=!0,s.close();const $=()=>{s.remove(),t(u),n instanceof HTMLElement&&n.isConnected&&n.focus()};s.updateComplete.then($,$)},d=async u=>{for(let $=0;$<5;$++)if(await s.updateComplete,r||(u.focus({preventScroll:!0}),document.activeElement===u))return;console.warn("[ns-confirm] 취소 버튼에 초기 포커스를 주지 못했습니다. ns-dialog 의 갱신 순서가 바뀌었을 수 있습니다.")},b=document.createElement("button");b.type="button",b.slot="footer",b.className=i.tone==="danger"?"ns-button ns-button--danger ns-button--sm":"ns-button ns-button--solid ns-button--sm",b.textContent=i.confirmLabel??"확인",b.addEventListener("click",()=>a(!0));let A=null;if(e){const u=document.createElement("button");u.type="button",u.slot="footer",u.className="ns-button ns-button--outline ns-button--sm",u.textContent=i.cancelLabel??"취소",u.addEventListener("click",()=>a(!1)),i.tone==="danger"&&(A=u),s.append(u)}s.append(b),s.addEventListener("ns-dialog-close",()=>a(!1)),document.body.append(s),s.show(),A!==null&&d(A)}function Ai(i){return typeof document>"u"?Promise.resolve():new Promise(e=>{Ys(i,!1,()=>e())})}function ki(i){return typeof document>"u"?Promise.resolve(!1):new Promise(e=>{Ys(i,!0,e)})}g.NsDialog=T,g.NsHeader=_t,g.NsIcon=Jt,g.NsMultiSelect=N,g.NsNavGroup=F,g.NsNavItem=nt,g.NsPageHeading=At,g.NsPagination=it,g.NsSidebar=kt,g.NsSkeleton=ot,g.NsTable=rt,g.NsTabs=ke,g.NsToast=xt,g.nsAlert=Ai,g.nsConfirm=ki,g.nsToast=_i,g.nsToastPosition=wi,g.registerIcons=In,g.svg=Vt,g.tabIdFor=Zs,Object.defineProperty(g,Symbol.toStringTag,{value:"Module"})}));
