/*
  ...
  **그 이름들을** 호스트에 쓰지 않고(불변 규칙 — 호스트에 쓰는 것은 ns-tabs 의 role,
  ns-toast 의 position, ns-sidebar 의 data-ns-open 셋뿐이고 어느 것도 advice 목록에
  오지 않는다), Lit 도 attribute: false 를 반영하지 않으며, React shim 은 프로퍼티로
  넘긴다. **따라서 발견되면 언제나 실수다.**
*/
